...
impl<TH: TypeHolderTrait> FrameRequestCallback {
    ...
    pub fn Call_<T: DomObject<TH>, TH: TypeHolderTrait>(&self, thisObj: &T, time: Finite<f64>, aExceptionHandling: ExceptionHandling) -> Fallible<(), TH> {
...
impl CallbackContainer for FrameRequestCallback {
    unsafe fn new(cx: *mut JSContext, callback: *mut JSObject) -> Rc<FrameRequestCallback> {
...
impl ToJSValConvertible for FrameRequestCallback {
    unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
...
pub trait WindowMethods<TH: TypeHolderTrait> {
    ...
    fn GetOnafterprint(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnafterprint(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnbeforeprint(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnbeforeprint(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnbeforeunload(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::OnBeforeUnloadEventHandlerNonNull>>;
    fn SetOnbeforeunload(&self, value: Option<Rc<OnBeforeUnloadEventHandlerNonNull>>) -> ();
    fn GetOnhashchange(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnhashchange(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnlanguagechange(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnlanguagechange(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnmessage(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnmessage(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnoffline(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnoffline(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnonline(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnonline(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnpagehide(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnpagehide(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnpageshow(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnpageshow(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnpopstate(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnpopstate(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnrejectionhandled(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnrejectionhandled(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnstorage(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnstorage(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnunhandledrejection(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnunhandledrejection(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnunload(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnunload(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplayconnect(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplayconnect(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplaydisconnect(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplaydisconnect(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplayactivate(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplayactivate(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplaydeactivate(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplaydeactivate(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplayblur(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplayblur(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplayfocus(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplayfocus(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnvrdisplaypresentchange(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnvrdisplaypresentchange(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    ...
    unsafe fn SetTimeout(&self, cx: *mut JSContext, handler: Rc<Function>, timeout: i32, arguments: Vec<HandleValue>) -> i32;
