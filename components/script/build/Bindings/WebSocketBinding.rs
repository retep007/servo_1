...
pub trait WebSocketMethods<TH: TypeHolderTrait> {
    ...
    fn GetOnopen(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
    fn SetOnopen(&self, value: Option<Rc<EventHandlerNonNull>>) -> ();
    fn GetOnerror(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull>>;
