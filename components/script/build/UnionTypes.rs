...
impl<TH: TypeHolderTrait> FromJSValConvertible for ArrayBufferOrArrayBufferViewOrBlobOrString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match ArrayBufferOrArrayBufferViewOrBlobOrString::TryConvertToArrayBuffer(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(ArrayBufferOrArrayBufferViewOrBlobOrString::ArrayBuffer(value))),
                Ok(None) => (),
            }
            match ArrayBufferOrArrayBufferViewOrBlobOrString::TryConvertToArrayBufferView(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(ArrayBufferOrArrayBufferViewOrBlobOrString::ArrayBufferView(value))),
                Ok(None) => (),
            }
            match ArrayBufferOrArrayBufferViewOrBlobOrString::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
        ...
        match ArrayBufferOrArrayBufferViewOrBlobOrString::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for BlobOrBoolean<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match BlobOrBoolean::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
        ...
        match BlobOrBoolean::TryConvertToBoolean(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::Blob(value))),
                Ok(None) => (),
            }
            match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToArrayBufferView(cx, value) {
                Err(_) => return Err(()),
            ...
            match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToArrayBuffer(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::ArrayBuffer(value))),
                Ok(None) => (),
            }
            match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToFormData(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::FormData(value))),
                Ok(None) => (),
            }
            match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToURLSearchParams(cx, value) {
                Err(_) => return Err(()),
        ...
        match BlobOrBufferSourceOrFormDataOrStringOrURLSearchParams::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for BlobOrUnsignedLong<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match BlobOrUnsignedLong::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
        ...
        match BlobOrUnsignedLong::TryConvertToUnsignedLong(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for DocumentOrBodyInit<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match DocumentOrBodyInit::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for DocumentOrTestTypedef<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match DocumentOrTestTypedef::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for EventOrString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match EventOrString::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for EventOrUSVString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match EventOrUSVString::TryConvertToUSVString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for FileOrUSVString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match FileOrUSVString::TryConvertToUSVString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for HTMLElementOrLong<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
        ...
        match HTMLElementOrLong::TryConvertToLong(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for HTMLElementOrUnsignedLongOrStringOrBoolean<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match HTMLElementOrUnsignedLongOrStringOrBoolean::TryConvertToHTMLElement(cx, value) {
                Err(_) => return Err(()),
        ...
        if value.get().is_boolean() {
            match HTMLElementOrUnsignedLongOrStringOrBoolean::TryConvertToBoolean(cx, value) {
                Err(_) => return Err(()),
        ...
        if value.get().is_number() {
            match HTMLElementOrUnsignedLongOrStringOrBoolean::TryConvertToUnsignedLong(cx, value) {
                Err(_) => return Err(()),
        ...
        match HTMLElementOrUnsignedLongOrStringOrBoolean::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
#[derive(JSTraceable)]
pub enum HeadersOrByteStringSequenceSequenceOrStringByteStringRecord {
    Headers(DomRoot<Headers>),
    ByteStringSequenceSequence(Vec<Vec<ByteString>>),
    StringByteStringRecord(MozMap<ByteString>),
}

impl ToJSValConvertible for HeadersOrByteStringSequenceSequenceOrStringByteStringRecord {
    unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
        match *self {
...
impl FromJSValConvertible for HeadersOrByteStringSequenceSequenceOrStringByteStringRecord {
    type Config = ();
    unsafe fn from_jsval(cx: *mut JSContext,
                         value: HandleValue,
                         _option: ())
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match HeadersOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToHeaders(cx, value) {
                Err(_) => return Err(()),
            ...
            match HeadersOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToByteStringSequenceSequence(cx, value) {
                Err(_) => return Err(()),
            ...
            match HeadersOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToStringByteStringRecord(cx, value) {
                Err(_) => return Err(()),
...
impl HeadersOrByteStringSequenceSequenceOrStringByteStringRecord {
    unsafe fn TryConvertToHeaders(cx: *mut JSContext, value: HandleValue) -> Result<Option<DomRoot<Headers>>, ()> {
        Ok(Some(match root_from_handlevalue(value) {
            Ok(val) => val,
            Err(()) => {
                return Ok(None);
...
impl<TH: TypeHolderTrait> FromJSValConvertible for LongSequenceOrTestTypedef<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match LongSequenceOrTestTypedef::TryConvertToURL(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(LongSequenceOrTestTypedef::URL(value))),
                Ok(None) => (),
            }
            match LongSequenceOrTestTypedef::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(LongSequenceOrTestTypedef::Blob(value))),
                Ok(None) => (),
            }

            match LongSequenceOrTestTypedef::TryConvertToLongSequence(cx, value) {
                Err(_) => return Err(()),
        ...
        match LongSequenceOrTestTypedef::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for NodeOrString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match NodeOrString::TryConvertToNode(cx, value) {
                Err(_) => return Err(()),
        ...
        match NodeOrString::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for RequestOrUSVString<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match RequestOrUSVString::TryConvertToRequest(cx, value) {
                Err(_) => return Err(()),
        ...
        match RequestOrUSVString::TryConvertToUSVString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for StringOrCanvasGradientOrCanvasPattern<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match StringOrCanvasGradientOrCanvasPattern::TryConvertToCanvasGradient(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(StringOrCanvasGradientOrCanvasPattern::CanvasGradient(value))),
                Ok(None) => (),
            }
            match StringOrCanvasGradientOrCanvasPattern::TryConvertToCanvasPattern(cx, value) {
                Err(_) => return Err(()),
        ...
        match StringOrCanvasGradientOrCanvasPattern::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for StringOrURLOrBlob<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match StringOrURLOrBlob::TryConvertToURL(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(StringOrURLOrBlob::URL(value))),
                Ok(None) => (),
            }
            match StringOrURLOrBlob::TryConvertToBlob(cx, value) {
                Err(_) => return Err(()),
        ...
        match StringOrURLOrBlob::TryConvertToString(cx, value) {
            Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToTestBinding(cx, value) {
                Err(_) => return Err(()),
            ...
            match TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToByteStringSequenceSequence(cx, value) {
                Err(_) => return Err(()),
            ...
            match TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord::TryConvertToStringByteStringRecord(cx, value) {
                Err(_) => return Err(()),
...
impl<TH: TypeHolderTrait> FromJSValConvertible for TestBindingOrStringByteStringRecord<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match TestBindingOrStringByteStringRecord::TryConvertToTestBinding(cx, value) {
                Err(_) => return Err(()),
                Ok(Some(value)) => return Ok(ConversionResult::Success(TestBindingOrStringByteStringRecord::TestBinding(value))),
                Ok(None) => (),
            }

            match TestBindingOrStringByteStringRecord::TryConvertToStringByteStringRecord(cx, value) {
                Err(_) => return Err(()),
...
impl FromJSValConvertible for TestDictionaryOrLong {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         _option: ())
                         -> Result<ConversionResult<Self>, ()> {
        match TestDictionaryOrLong::TryConvertToTestDictionary(cx, value) {
            Err(_) => return Err(()),
        ...
        match TestDictionaryOrLong::TryConvertToLong(cx, value) {
            Err(_) => return Err(()),
...
impl TestDictionaryOrLong {
    unsafe fn TryConvertToTestDictionary(cx: *mut JSContext, value: HandleValue) -> Result<Option<RootedTraceableBox<TestDictionary>>, ()> {
        Ok(Some(match FromJSValConvertible::from_jsval(cx, value, ()) {
            Ok(ConversionResult::Success(dictionary)) => dictionary,
            Ok(ConversionResult::Failure(error)) => {
                return Ok(None);
...
impl<TH: TypeHolderTrait> FromJSValConvertible for USVStringOrURLSearchParams<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext,
                         ...
                         -> Result<ConversionResult<Self>, ()> {
        if value.get().is_object() {
            match USVStringOrURLSearchParams::TryConvertToURLSearchParams(cx, value) {
                Err(_) => return Err(()),
        ...
        match USVStringOrURLSearchParams::TryConvertToUSVString(cx, value) {
            Err(_) => return Err(()),
