...
def replace(s):
    ...
    s = re.sub(' sMethods,', ' sMethods,', s);
    s = re.sub(' sAttributes,', ' sAttributes,', s);
    ...
    s = re.sub('sUnforgeableAttributes_specs\[', 'sUnforgeableAttributes_specs[', s);
    s = re.sub(' sUnforgeableAttributes,', ' sUnforgeableAttributes,', s);
    ...
    s = re.sub(' sUnforgeableMethods,', ' sUnforgeableMethods,', s);
    ...
    s = re.sub(' sStaticMethods,', ' sStaticMethods,', s);
    ...
    if 'call(_constructor)' in s:
        ...
        s = re.sub('&INTERFACE_OBJECT_CLASS,', '&INTERFACE_OBJECT_CLASS,',s)
