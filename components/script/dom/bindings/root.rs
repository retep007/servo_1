    ...
    T: DomObject
{
    fn stable_trace_object<'a>(&'a self) -> *const JSTraceable {
        ...
        // T pointer in Dom<T>.
        #[allow(unrooted_must_root)]
        struct ReflectorStackRoot<TH: TypeHolderTrait<TH>>(Reflector<TH>);
        unsafe impl<TH: TypeHolderTrait<TH>> JSTraceable for ReflectorStackRoot<TH> {
...
impl<TH: TypeHolderTrait<TH>> LayoutDom<Node<TH>> {
