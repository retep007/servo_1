...
#[dom_struct]
pub struct Response<TH: TypeHolderTrait<TH> + 'static> {
...
impl<TH: TypeHolderTrait<TH>> Response<TH> {
...
impl<TH: TypeHolderTrait<TH>> BodyOperations<TH> for Response<TH> {
...
impl<TH: TypeHolderTrait<TH>> ResponseMethods<TH> for Response<TH> {
