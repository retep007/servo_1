...
pub struct TouchEvent<TH: TypeHolderTrait> {
    uievent: UIEvent<TH>,
    touches: MutDom<TouchList<TH>, TH>,
    target_touches: MutDom<TouchList<TH>, TH>,
    changed_touches: MutDom<TouchList<TH>, TH>,
    alt_key: Cell<bool>,
    meta_key: Cell<bool>,
    ctrl_key: Cell<bool>,
    shift_key: Cell<bool>,
...
impl<'a, TH> TouchEventMethods<TH> for &'a TouchEvent<TH> {
