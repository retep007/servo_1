...
#[allow(dead_code)]
enum CanvasFillOrStrokeStyle<TH: TypeHolderTrait<TH> + 'static> {
    Color(RGBA),
...
#[dom_struct]
pub struct CanvasRenderingContext2D<TH: TypeHolderTrait<TH> + 'static> {
...
#[must_root]
#[derive(Clone, JSTraceable, MallocSizeOf)]
struct CanvasContextState<TH: TypeHolderTrait<TH> + 'static> {
    global_alpha: f64,
...
impl<TH: TypeHolderTrait<TH>> CanvasContextState<TH> {
...
impl<TH: TypeHolderTrait<TH>> CanvasRenderingContext2D<TH> {
...
impl<TH: TypeHolderTrait<TH>> LayoutCanvasRenderingContext2DHelpers for LayoutDom<CanvasRenderingContext2D<TH>> {
    #[allow(unsafe_code)]
    unsafe fn get_ipc_renderer(&self) -> IpcSender<CanvasMsg> {
...
impl<TH: TypeHolderTrait<TH>> CanvasRenderingContext2DMethods<TH> for CanvasRenderingContext2D<TH> {
...
impl<TH: TypeHolderTrait<TH>> Drop for CanvasRenderingContext2D<TH> {
    fn drop(&mut self) {
