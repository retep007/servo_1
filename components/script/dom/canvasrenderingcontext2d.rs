...
impl<TH> LayoutCanvasRenderingContext2DHelpers for LayoutDom<CanvasRenderingContext2D<TH>> {
    #[allow(unsafe_code)]
    unsafe fn get_ipc_renderer(&self) -> IpcSender<CanvasMsg> {
...
impl<TH> CanvasRenderingContext2DMethods<TH> for CanvasRenderingContext2D<TH> {
...
impl<TH> Drop for CanvasRenderingContext2D<TH> {
    fn drop(&mut self) {
