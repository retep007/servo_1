...
#[dom_struct]
pub struct HTMLHeadElement<TH: TypeHolderTrait<TH> + 'static> {
    htmlelement: HTMLElement<TH>
}

impl<TH: TypeHolderTrait<TH>> HTMLHeadElement<TH> {
...
impl<TH: TypeHolderTrait<TH>> VirtualMethods<TH> for HTMLHeadElement<TH> {
