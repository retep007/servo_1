...
#[dom_struct]
pub struct HTMLStyleElement<TH: TypeHolderTrait<TH> + 'static> {
...
impl<TH: TypeHolderTrait<TH>> HTMLStyleElement<TH> {
...
impl<TH: TypeHolderTrait<TH>> VirtualMethods<TH> for HTMLStyleElement<TH> {
...
impl<TH: TypeHolderTrait<TH>> StylesheetOwner for HTMLStyleElement<TH> {
...
impl<TH: TypeHolderTrait<TH>> HTMLStyleElementMethods<TH> for HTMLStyleElement<TH> {
