...
#[dom_struct]
pub struct OESTextureFloat<TH: TypeHolderTrait<TH> + 'static> {
    reflector_: Reflector<TH>,
    _p: PhantomData<TH>,
}

impl<TH: TypeHolderTrait<TH>> OESTextureFloat<TH> {
...
impl<TH: TypeHolderTrait<TH>> WebGLExtension<TH> for OESTextureFloat<TH> {
