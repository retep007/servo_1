...
#[dom_struct]
pub struct HTMLTimeElement<TH: TypeHolderTrait<TH> + 'static> {
    htmlelement: HTMLElement<TH>,
}

impl<TH: TypeHolderTrait<TH>> HTMLTimeElement<TH> {
...
impl<TH: TypeHolderTrait<TH>> HTMLTimeElementMethods for HTMLTimeElement<TH> {
