...
impl<TH> HTMLDListElement<TH> {
    fn new_inherited(local_name: LocalName, prefix: Option<Prefix>, document: &Document<TH>) -> HTMLDListElement {
        HTMLDListElement {
            htmlelement:
    ...
    pub fn new(local_name: LocalName,
               ...
               document: &Document<TH>) -> DomRoot<HTMLDListElement> {
