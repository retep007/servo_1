...
#[dom_struct]
pub struct URLSearchParams<TH: TypeHolderTrait<TH> + 'static> {
...
impl<TH: TypeHolderTrait<TH>> URLSearchParams<TH> {
...
impl<TH: TypeHolderTrait<TH>> URLSearchParamsMethods for URLSearchParams<TH> {
...
impl<TH: TypeHolderTrait<TH>> Iterable for URLSearchParams<TH> {
    type Key = USVString;
