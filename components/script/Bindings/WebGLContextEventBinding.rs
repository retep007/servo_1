...
pub struct WebGLContextEventInit {
    ...
    pub statusMessage: Option<DOMString>,
}
impl WebGLContextEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> WebGLContextEventInit {
        match WebGLContextEventInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<WebGLContextEventInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = WebGLContextEventInit {
            parent: {
            ...
            statusMessage: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "statusMessage", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for WebGLContextEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<WebGLContextEventInit>, ()> {
        WebGLContextEventInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for WebGLContextEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        if let Some(ref statusMessage) = self.statusMessage {
            rooted!(in(cx) let mut statusMessage_js = UndefinedValue());
            statusMessage.to_jsval(cx, statusMessage_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "statusMessage", statusMessage_js.handle()).unwrap();
        }
...
pub use self::WebGLContextEventBinding::{Wrap, WebGLContextEventMethods, GetProtoObject, DefineDOMInterface};
...
use dom::globalscope::GlobalScope;
use dom::types::Event;
use dom::types::WebGLContextEvent;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
unsafe extern fn get_statusMessage<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const WebGLContextEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.StatusMessage();
...
fn statusMessage_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_statusMessage::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::WebGLContextEvent as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLContextEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WebGLContextEvent<TH>);
            }
            debug!("WebGLContextEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"WebGLContextEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::WebGLContextEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::WebGLContextEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<WebGLContextEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WebGLContextEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WebGLContextEvent<TH>>) -> DomRoot<WebGLContextEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLContextEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLContextEvent<TH> {
    fn eq(&self, other: &WebGLContextEvent<TH>) -> bool {
        self as *const WebGLContextEvent<TH> == &*other
    }
}
...
&[
    JSPropertySpec {
        name: b"statusMessage\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &statusMessage_getterinfo::<TH>() },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLContextEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WebGLContextEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"WebGLContextEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::WebGLContextEventBinding::WebGLContextEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::WebGLContextEventBinding::WebGLContextEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function WebGLContextEvent() {\n    [native code]\n}",
        PrototypeList::ID::WebGLContextEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WebGLContextEvent as usize].is_null());
    (*cache)[PrototypeList::ID::WebGLContextEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WebGLContextEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
