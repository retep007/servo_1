...
const statusMessage_getterinfo: JSJitInfo = JSJitInfo {
    call: get_statusMessage as *const os::raw::c_void,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &statusMessage_getterinfo },
