...
unsafe extern fn get_statusMessage<TH: TypeHolderTrait>
...
fn statusMessage_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLContextEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for WebGLContextEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for WebGLContextEvent<TH> {
