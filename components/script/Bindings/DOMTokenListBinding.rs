...
pub use self::DOMTokenListBinding::{Wrap, DOMTokenListMethods, GetProtoObject, DefineDOMInterface};
...
fn length_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::DOMTokenList as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMTokenList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"DOMTokenList.item\".");
            return false;
        }
        ...
        let result: Option<DOMString> = this.Item(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMTokenList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"DOMTokenList.contains\".");
            return false;
        }
        ...
        let result: bool = this.Contains(arg0);
...
const contains_methodinfo_argTypes: [i32; 2] = [ JSJitInfo_ArgType::String as i32, JSJitInfo_ArgType::ArgTypeListEnd as i32 ];
...
unsafe extern fn toggle<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMTokenList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"DOMTokenList.toggle\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let arg1: Option<bool> = if args.get(1).is_undefined() {
            None
        } else {
...
fn toggle_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: toggle::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMTokenList as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMTokenList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"DOMTokenList.replace\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, obj: HandleObject, this: *const DOMTokenList<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMTokenList<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DOMTokenList<TH>);
            }
            debug!("DOMTokenList<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const DOMTokenList<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const DOMTokenList<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::DOMTokenList, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<DOMTokenList<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"DOMTokenList\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<DOMTokenList<TH>>) -> DomRoot<DOMTokenList<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::DOMTokenList as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMTokenList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMTokenList<TH> {
    fn eq(&self, other: &DOMTokenList<TH>) -> bool {
        self as *const DOMTokenList<TH> == &*other
    }
}

pub trait DOMTokenListMethods<TH: TypeHolderTrait<TH>> {
    fn Length(&self) -> u32;
...
&[
    ...
    JSFunctionSpec {
        name: b"toggle\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &toggle_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DOMTokenList as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DOMTokenListPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function DOMTokenList() {\n    [native code]\n}",
        PrototypeList::ID::DOMTokenList,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DOMTokenList as usize].is_null());
    (*cache)[PrototypeList::ID::DOMTokenList as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMTokenList as isize),
                                  ptr::null_mut(),
                                  prototype.get());
