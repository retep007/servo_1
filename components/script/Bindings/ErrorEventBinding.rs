...
pub struct ErrorEventInit {
    ...
    pub error: RootedTraceableBox<Heap<JSVal>>,
    pub filename: Option<DOMString>,
...
impl ErrorEventInit {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let mut dictionary = RootedTraceableBox::new(ErrorEventInit::default());
            dictionary.parent = {
            ...
            dictionary.colno = {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "colno", rval.handle_mut())) {
                    true => {
            ...
            dictionary.error = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "error", rval.handle_mut())) {
                    true => {
            ...
            dictionary.filename = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "filename", rval.handle_mut())) {
                    true => {
            ...
            dictionary.lineno = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "lineno", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            dictionary.message = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "message", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), StringificationBehavior::Default) {
                            Ok(ConversionResult::Success(strval)) => strval,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for RootedTraceableBox<ErrorEventInit> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RootedTraceableBox<ErrorEventInit>>, ()> {
        ErrorEventInit::new(cx, value)
    }
}

impl ToJSValConvertible for RootedTraceableBox<ErrorEventInit> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        rooted!(in(cx) let obj = JS_NewObject(cx, ptr::null()));
        if let Some(ref colno) = self.colno {
            rooted!(in(cx) let mut colno_js = UndefinedValue());
            colno.to_jsval(cx, colno_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "colno", colno_js.handle()).unwrap();
        }
        ...
        if let Some(ref filename) = self.filename {
            rooted!(in(cx) let mut filename_js = UndefinedValue());
            filename.to_jsval(cx, filename_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "filename", filename_js.handle()).unwrap();
        }
        if let Some(ref lineno) = self.lineno {
            rooted!(in(cx) let mut lineno_js = UndefinedValue());
            lineno.to_jsval(cx, lineno_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "lineno", lineno_js.handle()).unwrap();
        }
        if let Some(ref message) = self.message {
            rooted!(in(cx) let mut message_js = UndefinedValue());
            message.to_jsval(cx, message_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "message", message_js.handle()).unwrap();
        }
...
pub use self::ErrorEventBinding::{Wrap, ErrorEventMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_message<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn message_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_message::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ErrorEvent as u16,
    depth: 1,
...
unsafe extern fn get_filename<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.Filename();
...
fn filename_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_filename::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ErrorEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_lineno<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: u32 = this.Lineno();
...
fn lineno_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_lineno::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ErrorEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_colno<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: u32 = this.Colno();
...
fn colno_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_colno::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ErrorEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: JSVal = this.Error(cx);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ErrorEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ErrorEvent<TH>);
            }
            debug!("ErrorEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ErrorEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::ErrorEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::ErrorEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ErrorEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ErrorEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ErrorEvent<TH>>) -> DomRoot<ErrorEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ErrorEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ErrorEvent<TH> {
    fn eq(&self, other: &ErrorEvent<TH>) -> bool {
        self as *const ErrorEvent<TH> == &*other
    }
}
...
pub trait ErrorEventMethods {
    ...
    fn Lineno(&self) -> u32;
    fn Colno(&self) -> u32;
    unsafe fn Error(&self, cx: *mut JSContext) -> JSVal;
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &message_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"filename\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &filename_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"lineno\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &lineno_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"colno\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &colno_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ErrorEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ErrorEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ErrorEvent.constructor\".");
            return false;
        }
        ...
        let arg1: RootedTraceableBox<dom::bindings::codegen::Bindings::ErrorEventBinding::ErrorEventInit> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::ErrorEventBinding::ErrorEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ErrorEvent() {\n    [native code]\n}",
        PrototypeList::ID::ErrorEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ErrorEvent as usize].is_null());
    (*cache)[PrototypeList::ID::ErrorEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ErrorEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
