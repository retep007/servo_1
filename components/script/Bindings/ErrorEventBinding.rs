...
fn message_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_filename<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn filename_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_lineno<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn lineno_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_colno<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const ErrorEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn colno_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ErrorEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for ErrorEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for ErrorEvent<TH> {
