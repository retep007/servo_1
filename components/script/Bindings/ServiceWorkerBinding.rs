...
pub mod ServiceWorkerStateValues {
    use dom::bindings::conversions::ToJSValConvertible;
    use js::jsapi::JSContext;
    use js::rust::MutableHandleValue;
    use js::jsval::JSVal;

    pub const pairs: &'static [(&'static str, super::ServiceWorkerState)] = &[
        ("installing", super::ServiceWorkerState::Installing),
        ("installed", super::ServiceWorkerState::Installed),
        ("activating", super::ServiceWorkerState::Activating),
        ("activated", super::ServiceWorkerState::Activated),
        ("redundant", super::ServiceWorkerState::Redundant),
    ];

    impl super::ServiceWorkerState {
        pub fn as_str(&self) -> &'static str {
            pairs[*self as usize].0
        }
    }

    impl Default for super::ServiceWorkerState {
        fn default() -> super::ServiceWorkerState {
            pairs[0].1
        }
    }

    impl ToJSValConvertible for super::ServiceWorkerState {
        unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
            pairs[*self as usize].0.to_jsval(cx, rval);
        }
    }
        } // mod ServiceWorkerStateValues

pub use self::ServiceWorkerBinding::{Wrap, ServiceWorkerMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::codegen::Bindings::ServiceWorkerBinding::ServiceWorkerStateValues;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
fn scriptURL_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_scriptURL::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ServiceWorker as u16,
    depth: 1,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorker<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: ServiceWorkerState = this.State();
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorker<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ServiceWorker.postMessage\".");
            return false;
        }
...
unsafe extern fn get_onstatechange<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorker<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn set_onstatechange<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const ServiceWorker<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.SetOnstatechange(arg0);
...
fn onstatechange_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_onstatechange::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ServiceWorker as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn onstatechange_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_onstatechange::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ServiceWorker as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ServiceWorker<TH>>(obj).unwrap();
            ...
            debug!("ServiceWorker<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::ServiceWorker, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::ServiceWorker) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ServiceWorker<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ServiceWorker<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ServiceWorker<TH>>) -> DomRoot<ServiceWorker<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ServiceWorker<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ServiceWorker<TH> {
    fn eq(&self, other: &ServiceWorker<TH>) -> bool {
        self as *const ServiceWorker<TH> == &*other
    }
}

pub trait ServiceWorkerMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSPropertySpec {
        name: b"scriptURL\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &scriptURL_getterinfo::<TH>() },
    ...
    JSPropertySpec {
        name: b"onstatechange\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &onstatechange_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &onstatechange_setterinfo::<TH>() }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ServiceWorker as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ServiceWorkerPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ServiceWorker() {\n    [native code]\n}",
        PrototypeList::ID::ServiceWorker,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ServiceWorker as usize].is_null());
    (*cache)[PrototypeList::ID::ServiceWorker as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ServiceWorker as isize),
                                  ptr::null_mut(),
                                  prototype.get());
