...
pub mod AttrBinding {
    ...
    unsafe extern "C" fn get_namespaceURI<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
    ...
    unsafe extern "C" fn get_prefix<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn get_localName<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn get_name<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn get_nodeName<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn get_value<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn set_value<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        obj: HandleObject,
        this: *const Attr<TH>,
        ...
        return wrap_panic(
            panic::AssertUnwindSafe(|| {
                let this = &*this;
                let arg0: DOMString = match FromJSValConvertible::from_jsval(
                    cx,
                    args.get(0),
    ...
    unsafe extern "C" fn get_textContent<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn set_textContent<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitSetterCallArgs,
    ...
    unsafe extern "C" fn get_nodeValue<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn set_nodeValue<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitSetterCallArgs,
    ...
    unsafe extern "C" fn get_ownerElement<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn get_specified<TH: TypeHolderTrait>(
        cx: *mut JSContext,
        _obj: HandleObject,
        this: *const Attr<TH>,
        args: JSJitGetterCallArgs,
    ...
    unsafe extern "C" fn FOO_finalize(_fop: *mut JSFreeOp, obj: *mut JSObject) {
        unimplemented!();
    }

    unsafe extern "C" fn _finalize<TH: TypeHolderTrait>(_fop: *mut JSFreeOp, obj: *mut JSObject) {
        return wrap_panic(
            panic::AssertUnwindSafe(|| {
    ...
    unsafe extern "C" fn FOO_trace(trc: *mut JSTracer, obj: *mut JSObject) {
        unimplemented!();
    }

    unsafe extern "C" fn _trace<TH: TypeHolderTrait>(trc: *mut JSTracer, obj: *mut JSObject) {
        return wrap_panic(
            panic::AssertUnwindSafe(|| {
                let this = native_from_object::<Attr<TH>>(obj).unwrap();
                if this.is_null() {
    ...
    pub unsafe fn FOO_malloc_size_of(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
        unimplemented!()
    }
    ...
    const sAttributes_specs: &'static [&'static [JSPropertySpec]] = &[&[
        JSPropertySpec {
            ...
            getter: JSNativeWrapper {
                op: Some(generic_getter),
                info: &namespaceURI_getterinfo,
            },
        ...
        JSPropertySpec {
            ...
            getter: JSNativeWrapper {
                op: Some(generic_getter),
                info: &value_getterinfo,
            },
            setter: JSNativeWrapper {
                op: Some(generic_setter),
                info: &value_setterinfo,
            },
        },
        JSPropertySpec {
            ...
            getter: JSNativeWrapper {
                op: Some(generic_getter),
                info: &textContent_getterinfo,
            },
            setter: JSNativeWrapper {
                op: Some(generic_setter),
                info: &textContent_setterinfo,
            },
        },
        JSPropertySpec {
            ...
            getter: JSNativeWrapper {
                op: Some(generic_getter),
                info: &nodeValue_getterinfo,
            },
            setter: JSNativeWrapper {
                op: Some(generic_setter),
                info: &nodeValue_setterinfo,
            },
        },
        JSPropertySpec {
    ...
    unsafe fn CreateInterfaceObjects<TH: TypeHolderTrait>(
        ...
        <*mut JSObject>::post_barrier(
            (*cache)
                .as_mut_ptr()
                .offset(PrototypeList::ID::Attr as isize),
            ptr::null_mut(),
            prototype.get(),
        );
