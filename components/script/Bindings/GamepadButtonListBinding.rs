...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<GamepadButtonList<TH>>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for GamepadButtonList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for GamepadButtonList<TH> {
    fn eq(&self, other: &GamepadButtonList<TH>) -> bool {
        self as *const GamepadButtonList<TH> == &*other
    }
}

pub trait GamepadButtonListMethods<TH: TypeHolderTrait<TH>> {
