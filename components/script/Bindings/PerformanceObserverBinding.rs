...
impl<TH: TypeHolderTrait> PerformanceObserverCallback<TH> {
    ...
    pub fn Call_<T: DomObject<TH>, TH: TypeHolderTrait>(&self, thisObj: &T, entries: &PerformanceObserverEntryList<TH>, observer: &PerformanceObserver<TH>, aExceptionHandling: ExceptionHandling) -> Fallible<(), TH> {
...
impl<TH: TypeHolderTrait> IDLInterface for PerformanceObserver<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PerformanceObserver<TH> {
