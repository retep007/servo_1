...
use dom::types::PerformanceObserver;
...
pub struct PerformanceObserverInit {
    pub buffered: bool,
    pub entryTypes: Vec<DOMString>,
}
impl PerformanceObserverInit {
    pub unsafe fn empty(cx: *mut JSContext) -> PerformanceObserverInit {
        match PerformanceObserverInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<PerformanceObserverInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = PerformanceObserverInit {
            buffered: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "buffered", rval.handle_mut())) {
                    true => {
            ...
            entryTypes: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "entryTypes", rval.handle_mut())) {
                    true => {
                    ...
                    false => {
                        throw_type_error(cx, "Missing required member \"entryTypes\".");
                        return Err(());
                    },
                }
            },
...
impl FromJSValConvertible for PerformanceObserverInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<PerformanceObserverInit>, ()> {
        PerformanceObserverInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for PerformanceObserverInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut buffered_js = UndefinedValue());
        buffered.to_jsval(cx, buffered_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "buffered", buffered_js.handle()).unwrap();
        let entryTypes = &self.entryTypes;
        rooted!(in(cx) let mut entryTypes_js = UndefinedValue());
        entryTypes.to_jsval(cx, entryTypes_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "entryTypes", entryTypes_js.handle()).unwrap();
...
pub struct PerformanceObserverCallback<TH: TypeHolderTrait<TH> + 'static> {
    pub parent: CallbackFunction<TH>,
}

impl<TH: TypeHolderTrait<TH>> PerformanceObserverCallback<TH> {
    ...
    unsafe fn Call(&self, cx: *mut JSContext, aThisObj: HandleObject, entries: &PerformanceObserverEntryList<TH>, observer: &PerformanceObserver<TH>) -> Fallible<(), TH> {
        ...
        *arg = Heap::default();
        ...
        rooted!(in(cx) let mut argv_root = UndefinedValue());
        (entries).to_jsval(cx, argv_root.handle_mut());
        {
        let arg = &mut argv[0];
        *arg = Heap::default();
        arg.set(argv_root.get());
...
impl<TH: TypeHolderTrait<TH>> CallbackContainer<TH> for PerformanceObserverCallback<TH> {
...
impl<TH: TypeHolderTrait<TH>> ToJSValConvertible for PerformanceObserverCallback<TH> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
        self.callback().to_jsval(cx, rval);
    }
}

pub use self::PerformanceObserverBinding::{Wrap, PerformanceObserverMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PerformanceObserver<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PerformanceObserver.observe\".");
            return false;
        }
        let arg0: dom::bindings::codegen::Bindings::PerformanceObserverBinding::PerformanceObserverInit = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PerformanceObserver<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PerformanceObserver<TH>);
            }
            debug!("PerformanceObserver<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"PerformanceObserver\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::PerformanceObserver, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PerformanceObserver<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<PerformanceObserver<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PerformanceObserver<TH>>) -> DomRoot<PerformanceObserver<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for PerformanceObserver<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for PerformanceObserver<TH> {
    fn eq(&self, other: &PerformanceObserver<TH>) -> bool {
        self as *const PerformanceObserver<TH> == &*other
    }
}

pub trait PerformanceObserverMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PerformanceObserver as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PerformanceObserverPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PerformanceObserver() {\n    [native code]\n}",
        PrototypeList::ID::PerformanceObserver,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::PerformanceObserver as usize].is_null());
    (*cache)[PrototypeList::ID::PerformanceObserver as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PerformanceObserver as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"PerformanceObserver\0",
                                        1,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod PerformanceObserverBinding
