...
impl MessageEventInit {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let mut dictionary = RootedTraceableBox::new(MessageEventInit::default());
            dictionary.parent = {
...
impl FromJSValConvertible for RootedTraceableBox<MessageEventInit> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RootedTraceableBox<MessageEventInit>>, ()> {
        MessageEventInit::new(cx, value)
    }
}

impl ToJSValConvertible for RootedTraceableBox<MessageEventInit> {
...
pub use self::MessageEventBinding::{Wrap, MessageEventMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MessageEvent<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn data_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::MessageEvent as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MessageEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut MessageEvent<TH>);
            }
            debug!("MessageEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"MessageEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::MessageEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::MessageEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<MessageEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<MessageEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<MessageEvent<TH>>) -> DomRoot<MessageEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for MessageEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for MessageEvent<TH> {
    fn eq(&self, other: &MessageEvent<TH>) -> bool {
        self as *const MessageEvent<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::MessageEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"MessageEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MessageEvent.constructor\".");
            return false;
        }
        ...
        let arg1: RootedTraceableBox<dom::bindings::codegen::Bindings::MessageEventBinding::MessageEventInit> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::MessageEventBinding::MessageEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<MessageEvent<TH>>, Error<TH>> = MessageEvent::Constructor(&global, arg0, arg1);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function MessageEvent() {\n    [native code]\n}",
        PrototypeList::ID::MessageEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::MessageEvent as usize].is_null());
    (*cache)[PrototypeList::ID::MessageEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::MessageEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
