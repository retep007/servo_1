...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLFieldSetElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLFieldSetElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLFieldSetElement<TH> {
    fn eq(&self, other: &HTMLFieldSetElement<TH>) -> bool {
        self as *const HTMLFieldSetElement<TH> == &*other
    }
}

pub trait HTMLFieldSetElementMethods<TH: TypeHolderTrait> {
