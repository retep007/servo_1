...
pub use self::PerformancePaintTimingBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::PerformanceEntryBinding::PerformanceEntryBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
use dom::types::PerformancePaintTiming;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PerformancePaintTiming<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PerformancePaintTiming<TH>);
            }
            debug!("PerformancePaintTiming<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"PerformancePaintTiming\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::PerformanceEntry, PrototypeList::ID::PerformancePaintTiming, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { performanceentry: (::dom::bindings::codegen::InheritTypes::PerformanceEntryTypeId::PerformancePaintTiming) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PerformancePaintTiming<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<PerformancePaintTiming<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PerformancePaintTiming<TH>>) -> DomRoot<PerformancePaintTiming<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for PerformancePaintTiming<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for PerformancePaintTiming<TH> {
    fn eq(&self, other: &PerformancePaintTiming<TH>) -> bool {
        self as *const PerformancePaintTiming<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PerformancePaintTiming as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PerformancePaintTimingPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PerformancePaintTiming() {\n    [native code]\n}",
        PrototypeList::ID::PerformancePaintTiming,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    PerformanceEntryBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::PerformancePaintTiming as usize].is_null());
    (*cache)[PrototypeList::ID::PerformancePaintTiming as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PerformancePaintTiming as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    PerformanceEntryBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"PerformancePaintTiming\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod PerformancePaintTimingBinding
