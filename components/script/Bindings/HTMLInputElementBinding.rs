...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    HTMLElementBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    HTMLElementBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
