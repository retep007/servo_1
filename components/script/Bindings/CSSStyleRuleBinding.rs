...
const selectorText_getterinfo: JSJitInfo = JSJitInfo {
    call: get_selectorText as *const os::raw::c_void,
...
const selectorText_setterinfo: JSJitInfo = JSJitInfo {
    call: set_selectorText as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
const style_getterinfo: JSJitInfo = JSJitInfo {
    call: get_style as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const style_setterinfo: JSJitInfo = JSJitInfo {
    call: set_style as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &selectorText_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &selectorText_setterinfo }
    },
    JSPropertySpec {
        name: b"style\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &style_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &style_setterinfo }
    },
    JSPropertySpec {
