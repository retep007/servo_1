...
pub use self::CSSStyleRuleBinding::{Wrap, CSSStyleRuleMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::CSSRuleBinding::CSSRuleBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
unsafe extern fn get_selectorText<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSStyleRule<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.SelectorText();
...
unsafe extern fn set_selectorText<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const CSSStyleRule<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        ...
        let result: () = this.SetSelectorText(arg0);
...
fn selectorText_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_selectorText::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
...
fn selectorText_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_selectorText::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn set_style<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const CSSStyleRule<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        rooted!(in(cx) let mut v = UndefinedValue());
        if !JS_GetProperty(cx, obj, b"style\0" as *const u8 as *const libc::c_char, v.handle_mut()) {
            return false;
        }
        if !v.is_object() {
        ...
        JS_SetProperty(cx, target_obj.handle(), b"cssText\0" as *const u8 as *const libc::c_char, args.get(0))
...
fn style_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_style::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSStyleRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSStyleRule<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CSSStyleRule<TH>);
            }
            debug!("CSSStyleRule<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"CSSStyleRule\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::CSSRule, PrototypeList::ID::CSSStyleRule, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { cssrule: (::dom::bindings::codegen::InheritTypes::CSSRuleTypeId::CSSStyleRule) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<CSSStyleRule<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CSSStyleRule<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CSSStyleRule<TH>>) -> DomRoot<CSSStyleRule<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CSSStyleRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CSSStyleRule<TH> {
    fn eq(&self, other: &CSSStyleRule<TH>) -> bool {
        self as *const CSSStyleRule<TH> == &*other
    }
}

pub trait CSSStyleRuleMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSPropertySpec {
        name: b"selectorText\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &selectorText_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &selectorText_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: b"style\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &style_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &style_setterinfo::<TH>() }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSSStyleRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSStyleRulePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function CSSStyleRule() {\n    [native code]\n}",
        PrototypeList::ID::CSSStyleRule,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CSSStyleRule as usize].is_null());
    (*cache)[PrototypeList::ID::CSSStyleRule as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSSStyleRule as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    CSSRuleBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
