...
unsafe extern fn get_selectorText<TH: TypeHolderTrait>
...
unsafe extern fn set_selectorText<TH: TypeHolderTrait>
...
fn selectorText_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
fn selectorText_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn set_style<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const CSSStyleRule<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
...
fn style_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSStyleRule<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for CSSStyleRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CSSStyleRule<TH> {
    fn eq(&self, other: &CSSStyleRule<TH>) -> bool {
        self as *const CSSStyleRule<TH> == &*other
    }
}

pub trait CSSStyleRuleMethods<TH: TypeHolderTrait> {
