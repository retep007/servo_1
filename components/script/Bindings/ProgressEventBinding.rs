...
impl ProgressEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> ProgressEventInit {
        match ProgressEventInit::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = ProgressEventInit {
            parent: {
            ...
            lengthComputable: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "lengthComputable", rval.handle_mut())) {
                    true => {
            ...
            loaded: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "loaded", rval.handle_mut())) {
                    true => {
            ...
            total: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "total", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for ProgressEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<ProgressEventInit>, ()> {
        ProgressEventInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for ProgressEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        let lengthComputable = &self.lengthComputable;
        rooted!(in(cx) let mut lengthComputable_js = UndefinedValue());
        lengthComputable.to_jsval(cx, lengthComputable_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "lengthComputable", lengthComputable_js.handle()).unwrap();
        let loaded = &self.loaded;
        rooted!(in(cx) let mut loaded_js = UndefinedValue());
        loaded.to_jsval(cx, loaded_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "loaded", loaded_js.handle()).unwrap();
        let total = &self.total;
        rooted!(in(cx) let mut total_js = UndefinedValue());
        total.to_jsval(cx, total_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "total", total_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::ProgressEventBinding::{Wrap, ProgressEventMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_lengthComputable<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ProgressEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.LengthComputable();
...
fn lengthComputable_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_lengthComputable::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ProgressEvent as u16,
    depth: 1,
...
unsafe extern fn get_loaded<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ProgressEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: u64 = this.Loaded();
...
fn loaded_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_loaded::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ProgressEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_total<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ProgressEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: u64 = this.Total();
...
fn total_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_total::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ProgressEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ProgressEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ProgressEvent<TH>);
            }
            debug!("ProgressEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ProgressEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::ProgressEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::ProgressEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ProgressEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ProgressEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ProgressEvent<TH>>) -> DomRoot<ProgressEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ProgressEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ProgressEvent<TH> {
    fn eq(&self, other: &ProgressEvent<TH>) -> bool {
        self as *const ProgressEvent<TH> == &*other
    }
}
...
&[
    JSPropertySpec {
        name: b"lengthComputable\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &lengthComputable_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"loaded\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &loaded_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"total\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &total_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ProgressEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ProgressEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ProgressEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::ProgressEventBinding::ProgressEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::ProgressEventBinding::ProgressEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ProgressEvent() {\n    [native code]\n}",
        PrototypeList::ID::ProgressEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ProgressEvent as usize].is_null());
    (*cache)[PrototypeList::ID::ProgressEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ProgressEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
