...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLCollection<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLCollection<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLCollection<TH> {
    fn eq(&self, other: &HTMLCollection<TH>) -> bool {
        self as *const HTMLCollection<TH> == &*other
    }
}

pub trait HTMLCollectionMethods<TH: TypeHolderTrait> {
    fn Length(&self) -> u32;
