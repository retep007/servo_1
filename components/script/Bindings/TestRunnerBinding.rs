...
unsafe extern fn setBluetoothMockDataSet<TH: TypeHolderTrait>
...
fn setBluetoothMockDataSet_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TestRunner<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for TestRunner<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TestRunner<TH> {
