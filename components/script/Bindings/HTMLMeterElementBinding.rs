...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLMeterElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLMeterElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLMeterElement<TH> {
    fn eq(&self, other: &HTMLMeterElement<TH>) -> bool {
        self as *const HTMLMeterElement<TH> == &*other
    }
}

pub trait HTMLMeterElementMethods<TH: TypeHolderTrait> {
