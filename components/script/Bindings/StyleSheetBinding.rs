...
unsafe extern fn get_type_<TH: TypeHolderTrait>
...
fn type__getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<StyleSheet<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for StyleSheet<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for StyleSheet<TH> {
