...
pub use self::HTMLFormControlsCollectionBinding::{Wrap, HTMLFormControlsCollectionMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn namedItem<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLFormControlsCollection<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"HTMLFormControlsCollection.namedItem\".");
            return false;
        }
...
fn namedItem_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: namedItem::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLFormControlsCollection as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLFormControlsCollection<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut HTMLFormControlsCollection<TH>);
            }
            debug!("HTMLFormControlsCollection<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const HTMLFormControlsCollection<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const HTMLFormControlsCollection<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::HTMLCollection, PrototypeList::ID::HTMLFormControlsCollection, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { htmlcollection: (::dom::bindings::codegen::InheritTypes::HTMLCollectionTypeId::HTMLFormControlsCollection) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<HTMLFormControlsCollection<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"HTMLFormControlsCollection\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<HTMLFormControlsCollection<TH>>) -> DomRoot<HTMLFormControlsCollection<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::HTMLFormControlsCollection as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for HTMLFormControlsCollection<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for HTMLFormControlsCollection<TH> {
    fn eq(&self, other: &HTMLFormControlsCollection<TH>) -> bool {
        self as *const HTMLFormControlsCollection<TH> == &*other
    }
}

pub trait HTMLFormControlsCollectionMethods<TH: TypeHolderTrait<TH>> {
    fn NamedItem(&self, name: DOMString) -> Option<UnionTypes::RadioNodeListOrElement<TH>>;
    fn SupportedPropertyNames(&self) -> Vec<DOMString>;
    fn NamedGetter(&self, name: DOMString) -> Option<UnionTypes::RadioNodeListOrElement<TH>>;
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &namedItem_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HTMLFormControlsCollection as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HTMLFormControlsCollectionPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function HTMLFormControlsCollection() {\n    [native code]\n}",
        PrototypeList::ID::HTMLFormControlsCollection,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::HTMLFormControlsCollection as usize].is_null());
    (*cache)[PrototypeList::ID::HTMLFormControlsCollection as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HTMLFormControlsCollection as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"HTMLFormControlsCollection\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod HTMLFormControlsCollectionBinding
