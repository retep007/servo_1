...
fn namedItem_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLFormControlsCollection<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLFormControlsCollection<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLFormControlsCollection<TH> {
    fn eq(&self, other: &HTMLFormControlsCollection<TH>) -> bool {
        self as *const HTMLFormControlsCollection<TH> == &*other
    }
}

pub trait HTMLFormControlsCollectionMethods<TH: TypeHolderTrait> {
