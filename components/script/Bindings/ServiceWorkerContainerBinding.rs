...
impl RegistrationOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> RegistrationOptions {
        match RegistrationOptions::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<RegistrationOptions>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = RegistrationOptions {
            scope: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "scope", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for RegistrationOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RegistrationOptions>, ()> {
        RegistrationOptions::new(cx, value)
    }
}
...
impl ToJSValConvertible for RegistrationOptions {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        if let Some(ref scope) = self.scope {
            rooted!(in(cx) let mut scope_js = UndefinedValue());
            scope.to_jsval(cx, scope_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "scope", scope_js.handle()).unwrap();
        }
...
pub use self::ServiceWorkerContainerBinding::{Wrap, ServiceWorkerContainerMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_controller<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorkerContainer<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<ServiceWorker<TH>>> = this.GetController();
...
fn controller_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_controller::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ServiceWorkerContainer as u16,
    depth: 1,
...
unsafe extern fn register<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorkerContainer<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ServiceWorkerContainer.register\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::ServiceWorkerContainerBinding::RegistrationOptions = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::ServiceWorkerContainerBinding::RegistrationOptions::empty(cx)
        } else {
        ...
        let result: Rc<Promise<TH>> = this.Register(arg0, &arg1);
...
fn register_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: register::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ServiceWorkerContainer as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ServiceWorkerContainer<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ServiceWorkerContainer<TH>);
            }
            debug!("ServiceWorkerContainer<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ServiceWorkerContainer\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::ServiceWorkerContainer, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::ServiceWorkerContainer) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ServiceWorkerContainer<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ServiceWorkerContainer<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ServiceWorkerContainer<TH>>) -> DomRoot<ServiceWorkerContainer<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ServiceWorkerContainer<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ServiceWorkerContainer<TH> {
    fn eq(&self, other: &ServiceWorkerContainer<TH>) -> bool {
        self as *const ServiceWorkerContainer<TH> == &*other
    }
}

pub trait ServiceWorkerContainerMethods<TH: TypeHolderTrait<TH>> {
    fn GetController(&self) -> Option<DomRoot<ServiceWorker<TH>>>;
    fn Register(&self, scriptURL: USVString, options: &dom::bindings::codegen::Bindings::ServiceWorkerContainerBinding::RegistrationOptions) -> Rc<Promise<TH>>;
}
fn sMethods_specs<TH: TypeHolderTrait<TH>>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"register\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &register_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
...
&[
    JSPropertySpec {
        name: b"controller\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED | JSPROP_PERMANENT) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &controller_getterinfo::<TH>() },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ServiceWorkerContainer as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ServiceWorkerContainerPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ServiceWorkerContainer() {\n    [native code]\n}",
        PrototypeList::ID::ServiceWorkerContainer,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ServiceWorkerContainer as usize].is_null());
    (*cache)[PrototypeList::ID::ServiceWorkerContainer as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ServiceWorkerContainer as isize),
                                  ptr::null_mut(),
                                  prototype.get());
...
} // mod ServiceWorkerContainerBinding
