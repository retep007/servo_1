...
unsafe extern fn get_controller<TH: TypeHolderTrait>
...
fn controller_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn register<TH: TypeHolderTrait>
...
fn register_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ServiceWorkerContainer<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for ServiceWorkerContainer<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for ServiceWorkerContainer<TH> {
    fn eq(&self, other: &ServiceWorkerContainer<TH>) -> bool {
        self as *const ServiceWorkerContainer<TH> == &*other
    }
}

pub trait ServiceWorkerContainerMethods<TH: TypeHolderTrait> {
