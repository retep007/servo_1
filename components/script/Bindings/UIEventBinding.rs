    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            ...
            detail: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "detail", rval.handle_mut())) {
                    true => {
            ...
            view: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "view", rval.handle_mut())) {
                    true => {
...
impl<TH: TypeHolderTrait<TH>> FromJSValConvertible for UIEventInit<TH> {
    type Config = ();
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<UIEventInit<TH>>, ()> {
        UIEventInit::new(cx, value)
    }
}

impl<TH: TypeHolderTrait<TH>> ToJSValConvertible for UIEventInit<TH> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        rooted!(in(cx) let obj = JS_NewObject(cx, ptr::null()));
        let detail = &self.detail;
        rooted!(in(cx) let mut detail_js = UndefinedValue());
        detail.to_jsval(cx, detail_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "detail", detail_js.handle()).unwrap();
        let view = &self.view;
...
pub use self::UIEventBinding::{Wrap, UIEventMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
unsafe extern fn get_view<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const UIEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<Window<TH>>> = this.GetView();
...
fn view_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_view::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::UIEvent as u16,
    depth: 1,
...
unsafe extern fn get_detail<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const UIEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: i32 = this.Detail();
...
fn detail_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_detail::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::UIEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn initUIEvent<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const UIEvent<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 5 {
            throw_type_error(cx, "Not enough arguments to \"UIEvent.initUIEvent\".");
            return false;
        }
        ...
        let result: () = this.InitUIEvent(arg0, arg1, arg2, arg3.r(), arg4);
...
fn initUIEvent_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: initUIEvent::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::UIEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<UIEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut UIEvent<TH>);
            }
            debug!("UIEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<UIEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<UIEvent<TH>>) -> DomRoot<UIEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for UIEvent<TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class.interface_chain[1] == PrototypeList::ID::UIEvent
    }
}

impl<TH: TypeHolderTrait<TH>> PartialEq for UIEvent<TH> {
    fn eq(&self, other: &UIEvent<TH>) -> bool {
        self as *const UIEvent<TH> == &*other
    }
}

pub trait UIEventMethods<TH: TypeHolderTrait<TH>> {
    fn GetView(&self) -> Option<DomRoot<Window<TH>>>;
    fn Detail(&self) -> i32;
    fn InitUIEvent(&self, typeArg: DOMString, bubblesArg: bool, cancelableArg: bool, viewArg: Option<&Window<TH>>, detailArg: i32) -> ();
    fn IsTrusted(&self) -> bool;
}
fn sMethods_specs<TH: TypeHolderTrait<TH>>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"initUIEvent\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &initUIEvent_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 5,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &view_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"detail\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &detail_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::UIEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"UIEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"UIEvent.constructor\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let arg1: dom::bindings::codegen::Bindings::UIEventBinding::UIEventInit<TH> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::UIEventBinding::UIEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<UIEvent<TH>>, Error<TH>> = UIEvent::Constructor(&global, arg0, &arg1);
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::UIEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::UIEvent as usize].is_null());
    (*cache)[PrototypeList::ID::UIEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::UIEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    assert!((*cache)[PrototypeList::Constructor::UIEvent as usize].is_null());
    (*cache)[PrototypeList::Constructor::UIEvent as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::UIEvent as isize),
                                  ptr::null_mut(),
                                  interface.get());
