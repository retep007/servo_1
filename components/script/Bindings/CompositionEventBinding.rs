...
#[derive(JSTraceable)]
pub struct CompositionEventInit<TH: TypeHolderTrait<TH> + 'static> {
    pub parent: dom::bindings::codegen::Bindings::UIEventBinding::UIEventInit<TH>,
    pub data: DOMString,
}
impl<TH: TypeHolderTrait<TH>> CompositionEventInit<TH> {
...
impl<TH: TypeHolderTrait<TH>> FromJSValConvertible for CompositionEventInit<TH> {
    type Config = ();
...
impl<TH: TypeHolderTrait<TH>> ToJSValConvertible for CompositionEventInit<TH> {
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<CompositionEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CompositionEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CompositionEvent<TH> {
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg1: dom::bindings::codegen::Bindings::CompositionEventBinding::CompositionEventInit<TH> = if args.get(1).is_undefined() {
