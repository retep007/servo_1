...
unsafe extern fn get_control<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLabelElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn control_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLLabelElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLLabelElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLLabelElement<TH> {
    fn eq(&self, other: &HTMLLabelElement<TH>) -> bool {
        self as *const HTMLLabelElement<TH> == &*other
    }
}

pub trait HTMLLabelElementMethods<TH: TypeHolderTrait> {
