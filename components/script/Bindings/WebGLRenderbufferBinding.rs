...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    WebGLObjectBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    WebGLObjectBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
