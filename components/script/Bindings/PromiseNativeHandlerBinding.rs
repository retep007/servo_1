...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PromiseNativeHandler<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for PromiseNativeHandler<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PromiseNativeHandler<TH> {
