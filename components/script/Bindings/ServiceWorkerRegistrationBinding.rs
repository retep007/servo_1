...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ServiceWorkerRegistration<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<ServiceWorkerRegistration<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
