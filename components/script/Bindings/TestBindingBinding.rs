...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: bool = TestBinding::<TH>::BooleanAttributeStatic(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = TestBinding::<TH>::SetBooleanAttributeStatic(&global, arg0);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: () = TestBinding::<TH>::ReceiveVoidStatic(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: bool = TestBinding::<TH>::PrefControlledStaticAttributeDisabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: () = TestBinding::<TH>::PrefControlledStaticMethodDisabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: bool = TestBinding::<TH>::PrefControlledStaticAttributeEnabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: () = TestBinding::<TH>::PrefControlledStaticMethodEnabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: bool = TestBinding::<TH>::FuncControlledStaticAttributeDisabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: () = TestBinding::<TH>::FuncControlledStaticMethodDisabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: bool = TestBinding::<TH>::FuncControlledStaticAttributeEnabled(&global);
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        let result: () = TestBinding::<TH>::FuncControlledStaticMethodEnabled(&global);
...
const sStaticMethods: &'static [Guard<&'static [JSFunctionSpec]>] = &[
    ...
    //Guard::new(Condition::Func(TestBinding::condition_satisfied), sStaticMethods_specs[3]),
...
const sStaticAttributes: &'static [Guard<&'static [JSPropertySpec]>] = &[
    ...
    //Guard::new(Condition::Func(TestBinding::condition_satisfied), sStaticAttributes_specs[3]),
...
const sMethods: &'static [Guard<&'static [JSFunctionSpec]>] = &[
    ...
    //Guard::new(Condition::Func(TestBinding::condition_satisfied), sMethods_specs[4]),
...
const sAttributes: &'static [Guard<&'static [JSPropertySpec]>] = &[
    ...
    //Guard::new(Condition::Func(TestBinding::condition_satisfied), sAttributes_specs[3]),
...
const sConstants: &'static [Guard<&'static [ConstantSpec]>] = &[
    ...
    //Guard::new(Condition::Func(TestBinding::condition_satisfied), sConstants_specs[3]),
