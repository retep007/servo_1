...
unsafe extern fn devices<TH: TypeHolderTrait>
...
const devices_methodinfo: JSJitInfo = JSJitInfo {
...
impl<TH: TypeHolderTrait> IDLInterface for BluetoothPermissionResult<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for BluetoothPermissionResult<TH> {
    fn eq(&self, other: &BluetoothPermissionResult<TH>) -> bool {
        self as *const BluetoothPermissionResult<TH> == &*other
    }
}

pub trait BluetoothPermissionResultMethods<TH: TypeHolderTrait> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &devices_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    PermissionStatusBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    PermissionStatusBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
