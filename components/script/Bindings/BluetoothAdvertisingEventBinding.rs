...
impl<TH: TypeHolderTrait> BluetoothAdvertisingEventInit<TH> {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = BluetoothAdvertisingEventInit {
            parent: {
            ...
            appearance: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "appearance", rval.handle_mut())) {
                    true => {
            ...
            device: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "device", rval.handle_mut())) {
                    true => {
                        if rval.handle().get().is_object() {
                            match root_from_handlevalue(rval.handle()) {
                                Ok(val) => val,
                                Err(()) => {
                                    throw_type_error(cx, "value does not implement interface BluetoothDevice.");
                                    return Err(());
                                }
                            }
            ...
            rssi: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "rssi", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            txPower: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "txPower", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl<TH: TypeHolderTrait> FromJSValConvertible for BluetoothAdvertisingEventInit<TH> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<BluetoothAdvertisingEventInit<TH>>, ()> {
        BluetoothAdvertisingEventInit::new(cx, value)
    }
}
...
impl<TH: TypeHolderTrait> ToJSValConvertible for BluetoothAdvertisingEventInit<TH> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        if let Some(ref appearance) = self.appearance {
            rooted!(in(cx) let mut appearance_js = UndefinedValue());
            appearance.to_jsval(cx, appearance_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "appearance", appearance_js.handle()).unwrap();
        }
        ...
        if let Some(ref rssi) = self.rssi {
            rooted!(in(cx) let mut rssi_js = UndefinedValue());
            rssi.to_jsval(cx, rssi_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "rssi", rssi_js.handle()).unwrap();
        }
        if let Some(ref txPower) = self.txPower {
            rooted!(in(cx) let mut txPower_js = UndefinedValue());
            txPower.to_jsval(cx, txPower_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "txPower", txPower_js.handle()).unwrap();
        }
...
pub use self::BluetoothAdvertisingEventBinding::{Wrap, BluetoothAdvertisingEventMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::BluetoothAdvertisingEvent;
use dom::types::BluetoothDevice;
use dom::types::Event;
use dom::types::EventTarget;
use dom::windowproxy::WindowProxy;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothAdvertisingEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<u16> = this.GetAppearance();
...
const appearance_getterinfo: JSJitInfo = JSJitInfo {
    call: get_appearance as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothAdvertisingEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothAdvertisingEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<i8> = this.GetTxPower();
...
const txPower_getterinfo: JSJitInfo = JSJitInfo {
    call: get_txPower as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothAdvertisingEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothAdvertisingEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<i8> = this.GetRssi();
...
const rssi_getterinfo: JSJitInfo = JSJitInfo {
    call: get_rssi as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothAdvertisingEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothAdvertisingEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut BluetoothAdvertisingEvent<TH>);
            }
            debug!("BluetoothAdvertisingEvent<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::BluetoothAdvertisingEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::BluetoothAdvertisingEvent) },
...
&[
    ...
    JSPropertySpec {
        name: b"appearance\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &appearance_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"txPower\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &txPower_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"rssi\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &rssi_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BluetoothAdvertisingEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BluetoothAdvertisingEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothAdvertisingEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::BluetoothAdvertisingEventBinding::BluetoothAdvertisingEventInit = match FromJSValConvertible::from_jsval(cx, args.get(1), ()) {
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        PrototypeList::ID::BluetoothAdvertisingEvent,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BluetoothAdvertisingEvent as usize].is_null());
    (*cache)[PrototypeList::ID::BluetoothAdvertisingEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BluetoothAdvertisingEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
...
} // mod BluetoothAdvertisingEventBinding
