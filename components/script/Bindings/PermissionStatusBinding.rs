...
impl<TH: TypeHolderTrait> IDLInterface for PermissionStatus<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PermissionStatus<TH> {
    fn eq(&self, other: &PermissionStatus<TH>) -> bool {
        self as *const PermissionStatus<TH> == &*other
    }
}

pub trait PermissionStatusMethods<TH: TypeHolderTrait> {
