...
pub use self::HTMLIFrameElementBinding::{Wrap, HTMLIFrameElementMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn get_sandbox<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<DOMTokenList<TH>> = this.Sandbox();
...
unsafe extern fn set_sandbox<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        rooted!(in(cx) let mut v = UndefinedValue());
        if !JS_GetProperty(cx, obj, b"sandbox\0" as *const u8 as *const libc::c_char, v.handle_mut()) {
            return false;
        }
        if !v.is_object() {
            throw_type_error(cx, "Value.sandbox is not an object.");
            return false;
        }
...
fn sandbox_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn sandbox_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_allowFullscreen<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        push_new_element_queue::<TH>();

        let result: bool = this.AllowFullscreen();
        pop_current_element_queue::<TH>();
...
unsafe extern fn set_allowFullscreen<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        ...
        let result: () = this.SetAllowFullscreen(arg0);
        pop_current_element_queue::<TH>();
...
fn allowFullscreen_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn allowFullscreen_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_contentDocument<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<Document<TH>>> = this.GetContentDocument();
...
fn contentDocument_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_contentWindow<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<WindowProxy<TH>>> = this.GetContentWindow();
...
fn contentWindow_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_frameBorder<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        push_new_element_queue::<TH>();

        let result: DOMString = this.FrameBorder();
        pop_current_element_queue::<TH>();
...
unsafe extern fn set_frameBorder<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
        ...
        let result: () = this.SetFrameBorder(arg0);
        pop_current_element_queue::<TH>();
...
fn frameBorder_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn frameBorder_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLIFrameElement<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut HTMLIFrameElement<TH>);
            }
            debug!("HTMLIFrameElement<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"HTMLIFrameElement\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::Node, PrototypeList::ID::Element, PrototypeList::ID::HTMLElement, PrototypeList::ID::HTMLIFrameElement, PrototypeList::ID::Last ],
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<HTMLIFrameElement<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<HTMLIFrameElement<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<HTMLIFrameElement<TH>>) -> DomRoot<HTMLIFrameElement<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for HTMLIFrameElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for HTMLIFrameElement<TH> {
    fn eq(&self, other: &HTMLIFrameElement<TH>) -> bool {
        self as *const HTMLIFrameElement<TH> == &*other
    }
}

pub trait HTMLIFrameElementMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HTMLIFrameElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HTMLIFrameElementPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: Result<DomRoot<HTMLIFrameElement<TH>>, Error<TH>> = html_constructor(&global, &args);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function HTMLIFrameElement() {\n    [native code]\n}",
        PrototypeList::ID::HTMLIFrameElement,
        4) 
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::HTMLIFrameElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::HTMLIFrameElement as usize].is_null());
    (*cache)[PrototypeList::ID::HTMLIFrameElement as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HTMLIFrameElement as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"HTMLIFrameElement\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
    assert!((*cache)[PrototypeList::Constructor::HTMLIFrameElement as usize].is_null());
    (*cache)[PrototypeList::Constructor::HTMLIFrameElement as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::HTMLIFrameElement as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod HTMLIFrameElementBinding
