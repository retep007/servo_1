...
unsafe extern fn set_sandbox<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
...
unsafe extern fn set_allowFullscreen<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn set_frameBorder<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLIFrameElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLIFrameElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLIFrameElement<TH> {
    fn eq(&self, other: &HTMLIFrameElement<TH>) -> bool {
        self as *const HTMLIFrameElement<TH> == &*other
    }
}

pub trait HTMLIFrameElementMethods<TH: TypeHolderTrait> {
