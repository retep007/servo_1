...
pub use self::ServoParserBinding::{Wrap, GetProtoObject};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TH::ServoParser>(obj).unwrap();
            if !this.is_null() {
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ServoParser\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::ServoParser, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<TH::ServoParser> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH> + 'static>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<TH::ServoParser>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH> + 'static>
...
// impl<TH: TypeHolderTrait<TH>> IDLInterface for ServoParser<TH, TypeHolder=TH> {
//     #[inline]
...
// impl<TH: TypeHolderTrait<TH>> PartialEq for ServoParser<TH, TypeHolder=TH> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ServoParser as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ServoParserPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ServoParser as usize].is_null());
    (*cache)[PrototypeList::ID::ServoParser as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ServoParser as isize),
                                  ptr::null_mut(),
                                  prototype.get());

}
} // mod ServoParserBinding
