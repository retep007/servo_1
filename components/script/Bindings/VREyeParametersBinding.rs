...
unsafe extern fn get_offset<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VREyeParameters<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for VREyeParameters<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for VREyeParameters<TH> {
    fn eq(&self, other: &VREyeParameters<TH>) -> bool {
        self as *const VREyeParameters<TH> == &*other
    }
}

pub trait VREyeParametersMethods<TH: TypeHolderTrait> {
