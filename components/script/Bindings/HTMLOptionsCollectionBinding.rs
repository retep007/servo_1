...
() -> *const libc::c_void {
    let traps = ProxyTraps {
        ...
        defineProperty: Some(defineProperty::<TH>),
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    HTMLCollectionBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    HTMLCollectionBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
