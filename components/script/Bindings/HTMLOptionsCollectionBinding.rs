...
pub use self::HTMLOptionsCollectionBinding::{Wrap, HTMLOptionsCollectionMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLOptionsCollection<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLOptionsCollection<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"HTMLOptionsCollection.add\".");
            return false;
        }
...
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLOptionsCollection<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"HTMLOptionsCollection.remove\".");
            return false;
        }
...
unsafe extern fn get_selectedIndex<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLOptionsCollection<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn set_selectedIndex<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLOptionsCollection<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: i32 = match FromJSValConvertible::from_jsval(cx, args.get(0), ConversionBehavior::Default) {
...
fn selectedIndex_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn selectedIndex_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLOptionsCollection<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut HTMLOptionsCollection<TH>);
            }
            debug!("HTMLOptionsCollection<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const HTMLOptionsCollection<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const HTMLOptionsCollection<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::HTMLCollection, PrototypeList::ID::HTMLOptionsCollection, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { htmlcollection: (::dom::bindings::codegen::InheritTypes::HTMLCollectionTypeId::HTMLOptionsCollection) },
    global: InterfaceObjectMap::Globals::EMPTY,
	malloc_size_of: malloc_size_of_including_raw_self::<HTMLOptionsCollection<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if index.is_none() && (RUST_JSID_IS_STRING(id) || RUST_JSID_IS_INT(id)) {
            ...
            if !has_on_proto {
                ...
                let this = UnwrapProxy(proxy);
                let this = &*this;
                let result: Option<DomRoot<Element<TH>>> = this.NamedGetter(name);
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"HTMLOptionsCollection\0" as *const u8 as *const i8
}
...
unsafe extern fn defineProperty<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawHandle<PropertyDescriptor>, opresult: *mut ObjectOpResult) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let option: Option<DomRoot<HTMLOptionElement<TH>>> = if value.handle().get().is_object() {
                Some(match root_from_handlevalue(value.handle()) {
                    Ok(val) => val,
                    Err(()) => {
                        throw_type_error(cx, "value does not implement interface HTMLOptionElement.");
                        return false;
                    }
                }
                )
            } else if value.handle().get().is_null_or_undefined() {
                None
            } else {
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<HTMLOptionsCollection<TH>>) -> DomRoot<HTMLOptionsCollection<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::HTMLOptionsCollection as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for HTMLOptionsCollection<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for HTMLOptionsCollection<TH> {
    fn eq(&self, other: &HTMLOptionsCollection<TH>) -> bool {
        self as *const HTMLOptionsCollection<TH> == &*other
    }
}

pub trait HTMLOptionsCollectionMethods<TH: TypeHolderTrait<TH>> {
    fn Length(&self) -> u32;
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HTMLOptionsCollection as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HTMLOptionsCollectionPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function HTMLOptionsCollection() {\n    [native code]\n}",
        PrototypeList::ID::HTMLOptionsCollection,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    HTMLCollectionBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::HTMLOptionsCollection as usize].is_null());
    (*cache)[PrototypeList::ID::HTMLOptionsCollection as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HTMLOptionsCollection as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    HTMLCollectionBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"HTMLOptionsCollection\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod HTMLOptionsCollectionBinding
