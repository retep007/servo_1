...
pub use self::BluetoothRemoteGATTCharacteristicBinding::{Wrap, BluetoothRemoteGATTCharacteristicMethods, GetProtoObject, DefineDOMInterface};
...
use dom::types::BluetoothCharacteristicProperties;
...
fn service_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_service::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
...
unsafe extern fn get_properties<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<BluetoothCharacteristicProperties<TH>> = this.Properties();
...
fn properties_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo {JSJitInfo {
    call: get_properties::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn getDescriptor<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothRemoteGATTCharacteristic.getDescriptor\".");
            return false;
        }
        ...
        let result: Rc<Promise<TH>> = this.GetDescriptor(arg0);
...
fn getDescriptor_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getDescriptor::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn getDescriptors<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let result: Rc<Promise<TH>> = this.GetDescriptors(arg0);
...
fn getDescriptors_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getDescriptors::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn readValue<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn readValue_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: readValue::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn writeValue<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothRemoteGATTCharacteristic.writeValue\".");
            return false;
        }
...
fn writeValue_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo {JSJitInfo {
...
unsafe extern fn startNotifications<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: Rc<Promise<TH>> = this.StartNotifications();
...
fn startNotifications_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: startNotifications::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn stopNotifications<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: Rc<Promise<TH>> = this.StopNotifications();
...
fn stopNotifications_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: stopNotifications::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn get_oncharacteristicvaluechanged<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn set_oncharacteristicvaluechanged<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const BluetoothRemoteGATTCharacteristic<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.SetOncharacteristicvaluechanged(arg0);
...
fn oncharacteristicvaluechanged_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_oncharacteristicvaluechanged::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn oncharacteristicvaluechanged_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_oncharacteristicvaluechanged::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothRemoteGATTCharacteristic<TH>>(obj).unwrap();
            ...
            debug!("BluetoothRemoteGATTCharacteristic<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"BluetoothRemoteGATTCharacteristic\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::BluetoothRemoteGATTCharacteristic, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::BluetoothRemoteGATTCharacteristic) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<BluetoothRemoteGATTCharacteristic<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<BluetoothRemoteGATTCharacteristic<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<BluetoothRemoteGATTCharacteristic<TH>>) -> DomRoot<BluetoothRemoteGATTCharacteristic<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for BluetoothRemoteGATTCharacteristic<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for BluetoothRemoteGATTCharacteristic<TH> {
    fn eq(&self, other: &BluetoothRemoteGATTCharacteristic<TH>) -> bool {
        self as *const BluetoothRemoteGATTCharacteristic<TH> == &*other
    }
}

pub trait BluetoothRemoteGATTCharacteristicMethods<TH: TypeHolderTrait<TH>> {
    ...
    fn GetDescriptor(&self, descriptor: UnionTypes::StringOrUnsignedLong) -> Rc<Promise<TH>>;
    fn GetDescriptors(&self, descriptor: Option<UnionTypes::StringOrUnsignedLong>) -> Rc<Promise<TH>>;
    ...
    fn GetOncharacteristicvaluechanged(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>>;
    fn SetOncharacteristicvaluechanged(&self, value: Option<Rc<EventHandlerNonNull<TH>>>) -> ();
}
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getDescriptor_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getDescriptors\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getDescriptors_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &readValue_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &writeValue_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"startNotifications\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &startNotifications_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"stopNotifications\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &stopNotifications_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSPropertySpec {
        name: b"service\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &service_getterinfo::<TH>() },
    ...
    JSPropertySpec {
        name: b"properties\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &properties_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
    ...
    JSPropertySpec {
        name: b"oncharacteristicvaluechanged\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &oncharacteristicvaluechanged_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &oncharacteristicvaluechanged_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
        flags: 0,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BluetoothRemoteGATTCharacteristic as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BluetoothRemoteGATTCharacteristicPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function BluetoothRemoteGATTCharacteristic() {\n    [native code]\n}",
        PrototypeList::ID::BluetoothRemoteGATTCharacteristic,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BluetoothRemoteGATTCharacteristic as usize].is_null());
    (*cache)[PrototypeList::ID::BluetoothRemoteGATTCharacteristic as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BluetoothRemoteGATTCharacteristic as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"BluetoothRemoteGATTCharacteristic\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod BluetoothRemoteGATTCharacteristicBinding
