...
const service_getterinfo: JSJitInfo = JSJitInfo {
    call: get_service as *const os::raw::c_void,
...
const properties_getterinfo: JSJitInfo = JSJitInfo {
    call: get_properties as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const getDescriptor_methodinfo: JSJitInfo = JSJitInfo {
    call: getDescriptor as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
const getDescriptors_methodinfo: JSJitInfo = JSJitInfo {
    call: getDescriptors as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
const startNotifications_methodinfo: JSJitInfo = JSJitInfo {
    call: startNotifications as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
const stopNotifications_methodinfo: JSJitInfo = JSJitInfo {
    call: stopNotifications as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
const oncharacteristicvaluechanged_getterinfo: JSJitInfo = JSJitInfo {
    call: get_oncharacteristicvaluechanged as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const oncharacteristicvaluechanged_setterinfo: JSJitInfo = JSJitInfo {
    call: set_oncharacteristicvaluechanged as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTCharacteristic as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getDescriptor_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getDescriptors_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &startNotifications_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &stopNotifications_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &service_getterinfo },
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &properties_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &oncharacteristicvaluechanged_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &oncharacteristicvaluechanged_setterinfo }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
        flags: 0,
