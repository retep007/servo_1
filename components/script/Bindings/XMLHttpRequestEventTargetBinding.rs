...
pub use self::XMLHttpRequestEventTargetBinding::{XMLHttpRequestEventTargetMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
(cx: *mut JSContext, obj: HandleObject, this: *const XMLHttpRequestEventTarget<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
unsafe extern fn get_ontimeout<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const XMLHttpRequestEventTarget<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>> = this.GetOntimeout();
...
unsafe extern fn set_ontimeout<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const XMLHttpRequestEventTarget<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: Option<Rc<EventHandlerNonNull<TH>>> = if args.get(0).get().is_object() {
        ...
        let result: () = this.SetOntimeout(arg0);
...
fn ontimeout_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn ontimeout_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for XMLHttpRequestEventTarget<TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class.interface_chain[1] == PrototypeList::ID::XMLHttpRequestEventTarget
    }
}

impl<TH: TypeHolderTrait<TH>> PartialEq for XMLHttpRequestEventTarget<TH> {
    fn eq(&self, other: &XMLHttpRequestEventTarget<TH>) -> bool {
        self as *const XMLHttpRequestEventTarget<TH> == &*other
    }
}

pub trait XMLHttpRequestEventTargetMethods<TH: TypeHolderTrait<TH>> {
    ...
    fn GetOntimeout(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>>;
    fn SetOntimeout(&self, value: Option<Rc<EventHandlerNonNull<TH>>>) -> ();
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::XMLHttpRequestEventTarget as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"XMLHttpRequestEventTargetPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function XMLHttpRequestEventTarget() {\n    [native code]\n}",
        PrototypeList::ID::XMLHttpRequestEventTarget,
        1);
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::XMLHttpRequestEventTarget as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::XMLHttpRequestEventTarget as usize].is_null());
    (*cache)[PrototypeList::ID::XMLHttpRequestEventTarget as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::XMLHttpRequestEventTarget as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"XMLHttpRequestEventTarget\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
    assert!((*cache)[PrototypeList::Constructor::XMLHttpRequestEventTarget as usize].is_null());
    (*cache)[PrototypeList::Constructor::XMLHttpRequestEventTarget as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::XMLHttpRequestEventTarget as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod XMLHttpRequestEventTargetBinding
