...
unsafe extern fn get_gamepad<TH: TypeHolderTrait>
...
fn gamepad_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<GamepadEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for GamepadEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for GamepadEvent<TH> {
    fn eq(&self, other: &GamepadEvent<TH>) -> bool {
        self as *const GamepadEvent<TH> == &*other
    }
}

pub trait GamepadEventMethods<TH: TypeHolderTrait> {
