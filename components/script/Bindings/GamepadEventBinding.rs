...
const gamepad_getterinfo: JSJitInfo = JSJitInfo {
    call: get_gamepad as *const os::raw::c_void,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &gamepad_getterinfo },
