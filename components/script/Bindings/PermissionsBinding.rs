...
unsafe extern fn query<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Permissions<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for Permissions<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for Permissions<TH> {
    fn eq(&self, other: &Permissions<TH>) -> bool {
        self as *const Permissions<TH> == &*other
    }
}

pub trait PermissionsMethods<TH: TypeHolderTrait> {
