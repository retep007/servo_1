...
const target_setterinfo: JSJitInfo = JSJitInfo {
    call: set_target as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
const rel_getterinfo: JSJitInfo = JSJitInfo {
    call: get_rel as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const rel_setterinfo: JSJitInfo = JSJitInfo {
    call: set_rel as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const relList_getterinfo: JSJitInfo = JSJitInfo {
    call: get_relList as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const text_getterinfo: JSJitInfo = JSJitInfo {
    call: get_text as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const text_setterinfo: JSJitInfo = JSJitInfo {
    call: set_text as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const coords_getterinfo: JSJitInfo = JSJitInfo {
    call: get_coords as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const coords_setterinfo: JSJitInfo = JSJitInfo {
    call: set_coords as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const rev_getterinfo: JSJitInfo = JSJitInfo {
    call: get_rev as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const rev_setterinfo: JSJitInfo = JSJitInfo {
    call: set_rev as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const shape_getterinfo: JSJitInfo = JSJitInfo {
    call: get_shape as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const shape_setterinfo: JSJitInfo = JSJitInfo {
    call: set_shape as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLAnchorElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
&[
    JSPropertySpec {
        ...
        setter: JSNativeWrapper { op: Some(generic_setter), info: &target_setterinfo }
    },
    JSPropertySpec {
        name: b"rel\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &rel_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &rel_setterinfo }
    },
    JSPropertySpec {
        name: b"relList\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &relList_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"text\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &text_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &text_setterinfo }
    },
    JSPropertySpec {
        name: b"coords\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &coords_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &coords_setterinfo }
    },
    JSPropertySpec {
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &rev_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &rev_setterinfo }
    },
    JSPropertySpec {
        name: b"shape\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &shape_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &shape_setterinfo }
    },
    JSPropertySpec {
