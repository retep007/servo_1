...
pub use self::CSSBinding::{GetProtoObject, DefineDOMInterface};
pub mod CSSBinding {
#![allow(non_camel_case_types,non_upper_case_globals,unused_imports,unused_variables,unused_assignments,unused_mut)]
use dom;
use dom::bindings;
...
unsafe extern fn escape<TH: TypeHolderTrait<TH>>(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CSS.escape\".");
            return false;
        }
...
unsafe extern fn supports<TH: TypeHolderTrait<TH>>(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        ...
        match argcount {
            1 => {
                ...
                let result: bool = CSS::Supports_(&global, arg0);
            ...
            2 => {
                ...
                let result: bool = CSS::Supports(&global, arg0, arg1);

                (result).to_jsval(cx, args.rval());
                return true;
            }
            _ => {
                throw_type_error(cx, "Not enough arguments to \"CSS.supports\".");
                return false;
            }
        }
    }), false);
...
unsafe extern fn get_paintWorklet<TH: TypeHolderTrait<TH>>(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(escape), info: 0 as *const JSJitInfo },
        nargs: 1,
...
pub unsafe fn GetProtoObject(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSS as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
unsafe fn CreateInterfaceObjects<TH: TypeHolderTrait<TH>>(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CSS as usize].is_null());
    (*cache)[PrototypeList::ID::CSS as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSS as isize),
                                  ptr::null_mut(),
                                  prototype.get());
