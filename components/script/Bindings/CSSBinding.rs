...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(escape)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(supports)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: /*Some(get_paintWorklet)*/None, info: 0 as *const JSJitInfo },
...
pub unsafe fn GetProtoObject<TH: TypeHolderTrait>(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
