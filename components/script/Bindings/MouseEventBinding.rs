    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            ...
            button: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "button", rval.handle_mut())) {
                    true => {
            ...
            clientX: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "clientX", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            clientY: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "clientY", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            relatedTarget: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "relatedTarget", rval.handle_mut())) {
                    true => {
                        if rval.handle().get().is_object() {
                            Some(match root_from_handlevalue(rval.handle()) {
                                Ok(val) => val,
                                Err(()) => {
            ...
            screenX: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "screenX", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            screenY: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "screenY", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ConversionBehavior::Default) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl<TH: TypeHolderTrait> ToJSValConvertible for MouseEventInit<TH> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut button_js = UndefinedValue());
        button.to_jsval(cx, button_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "button", button_js.handle()).unwrap();
        let clientX = &self.clientX;
        rooted!(in(cx) let mut clientX_js = UndefinedValue());
        clientX.to_jsval(cx, clientX_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "clientX", clientX_js.handle()).unwrap();
        let clientY = &self.clientY;
        rooted!(in(cx) let mut clientY_js = UndefinedValue());
        clientY.to_jsval(cx, clientY_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "clientY", clientY_js.handle()).unwrap();
        let relatedTarget = &self.relatedTarget;
        rooted!(in(cx) let mut relatedTarget_js = UndefinedValue());
        relatedTarget.to_jsval(cx, relatedTarget_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "relatedTarget", relatedTarget_js.handle()).unwrap();
        let screenX = &self.screenX;
        rooted!(in(cx) let mut screenX_js = UndefinedValue());
        screenX.to_jsval(cx, screenX_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "screenX", screenX_js.handle()).unwrap();
        let screenY = &self.screenY;
        rooted!(in(cx) let mut screenY_js = UndefinedValue());
        screenY.to_jsval(cx, screenY_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "screenY", screenY_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::MouseEventBinding::{Wrap, MouseEventMethods, GetProtoObject, DefineDOMInterface};
...
const button_getterinfo: JSJitInfo = JSJitInfo {
    call: get_button as *const os::raw::c_void,
    protoID: PrototypeList::ID::MouseEvent as u16,
    depth: 2,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MouseEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<EventTarget<TH>>> = this.GetRelatedTarget();
...
const relatedTarget_getterinfo: JSJitInfo = JSJitInfo {
    call: get_relatedTarget as *const os::raw::c_void,
    protoID: PrototypeList::ID::MouseEvent as u16,
    depth: 2,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MouseEvent<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 15 {
            throw_type_error(cx, "Not enough arguments to \"MouseEvent.initMouseEvent\".");
            return false;
        }
        ...
        let arg8: i32 = match FromJSValConvertible::from_jsval(cx, args.get(8), ConversionBehavior::Default) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg9: bool = match FromJSValConvertible::from_jsval(cx, args.get(9), ()) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg10: bool = match FromJSValConvertible::from_jsval(cx, args.get(10), ()) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg11: bool = match FromJSValConvertible::from_jsval(cx, args.get(11), ()) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg12: bool = match FromJSValConvertible::from_jsval(cx, args.get(12), ()) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg13: i16 = match FromJSValConvertible::from_jsval(cx, args.get(13), ConversionBehavior::Default) {
            Ok(ConversionResult::Success(v)) => v,
            Ok(ConversionResult::Failure(error)) => {
                throw_type_error(cx, &error);
                return false;
        ...
        let arg14: Option<DomRoot<EventTarget<TH>>> = if args.get(14).get().is_object() {
            Some(match root_from_handlevalue(args.get(14)) {
                Ok(val) => val,
                Err(()) => {
                    throw_type_error(cx, "value does not implement interface EventTarget.");
                    return false;
        ...
        } else if args.get(14).get().is_null_or_undefined() {
            None
        } else {
            throw_type_error(cx, "Value is not an object.");
            return false;
        ...
        let result: () = this.InitMouseEvent(arg0, arg1, arg2, arg3.r(), arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14.r());
...
const initMouseEvent_methodinfo: JSJitInfo = JSJitInfo {
    call: initMouseEvent as *const os::raw::c_void,
    protoID: PrototypeList::ID::MouseEvent as u16,
    depth: 2,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MouseEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut MouseEvent<TH>);
            }
            debug!("MouseEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::UIEvent, PrototypeList::ID::MouseEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::UIEvent(::dom::bindings::codegen::InheritTypes::UIEventTypeId::MouseEvent)) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<MouseEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &initMouseEvent_methodinfo as *const _ as *const JSJitInfo },
        nargs: 15,
...
&[
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &button_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"relatedTarget\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &relatedTarget_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
...
const sAttributes: &'static [Guard<&'static [JSPropertySpec]>] = &[
    ...
    Guard::new(Condition::Pref("dom.mouseevent.which.enabled"), sAttributes_specs[1])
];
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::MouseEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"MouseEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MouseEvent.constructor\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let arg1: dom::bindings::codegen::Bindings::MouseEventBinding::MouseEventInit<TH> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::MouseEventBinding::MouseEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<MouseEvent<TH>>, Error<TH>> = MouseEvent::Constructor(&global, arg0, &arg1);
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function MouseEvent() {\n    [native code]\n}",
        PrototypeList::ID::MouseEvent,
        2);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::MouseEvent as usize].is_null());
    (*cache)[PrototypeList::ID::MouseEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::MouseEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
