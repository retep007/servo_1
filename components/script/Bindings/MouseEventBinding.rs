...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MouseEvent<TH>>(obj).unwrap();
            if !this.is_null() {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    UIEventBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    UIEventBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
