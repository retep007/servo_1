...
pub struct HashChangeEventInit {
    ...
    pub newURL: USVString,
    pub oldURL: USVString,
}
impl HashChangeEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> HashChangeEventInit {
        match HashChangeEventInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<HashChangeEventInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = HashChangeEventInit {
            parent: {
            ...
            newURL: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "newURL", rval.handle_mut())) {
                    true => {
            ...
            oldURL: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "oldURL", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(strval)) => strval,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for HashChangeEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<HashChangeEventInit>, ()> {
        HashChangeEventInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for HashChangeEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        let newURL = &self.newURL;
        rooted!(in(cx) let mut newURL_js = UndefinedValue());
        newURL.to_jsval(cx, newURL_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "newURL", newURL_js.handle()).unwrap();
        let oldURL = &self.oldURL;
        rooted!(in(cx) let mut oldURL_js = UndefinedValue());
        oldURL.to_jsval(cx, oldURL_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "oldURL", oldURL_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::HashChangeEventBinding::{Wrap, HashChangeEventMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_oldURL<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HashChangeEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: USVString = this.OldURL();
...
fn oldURL_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_oldURL::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HashChangeEvent as u16,
    depth: 1,
...
unsafe extern fn get_newURL<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HashChangeEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: USVString = this.NewURL();
...
fn newURL_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_newURL::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HashChangeEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HashChangeEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut HashChangeEvent<TH>);
            }
            debug!("HashChangeEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"HashChangeEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::HashChangeEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::HashChangeEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<HashChangeEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<HashChangeEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<HashChangeEvent<TH>>) -> DomRoot<HashChangeEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for HashChangeEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for HashChangeEvent<TH> {
    fn eq(&self, other: &HashChangeEvent<TH>) -> bool {
        self as *const HashChangeEvent<TH> == &*other
    }
}
...
&[
    JSPropertySpec {
        name: b"oldURL\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &oldURL_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"newURL\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &newURL_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HashChangeEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HashChangeEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"HashChangeEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::HashChangeEventBinding::HashChangeEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::HashChangeEventBinding::HashChangeEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function HashChangeEvent() {\n    [native code]\n}",
        PrototypeList::ID::HashChangeEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::HashChangeEvent as usize].is_null());
    (*cache)[PrototypeList::ID::HashChangeEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HashChangeEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
