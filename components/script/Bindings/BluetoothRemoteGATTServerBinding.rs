...
pub use self::BluetoothRemoteGATTServerBinding::{Wrap, BluetoothRemoteGATTServerMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn device_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::BluetoothRemoteGATTServer as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.Connected();
...
unsafe extern fn connect<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: Rc<Promise<TH>> = this.Connect();
...
fn connect_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: connect::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTServer as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn disconnect<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn disconnect_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn getPrimaryService<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothRemoteGATTServer.getPrimaryService\".");
            return false;
        }
        ...
        let result: Rc<Promise<TH>> = this.GetPrimaryService(arg0);
...
fn getPrimaryService_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getPrimaryService::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTServer as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn getPrimaryServices<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothRemoteGATTServer<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let result: Rc<Promise<TH>> = this.GetPrimaryServices(arg0);
...
fn getPrimaryServices_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getPrimaryServices::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothRemoteGATTServer as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothRemoteGATTServer<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut BluetoothRemoteGATTServer<TH>);
            }
            debug!("BluetoothRemoteGATTServer<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"BluetoothRemoteGATTServer\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::BluetoothRemoteGATTServer, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<BluetoothRemoteGATTServer<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<BluetoothRemoteGATTServer<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<BluetoothRemoteGATTServer<TH>>) -> DomRoot<BluetoothRemoteGATTServer<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for BluetoothRemoteGATTServer<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for BluetoothRemoteGATTServer<TH> {
    fn eq(&self, other: &BluetoothRemoteGATTServer<TH>) -> bool {
        self as *const BluetoothRemoteGATTServer<TH> == &*other
    }
}

pub trait BluetoothRemoteGATTServerMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &connect_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
    ...
    JSFunctionSpec {
        name: b"getPrimaryService\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getPrimaryService_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getPrimaryServices\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getPrimaryServices_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BluetoothRemoteGATTServer as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BluetoothRemoteGATTServerPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function BluetoothRemoteGATTServer() {\n    [native code]\n}",
        PrototypeList::ID::BluetoothRemoteGATTServer,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BluetoothRemoteGATTServer as usize].is_null());
    (*cache)[PrototypeList::ID::BluetoothRemoteGATTServer as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BluetoothRemoteGATTServer as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"BluetoothRemoteGATTServer\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod BluetoothRemoteGATTServerBinding
