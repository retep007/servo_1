...
impl DOMPointInit {
    pub unsafe fn empty(cx: *mut JSContext) -> DOMPointInit {
        match DOMPointInit::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = DOMPointInit {
            w: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "w", rval.handle_mut())) {
                    true => {
            ...
            x: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "x", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            y: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "y", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            z: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "z", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl ToJSValConvertible for DOMPointInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        let w = &self.w;
        rooted!(in(cx) let mut w_js = UndefinedValue());
        w.to_jsval(cx, w_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "w", w_js.handle()).unwrap();
        let x = &self.x;
...
pub use self::DOMPointBinding::{Wrap, DOMPointMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_x<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: f64 = this.X();
...
unsafe extern fn set_x<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn x_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_x::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
...
fn x_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_x::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn get_y<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: f64 = this.Y();
...
unsafe extern fn set_y<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: f64 = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
...
fn y_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
fn y_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_y::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn get_z<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: f64 = this.Z();
...
unsafe extern fn set_z<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: f64 = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
...
fn z_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_z::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn z_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_z::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn get_w<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: f64 = this.W();
...
unsafe extern fn set_w<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const DOMPoint<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: f64 = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
...
fn w_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_w::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn w_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_w::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMPoint as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMPoint<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DOMPoint<TH>);
            }
            debug!("DOMPoint<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"DOMPoint\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::DOMPointReadOnly, PrototypeList::ID::DOMPoint, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { dompointreadonly: (::dom::bindings::codegen::InheritTypes::DOMPointReadOnlyTypeId::DOMPoint) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<DOMPoint<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<DOMPoint<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<DOMPoint<TH>>) -> DomRoot<DOMPoint<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMPoint<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMPoint<TH> {
    fn eq(&self, other: &DOMPoint<TH>) -> bool {
        self as *const DOMPoint<TH> == &*other
    }
}

pub trait DOMPointMethods {
    fn X(&self) -> f64;
...
&[
    JSPropertySpec {
        ...
        setter: JSNativeWrapper { op: Some(generic_setter), info: &x_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: b"y\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &y_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &y_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: b"z\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &z_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &z_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: b"w\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &w_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &w_setterinfo::<TH>() }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DOMPoint as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DOMPointPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: Result<DomRoot<DOMPoint<TH>>, Error<TH>> = DOMPoint::Constructor(&global, arg0, arg1, arg2, arg3);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    DOMPointReadOnlyBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::DOMPoint as usize].is_null());
    (*cache)[PrototypeList::ID::DOMPoint as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMPoint as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    DOMPointReadOnlyBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
