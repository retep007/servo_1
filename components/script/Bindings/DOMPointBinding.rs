...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    DOMPointReadOnlyBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    DOMPointReadOnlyBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
