...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    StyleSheetBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    StyleSheetBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
