...
fn validity_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLButtonElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLButtonElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLButtonElement<TH> {
    fn eq(&self, other: &HTMLButtonElement<TH>) -> bool {
        self as *const HTMLButtonElement<TH> == &*other
    }
}

pub trait HTMLButtonElementMethods<TH: TypeHolderTrait> {
