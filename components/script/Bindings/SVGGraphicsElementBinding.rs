...
pub use self::SVGGraphicsElementBinding::{GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::SVGElementBinding::SVGElementBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for SVGGraphicsElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for SVGGraphicsElement<TH> {
    fn eq(&self, other: &SVGGraphicsElement<TH>) -> bool {
        self as *const SVGGraphicsElement<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::SVGGraphicsElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::SVGGraphicsElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    SVGElementBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    SVGElementBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
