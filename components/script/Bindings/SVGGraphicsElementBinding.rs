...
impl<TH: TypeHolderTrait> IDLInterface for SVGGraphicsElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for SVGGraphicsElement<TH> {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    SVGElementBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    SVGElementBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
