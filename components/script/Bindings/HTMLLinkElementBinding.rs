...
pub use self::HTMLLinkElementBinding::{Wrap, HTMLLinkElementMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        push_new_element_queue::<TH>();

        let result: DOMString = this.Href();
...
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn href_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: DOMString = this.Media();
        pop_current_element_queue::<TH>();
...
unsafe extern fn set_media<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
fn media_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_media::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn get_hreflang<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        push_new_element_queue::<TH>();

        let result: DOMString = this.Hreflang();
        pop_current_element_queue::<TH>();
...
unsafe extern fn set_hreflang<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
        ...
        let result: () = this.SetHreflang(arg0);
        pop_current_element_queue::<TH>();
...
fn hreflang_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_hreflang::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn hreflang_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_hreflang::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn set_integrity<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
        ...
        let result: () = this.SetIntegrity(arg0);
        pop_current_element_queue::<TH>();
...
fn integrity_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_integrity::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn set_charset<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
        ...
        let result: () = this.SetCharset(arg0);
        pop_current_element_queue::<TH>();
...
fn charset_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_charset::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
unsafe extern fn get_sheet<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<StyleSheet<TH>>> = this.GetSheet();
...
fn sheet_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_sheet::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLLinkElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLLinkElement<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut HTMLLinkElement<TH>);
            }
            debug!("HTMLLinkElement<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"HTMLLinkElement\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::Node, PrototypeList::ID::Element, PrototypeList::ID::HTMLElement, PrototypeList::ID::HTMLLinkElement, PrototypeList::ID::Last ],
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<HTMLLinkElement<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<HTMLLinkElement<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<HTMLLinkElement<TH>>) -> DomRoot<HTMLLinkElement<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for HTMLLinkElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for HTMLLinkElement<TH> {
    fn eq(&self, other: &HTMLLinkElement<TH>) -> bool {
        self as *const HTMLLinkElement<TH> == &*other
    }
}

pub trait HTMLLinkElementMethods<TH: TypeHolderTrait<TH>> {
    ...
    fn GetSheet(&self) -> Option<DomRoot<StyleSheet<TH>>>;
}
...
&[
    ...
    JSPropertySpec {
        ...
        setter: JSNativeWrapper { op: Some(generic_setter), info: &media_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: b"hreflang\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &hreflang_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &hreflang_setterinfo::<TH>() }
    },
    JSPropertySpec {
    ...
    JSPropertySpec {
        ...
        setter: JSNativeWrapper { op: Some(generic_setter), info: &integrity_setterinfo::<TH>() }
    },
    JSPropertySpec {
        ...
        setter: JSNativeWrapper { op: Some(generic_setter), info: &charset_setterinfo::<TH>() }
    },
    JSPropertySpec {
    ...
    JSPropertySpec {
        name: b"sheet\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &sheet_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HTMLLinkElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HTMLLinkElementPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: Result<DomRoot<HTMLLinkElement<TH>>, Error<TH>> = html_constructor(&global, &args);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function HTMLLinkElement() {\n    [native code]\n}",
        PrototypeList::ID::HTMLLinkElement,
        4) 
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::HTMLLinkElement as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::HTMLLinkElement as usize].is_null());
    (*cache)[PrototypeList::ID::HTMLLinkElement as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HTMLLinkElement as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    assert!((*cache)[PrototypeList::Constructor::HTMLLinkElement as usize].is_null());
    (*cache)[PrototypeList::Constructor::HTMLLinkElement as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::HTMLLinkElement as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod HTMLLinkElementBinding
