...
unsafe extern fn set_media<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
fn media_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_hreflang<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        push_new_element_queue();
...
unsafe extern fn set_hreflang<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
fn hreflang_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
fn hreflang_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn set_integrity<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
fn integrity_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn set_charset<TH: TypeHolderTrait>
(cx: *mut JSContext, obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
...
fn charset_setterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_sheet<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const HTMLLinkElement<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn sheet_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLLinkElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLLinkElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLLinkElement<TH> {
    fn eq(&self, other: &HTMLLinkElement<TH>) -> bool {
        self as *const HTMLLinkElement<TH> == &*other
    }
}

pub trait HTMLLinkElementMethods<TH: TypeHolderTrait> {
