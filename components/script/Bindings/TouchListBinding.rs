...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TouchList<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for TouchList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TouchList<TH> {
    fn eq(&self, other: &TouchList<TH>) -> bool {
        self as *const TouchList<TH> == &*other
    }
}

pub trait TouchListMethods<TH: TypeHolderTrait> {
    fn Length(&self) -> u32;
