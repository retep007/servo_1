...
unsafe extern fn initCustomEvent<TH: TypeHolderTrait>
...
fn initCustomEvent_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CustomEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for CustomEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CustomEvent<TH> {
