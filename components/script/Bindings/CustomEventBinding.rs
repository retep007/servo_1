...
const initCustomEvent_methodinfo: JSJitInfo = JSJitInfo {
    call: initCustomEvent as *const os::raw::c_void,
    protoID: PrototypeList::ID::CustomEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &initCustomEvent_methodinfo as *const _ as *const JSJitInfo },
        nargs: 4,
