...
impl CustomEventInit {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let mut dictionary = RootedTraceableBox::new(CustomEventInit::default());
            dictionary.parent = {
...
impl FromJSValConvertible for RootedTraceableBox<CustomEventInit> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RootedTraceableBox<CustomEventInit>>, ()> {
        CustomEventInit::new(cx, value)
    }
}

impl ToJSValConvertible for RootedTraceableBox<CustomEventInit> {
...
pub use self::CustomEventBinding::{Wrap, CustomEventMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CustomEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: JSVal = this.Detail(cx);
...
fn detail_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::CustomEvent as u16,
    depth: 1,
...
unsafe extern fn initCustomEvent<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CustomEvent<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 4 {
            throw_type_error(cx, "Not enough arguments to \"CustomEvent.initCustomEvent\".");
            return false;
        }
        ...
        let arg3: HandleValue = args.get(3);
        let result: () = this.InitCustomEvent(cx, arg0, arg1, arg2, arg3);
...
fn initCustomEvent_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: initCustomEvent::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CustomEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CustomEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CustomEvent<TH>);
            }
            debug!("CustomEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"CustomEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::CustomEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::CustomEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<CustomEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CustomEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CustomEvent<TH>>) -> DomRoot<CustomEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CustomEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CustomEvent<TH> {
    fn eq(&self, other: &CustomEvent<TH>) -> bool {
        self as *const CustomEvent<TH> == &*other
    }
}

pub trait CustomEventMethods {
    unsafe fn Detail(&self, cx: *mut JSContext) -> JSVal;
    unsafe fn InitCustomEvent(&self, cx: *mut JSContext, type_: DOMString, bubbles: bool, cancelable: bool, detail: HandleValue) -> ();
    fn IsTrusted(&self) -> bool;
}
fn sMethods_specs<TH: TypeHolderTrait<TH>>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"initCustomEvent\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &initCustomEvent_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 4,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CustomEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CustomEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CustomEvent.constructor\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let arg1: RootedTraceableBox<dom::bindings::codegen::Bindings::CustomEventBinding::CustomEventInit> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::CustomEventBinding::CustomEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function CustomEvent() {\n    [native code]\n}",
        PrototypeList::ID::CustomEvent,
        1)
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CustomEvent as usize].is_null());
    (*cache)[PrototypeList::ID::CustomEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CustomEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
