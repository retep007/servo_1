...
const refresh_methodinfo: JSJitInfo = JSJitInfo {
    call: refresh as *const os::raw::c_void,
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &refresh_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
