...
unsafe extern fn refresh<TH: TypeHolderTrait>
...
fn refresh_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PluginArray<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for PluginArray<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PluginArray<TH> {
    fn eq(&self, other: &PluginArray<TH>) -> bool {
        self as *const PluginArray<TH> == &*other
    }
}

pub trait PluginArrayMethods<TH: TypeHolderTrait> {
