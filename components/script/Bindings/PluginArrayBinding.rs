...
pub use self::PluginArrayBinding::{Wrap, PluginArrayMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn refresh<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const PluginArray<TH>, args: *const JSJitMethodCallArgs) -> bool {
...
fn refresh_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: refresh::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::PluginArray as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PluginArray<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PluginArray<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PluginArray.item\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Plugin<TH>>> = this.Item(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PluginArray<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PluginArray.namedItem\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Plugin<TH>>> = this.NamedItem(arg0);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PluginArray<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PluginArray<TH>);
            }
            debug!("PluginArray<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const PluginArray<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const PluginArray<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::PluginArray, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PluginArray<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let this = &*this;
            let result: Option<DomRoot<Plugin<TH>>> = this.IndexedGetter(index);
        ...
        if index.is_none() && (RUST_JSID_IS_STRING(id) || RUST_JSID_IS_INT(id)) {
            ...
            if !has_on_proto {
                ...
                let this = UnwrapProxy(proxy);
                let this = &*this;
                let result: Option<DomRoot<Plugin<TH>>> = this.NamedGetter(name);
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"PluginArray\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PluginArray<TH>>) -> DomRoot<PluginArray<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::PluginArray as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for PluginArray<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for PluginArray<TH> {
    fn eq(&self, other: &PluginArray<TH>) -> bool {
        self as *const PluginArray<TH> == &*other
    }
}

pub trait PluginArrayMethods<TH: TypeHolderTrait<TH>> {
    fn Refresh(&self, reload: bool) -> ();
    fn Length(&self) -> u32;
    fn Item(&self, index: u32) -> Option<DomRoot<Plugin<TH>>>;
    fn NamedItem(&self, name: DOMString) -> Option<DomRoot<Plugin<TH>>>;
    fn SupportedPropertyNames(&self) -> Vec<DOMString>;
    fn NamedGetter(&self, name: DOMString) -> Option<DomRoot<Plugin<TH>>>;
    fn IndexedGetter(&self, index: u32) -> Option<DomRoot<Plugin<TH>>>;
}
fn sMethods_specs<TH: TypeHolderTrait<TH>>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"refresh\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &refresh_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PluginArray as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PluginArrayPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PluginArray() {\n    [native code]\n}",
        PrototypeList::ID::PluginArray,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::PluginArray as usize].is_null());
    (*cache)[PrototypeList::ID::PluginArray as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PluginArray as isize),
                                  ptr::null_mut(),
                                  prototype.get());
