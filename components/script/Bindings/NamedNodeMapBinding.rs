...
pub use self::NamedNodeMapBinding::{Wrap, NamedNodeMapMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.item\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Attr<TH>>> = this.Item(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.getNamedItem\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Attr<TH>>> = this.GetNamedItem(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.getNamedItemNS\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Attr<TH>>> = this.GetNamedItemNS(arg0, arg1);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.setNamedItem\".");
            return false;
        }
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.setNamedItemNS\".");
            return false;
        }
        let arg0: DomRoot<Attr<TH>> = if args.get(0).get().is_object() {
            match root_from_handlevalue(args.get(0)) {
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.removeNamedItem\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const NamedNodeMap<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"NamedNodeMap.removeNamedItemNS\".");
            return false;
        }
        let arg0: Option<DOMString> = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<NamedNodeMap<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut NamedNodeMap<TH>);
            }
            debug!("NamedNodeMap<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const NamedNodeMap<TH> {
    ...
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const NamedNodeMap<TH>;
    return box_;
}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let this = &*this;
            let result: Option<DomRoot<Attr<TH>>> = this.IndexedGetter(index);
        ...
        if index.is_none() && (RUST_JSID_IS_STRING(id) || RUST_JSID_IS_INT(id)) {
            ...
            if !has_on_proto {
                        let qualifiedName = jsid_to_string(cx, Handle::from_raw(id)).expect("Not a string-convertible JSID?");
                let this = UnwrapProxy::<TH>(proxy);
                let this = &*this;
                let result: Option<DomRoot<Attr<TH>>> = this.NamedGetter(qualifiedName);
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<NamedNodeMap<TH>>) -> DomRoot<NamedNodeMap<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::NamedNodeMap as usize];
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::NamedNodeMap as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"NamedNodeMapPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::NamedNodeMap as usize].is_null());
    (*cache)[PrototypeList::ID::NamedNodeMap as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::NamedNodeMap as isize),
                                  ptr::null_mut(),
                                  prototype.get());
