...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MimeType<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for MimeType<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for MimeType<TH> {
    fn eq(&self, other: &MimeType<TH>) -> bool {
        self as *const MimeType<TH> == &*other
    }
}

pub trait MimeTypeMethods<TH: TypeHolderTrait> {
