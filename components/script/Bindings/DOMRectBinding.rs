...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    DOMRectReadOnlyBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    DOMRectReadOnlyBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
