...
pub use self::DOMPointReadOnlyBinding::{Wrap, DOMPointReadOnlyMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMPointReadOnly<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn x_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::DOMPointReadOnly as u16,
    depth: 0,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMPointReadOnly<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DOMPointReadOnly<TH>);
            }
            debug!("DOMPointReadOnly<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"DOMPointReadOnly\0" as *const u8 as *const libc::c_char,
...
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<DOMPointReadOnly<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<DOMPointReadOnly<TH>>) -> DomRoot<DOMPointReadOnly<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMPointReadOnly<TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class.interface_chain[0] == PrototypeList::ID::DOMPointReadOnly
    }
}

impl<TH: TypeHolderTrait<TH>> PartialEq for DOMPointReadOnly<TH> {
    fn eq(&self, other: &DOMPointReadOnly<TH>) -> bool {
        self as *const DOMPointReadOnly<TH> == &*other
    }
}

pub trait DOMPointReadOnlyMethods {
    fn X(&self) -> f64;
    fn Y(&self) -> f64;
    fn Z(&self) -> f64;
    fn W(&self) -> f64;
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DOMPointReadOnly as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DOMPointReadOnlyPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function DOMPointReadOnly() {\n    [native code]\n}",
        PrototypeList::ID::DOMPointReadOnly,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::DOMPointReadOnly as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DOMPointReadOnly as usize].is_null());
    (*cache)[PrototypeList::ID::DOMPointReadOnly as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMPointReadOnly as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"DOMPointReadOnly\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
    assert!((*cache)[PrototypeList::Constructor::DOMPointReadOnly as usize].is_null());
    (*cache)[PrototypeList::Constructor::DOMPointReadOnly as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::DOMPointReadOnly as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod DOMPointReadOnlyBinding
