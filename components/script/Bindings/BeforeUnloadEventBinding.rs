...
pub use self::BeforeUnloadEventBinding::{Wrap, BeforeUnloadEventMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::BeforeUnloadEvent;
use dom::types::Event;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
...
const returnValue_getterinfo: JSJitInfo = 
 JSJitInfo {
...
const returnValue_setterinfo: JSJitInfo = 
	JSJitInfo {
        call: 0 as *const os::raw::c_void,
    protoID: PrototypeList::ID::BeforeUnloadEvent as u16,
    depth: 1,
...
const isTrusted_getterinfo: JSJitInfo = 
	JSJitInfo {
        call: 0 as *const os::raw::c_void,
    protoID: PrototypeList::ID::BeforeUnloadEvent as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BeforeUnloadEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut BeforeUnloadEvent<TH>);
            }
            debug!("BeforeUnloadEvent<TH> finalize: {:p}", this);
    }), ());
}
...
static CLASS_OPS: js::jsapi::JSClassOps =
	js::jsapi::JSClassOps {
    addProperty: None,
    delProperty: None,
    getProperty: None,
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::BeforeUnloadEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::BeforeUnloadEvent) },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BeforeUnloadEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BeforeUnloadEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BeforeUnloadEvent as usize].is_null());
    (*cache)[PrototypeList::ID::BeforeUnloadEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BeforeUnloadEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
