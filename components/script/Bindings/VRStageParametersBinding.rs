...
unsafe extern fn get_sittingToStandingTransform<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VRStageParameters<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for VRStageParameters<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for VRStageParameters<TH> {
