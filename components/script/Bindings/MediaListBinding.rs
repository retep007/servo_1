...
unsafe extern fn get_mediaText<TH: TypeHolderTrait>
...
unsafe extern fn set_mediaText<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MediaList<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> PartialEq for MediaList<TH> {
