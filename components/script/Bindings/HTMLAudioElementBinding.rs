...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: Result<DomRoot<HTMLAudioElement<TH>>, Error> = html_constructor(&global, &args);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    HTMLMediaElementBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    HTMLMediaElementBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
