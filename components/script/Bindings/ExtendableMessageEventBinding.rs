...
unsafe extern fn get_lastEventId<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableMessageEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn lastEventId_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ExtendableMessageEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for ExtendableMessageEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for ExtendableMessageEvent<TH> {
