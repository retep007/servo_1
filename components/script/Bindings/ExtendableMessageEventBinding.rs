...
pub struct ExtendableMessageEventInit {
    pub parent: dom::bindings::codegen::Bindings::ExtendableEventBinding::ExtendableEventInit,
    pub data: RootedTraceableBox<Heap<JSVal>>,
    pub lastEventId: Option<DOMString>,
    pub origin: Option<DOMString>,
}
impl ExtendableMessageEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> RootedTraceableBox<ExtendableMessageEventInit> {
        match ExtendableMessageEventInit::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let mut dictionary = RootedTraceableBox::new(ExtendableMessageEventInit::default());
            dictionary.parent = {
                match try!(dom::bindings::codegen::Bindings::ExtendableEventBinding::ExtendableEventInit::new(cx, val)) {
            ...
            dictionary.lastEventId = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "lastEventId", rval.handle_mut())) {
                    true => {
            ...
            dictionary.origin = {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "origin", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), StringificationBehavior::Default) {
                            Ok(ConversionResult::Success(strval)) => strval,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for RootedTraceableBox<ExtendableMessageEventInit> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RootedTraceableBox<ExtendableMessageEventInit>>, ()> {
        ExtendableMessageEventInit::new(cx, value)
    }
}

impl ToJSValConvertible for RootedTraceableBox<ExtendableMessageEventInit> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        if let Some(ref lastEventId) = self.lastEventId {
            rooted!(in(cx) let mut lastEventId_js = UndefinedValue());
            lastEventId.to_jsval(cx, lastEventId_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "lastEventId", lastEventId_js.handle()).unwrap();
        }
...
pub use self::ExtendableMessageEventBinding::{Wrap, ExtendableMessageEventMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::ExtendableEventBinding::ExtendableEventBinding;
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::ExtendableEvent;
use dom::types::ExtendableMessageEvent;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableMessageEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: JSVal = this.Data(cx);
...
fn data_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::ExtendableMessageEvent as u16,
    depth: 2,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableMessageEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.Origin();
...
unsafe extern fn get_lastEventId<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableMessageEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.LastEventId();
...
fn lastEventId_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_lastEventId::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ExtendableMessageEvent as u16,
    depth: 2,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ExtendableMessageEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ExtendableMessageEvent<TH>);
            }
            debug!("ExtendableMessageEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ExtendableMessageEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::ExtendableEvent, PrototypeList::ID::ExtendableMessageEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::ExtendableEvent(::dom::bindings::codegen::InheritTypes::ExtendableEventTypeId::ExtendableMessageEvent)) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ExtendableMessageEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ExtendableMessageEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ExtendableMessageEvent<TH>>) -> DomRoot<ExtendableMessageEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ExtendableMessageEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ExtendableMessageEvent<TH> {
    fn eq(&self, other: &ExtendableMessageEvent<TH>) -> bool {
        self as *const ExtendableMessageEvent<TH> == &*other
    }
}

pub trait ExtendableMessageEventMethods {
    unsafe fn Data(&self, cx: *mut JSContext) -> JSVal;
...
&[
    ...
    JSPropertySpec {
        name: b"lastEventId\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &lastEventId_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ExtendableMessageEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ExtendableMessageEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ExtendableMessageEvent.constructor\".");
            return false;
        }
        ...
        let arg1: RootedTraceableBox<dom::bindings::codegen::Bindings::ExtendableMessageEventBinding::ExtendableMessageEventInit> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::ExtendableMessageEventBinding::ExtendableMessageEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<ExtendableMessageEvent<TH>>, Error<TH>> = ExtendableMessageEvent::Constructor(&global, arg0, arg1);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ExtendableMessageEvent() {\n    [native code]\n}",
        PrototypeList::ID::ExtendableMessageEvent,
        2) 
}
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    is_exposed_in(aObj, InterfaceObjectMap::Globals::SERVICE_WORKER_GLOBAL_SCOPE) &&
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    ExtendableEventBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::ExtendableMessageEvent as usize].is_null());
    (*cache)[PrototypeList::ID::ExtendableMessageEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ExtendableMessageEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    ExtendableEventBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
...
} // mod ExtendableMessageEventBinding
