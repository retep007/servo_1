...
unsafe extern fn splitText<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Text<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for Text<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for Text<TH> {
