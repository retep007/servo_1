...
pub use self::WebGLVertexArrayObjectOESBinding::{Wrap, GetProtoObject};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLVertexArrayObjectOES<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WebGLVertexArrayObjectOES<TH>);
            }
            debug!("WebGLVertexArrayObjectOES<TH> finalize: {:p}", this);
    }), ());
}
...
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WebGLVertexArrayObjectOES<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WebGLVertexArrayObjectOES<TH>>) -> DomRoot<WebGLVertexArrayObjectOES<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLVertexArrayObjectOES<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLVertexArrayObjectOES<TH> {
    fn eq(&self, other: &WebGLVertexArrayObjectOES<TH>) -> bool {
        self as *const WebGLVertexArrayObjectOES<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLVertexArrayObjectOES as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WebGLVertexArrayObjectOESPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WebGLVertexArrayObjectOES as usize].is_null());
    (*cache)[PrototypeList::ID::WebGLVertexArrayObjectOES as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WebGLVertexArrayObjectOES as isize),
                                  ptr::null_mut(),
                                  prototype.get());

}
} // mod WebGLVertexArrayObjectOESBinding
