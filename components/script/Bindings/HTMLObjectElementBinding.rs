...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLObjectElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLObjectElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLObjectElement<TH> {
    fn eq(&self, other: &HTMLObjectElement<TH>) -> bool {
        self as *const HTMLObjectElement<TH> == &*other
    }
}

pub trait HTMLObjectElementMethods<TH: TypeHolderTrait> {
