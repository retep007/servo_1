...
const persisted_getterinfo: JSJitInfo = JSJitInfo {
    call: get_persisted as *const os::raw::c_void,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &persisted_getterinfo },
