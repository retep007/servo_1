...
unsafe extern fn get_persisted<TH: TypeHolderTrait>
...
fn persisted_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PageTransitionEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for PageTransitionEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PageTransitionEvent<TH> {
