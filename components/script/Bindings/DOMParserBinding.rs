...
pub mod SupportedTypeValues {
    use dom::bindings::conversions::ToJSValConvertible;
    use js::jsapi::JSContext;
    use js::rust::MutableHandleValue;
    use js::jsval::JSVal;

    pub const pairs: &'static [(&'static str, super::SupportedType)] = &[
        ("text/html", super::SupportedType::Text_html),
        ("text/xml", super::SupportedType::Text_xml),
        ("application/xml", super::SupportedType::Application_xml),
        ("application/xhtml+xml", super::SupportedType::Application_xhtml_xml),
    ];

    impl super::SupportedType {
        pub fn as_str(&self) -> &'static str {
            pairs[*self as usize].0
        }
    }

    impl Default for super::SupportedType {
        fn default() -> super::SupportedType {
            pairs[0].1
        }
    }

    impl ToJSValConvertible for super::SupportedType {
        unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
            pairs[*self as usize].0.to_jsval(cx, rval);
        }
    }
        } // mod SupportedTypeValues

pub use self::DOMParserBinding::{Wrap, DOMParserMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::DOMParserBinding::SupportedType;
use dom::bindings::codegen::Bindings::DOMParserBinding::SupportedTypeValues;
...
unsafe extern fn parseFromString<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMParser<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"DOMParser.parseFromString\".");
            return false;
        }
        ...
        let arg1: SupportedType = match find_enum_value(cx, args.get(1), SupportedTypeValues::pairs) {
            Err(_) => { return false;
         },
            Ok((None, search)) => { throw_type_error(cx, &format!("'{}' is not a valid enum value for enumeration 'SupportedType'.", search)); return false;
         },
...
fn parseFromString_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: parseFromString::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMParser as u16,
    depth: 0,
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"DOMParser\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::DOMParser, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<DOMParser<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<DOMParser<TH>>(ops, obj)
}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMParser<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMParser<TH> {
    fn eq(&self, other: &DOMParser<TH>) -> bool {
        self as *const DOMParser<TH> == &*other
    }
}

pub trait DOMParserMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        name: b"parseFromString\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &parseFromString_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 2,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DOMParser as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DOMParserPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function DOMParser() {\n    [native code]\n}",
        PrototypeList::ID::DOMParser,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DOMParser as usize].is_null());
    (*cache)[PrototypeList::ID::DOMParser as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMParser as isize),
                                  ptr::null_mut(),
                                  prototype.get());
