...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLLegendElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLLegendElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLLegendElement<TH> {
    fn eq(&self, other: &HTMLLegendElement<TH>) -> bool {
        self as *const HTMLLegendElement<TH> == &*other
    }
}

pub trait HTMLLegendElementMethods<TH: TypeHolderTrait> {
