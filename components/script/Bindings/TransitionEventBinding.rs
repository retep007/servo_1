...
pub struct TransitionEventInit {
    ...
    pub elapsedTime: Finite<f32>,
    pub propertyName: DOMString,
    pub pseudoElement: DOMString,
}
impl TransitionEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> TransitionEventInit {
        match TransitionEventInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<TransitionEventInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = TransitionEventInit {
            parent: {
            ...
            elapsedTime: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "elapsedTime", rval.handle_mut())) {
                    true => {
            ...
            propertyName: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "propertyName", rval.handle_mut())) {
                    true => {
            ...
            pseudoElement: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "pseudoElement", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), StringificationBehavior::Default) {
                            Ok(ConversionResult::Success(strval)) => strval,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for TransitionEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<TransitionEventInit>, ()> {
        TransitionEventInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for TransitionEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut elapsedTime_js = UndefinedValue());
        elapsedTime.to_jsval(cx, elapsedTime_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "elapsedTime", elapsedTime_js.handle()).unwrap();
        let propertyName = &self.propertyName;
        rooted!(in(cx) let mut propertyName_js = UndefinedValue());
        propertyName.to_jsval(cx, propertyName_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "propertyName", propertyName_js.handle()).unwrap();
        let pseudoElement = &self.pseudoElement;
        rooted!(in(cx) let mut pseudoElement_js = UndefinedValue());
        pseudoElement.to_jsval(cx, pseudoElement_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "pseudoElement", pseudoElement_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::TransitionEventBinding::{Wrap, TransitionEventMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_propertyName<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TransitionEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.PropertyName();
...
fn propertyName_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_propertyName::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::TransitionEvent as u16,
    depth: 1,
...
unsafe extern fn get_elapsedTime<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TransitionEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Finite<f32> = this.ElapsedTime();
...
fn elapsedTime_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_elapsedTime::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::TransitionEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_pseudoElement<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TransitionEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.PseudoElement();
...
fn pseudoElement_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_pseudoElement::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::TransitionEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TransitionEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut TransitionEvent<TH>);
            }
            debug!("TransitionEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"TransitionEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::TransitionEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::TransitionEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<TransitionEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<TransitionEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<TransitionEvent<TH>>) -> DomRoot<TransitionEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for TransitionEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for TransitionEvent<TH> {
    fn eq(&self, other: &TransitionEvent<TH>) -> bool {
        self as *const TransitionEvent<TH> == &*other
    }
}
...
&[
    JSPropertySpec {
        name: b"propertyName\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &propertyName_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"elapsedTime\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &elapsedTime_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"pseudoElement\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &pseudoElement_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::TransitionEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"TransitionEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"TransitionEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::TransitionEventBinding::TransitionEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::TransitionEventBinding::TransitionEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function TransitionEvent() {\n    [native code]\n}",
        PrototypeList::ID::TransitionEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::TransitionEvent as usize].is_null());
    (*cache)[PrototypeList::ID::TransitionEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::TransitionEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
