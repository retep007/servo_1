...
unsafe extern fn get_propertyName<TH: TypeHolderTrait>
...
fn propertyName_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_elapsedTime<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const TransitionEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn elapsedTime_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_pseudoElement<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const TransitionEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn pseudoElement_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TransitionEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for TransitionEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TransitionEvent<TH> {
