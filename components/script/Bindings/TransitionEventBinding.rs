...
const propertyName_getterinfo: JSJitInfo = JSJitInfo {
    call: get_propertyName as *const os::raw::c_void,
...
const elapsedTime_getterinfo: JSJitInfo = JSJitInfo {
    call: get_elapsedTime as *const os::raw::c_void,
    protoID: PrototypeList::ID::TransitionEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const pseudoElement_getterinfo: JSJitInfo = JSJitInfo {
    call: get_pseudoElement as *const os::raw::c_void,
    protoID: PrototypeList::ID::TransitionEvent as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &propertyName_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"elapsedTime\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &elapsedTime_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"pseudoElement\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &pseudoElement_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
