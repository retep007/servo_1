...
const createDocumentType_methodinfo: JSJitInfo = JSJitInfo {
    call: createDocumentType as *const os::raw::c_void,
...
const createDocument_methodinfo: JSJitInfo = JSJitInfo {
    call: createDocument as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMImplementation as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
const createHTMLDocument_methodinfo: JSJitInfo = JSJitInfo {
    call: createHTMLDocument as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMImplementation as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
const hasFeature_methodinfo: JSTypedMethodJitInfo = JSTypedMethodJitInfo {
    base:   JSJitInfo {
      call: hasFeature as *const os::raw::c_void,
      protoID: PrototypeList::ID::DOMImplementation as u16,
      depth: 0,
      _bitfield_1: new_jsjitinfo_bitfield_1!(
          JSJitInfo_OpType::Method as u8,
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &createDocumentType_methodinfo as *const _ as *const JSJitInfo },
        nargs: 3,
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &createDocument_methodinfo as *const _ as *const JSJitInfo },
        nargs: 2,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &createHTMLDocument_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &hasFeature_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
