...
unsafe extern fn waitUntil<TH: TypeHolderTrait>
...
fn waitUntil_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ExtendableEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for ExtendableEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for ExtendableEvent<TH> {
