...
impl ExtendableEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> ExtendableEventInit {
        match ExtendableEventInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<ExtendableEventInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = ExtendableEventInit {
            parent: {
...
impl FromJSValConvertible for ExtendableEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<ExtendableEventInit>, ()> {
        ExtendableEventInit::new(cx, value)
    }
}
...
pub use self::ExtendableEventBinding::{Wrap, ExtendableEventMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
unsafe extern fn waitUntil<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableEvent<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ExtendableEvent.waitUntil\".");
            return false;
        }
...
fn waitUntil_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: waitUntil::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::ExtendableEvent as u16,
    depth: 1,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ExtendableEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ExtendableEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ExtendableEvent<TH>);
            }
            debug!("ExtendableEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ExtendableEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::ExtendableEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::ExtendableEvent(::dom::bindings::codegen::InheritTypes::ExtendableEventTypeId::ExtendableEvent)) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<ExtendableEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ExtendableEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ExtendableEvent<TH>>) -> DomRoot<ExtendableEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ExtendableEvent<TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class.interface_chain[1] == PrototypeList::ID::ExtendableEvent
    }
}

impl<TH: TypeHolderTrait<TH>> PartialEq for ExtendableEvent<TH> {
    fn eq(&self, other: &ExtendableEvent<TH>) -> bool {
        self as *const ExtendableEvent<TH> == &*other
    }
}

pub trait ExtendableEventMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        name: b"waitUntil\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &waitUntil_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ExtendableEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ExtendableEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"ExtendableEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::ExtendableEventBinding::ExtendableEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::ExtendableEventBinding::ExtendableEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ExtendableEvent() {\n    [native code]\n}",
        PrototypeList::ID::ExtendableEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::ExtendableEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::ExtendableEvent as usize].is_null());
    (*cache)[PrototypeList::ID::ExtendableEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ExtendableEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    assert!((*cache)[PrototypeList::Constructor::ExtendableEvent as usize].is_null());
    (*cache)[PrototypeList::Constructor::ExtendableEvent as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::ExtendableEvent as isize),
                                  ptr::null_mut(),
                                  interface.get());
