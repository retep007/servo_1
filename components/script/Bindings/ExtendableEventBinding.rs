...
const waitUntil_methodinfo: JSJitInfo = JSJitInfo {
    call: waitUntil as *const os::raw::c_void,
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &waitUntil_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
