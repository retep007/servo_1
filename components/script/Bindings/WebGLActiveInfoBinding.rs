...
pub use self::WebGLActiveInfoBinding::{Wrap, WebGLActiveInfoMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WebGLActiveInfo<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: i32 = this.Size();
...
fn size_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::WebGLActiveInfo as u16,
    depth: 0,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLActiveInfo<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WebGLActiveInfo<TH>);
            }
            debug!("WebGLActiveInfo<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"WebGLActiveInfo\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::WebGLActiveInfo, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<WebGLActiveInfo<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WebGLActiveInfo<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WebGLActiveInfo<TH>>) -> DomRoot<WebGLActiveInfo<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLActiveInfo<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLActiveInfo<TH> {
    fn eq(&self, other: &WebGLActiveInfo<TH>) -> bool {
        self as *const WebGLActiveInfo<TH> == &*other
    }
}

pub trait WebGLActiveInfoMethods {
    fn Size(&self) -> i32;
    fn Type(&self) -> u32;
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLActiveInfo as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WebGLActiveInfoPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function WebGLActiveInfo() {\n    [native code]\n}",
        PrototypeList::ID::WebGLActiveInfo,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WebGLActiveInfo as usize].is_null());
    (*cache)[PrototypeList::ID::WebGLActiveInfo as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WebGLActiveInfo as isize),
                                  ptr::null_mut(),
                                  prototype.get());
