...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSViewportRule<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for CSSViewportRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CSSViewportRule<TH> {
