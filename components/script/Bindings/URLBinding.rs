...
unsafe extern fn get_searchParams<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const URL<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn searchParams_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_searchParams::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::URL as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn createObjectURL<TH: TypeHolderTrait<TH>>
...
unsafe extern fn revokeObjectURL<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<URL<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for URL<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for URL<TH> {
    fn eq(&self, other: &URL<TH>) -> bool {
        self as *const URL<TH> == &*other
    }
}

pub trait URLMethods<TH: TypeHolderTrait<TH>> {
...
impl<TH: TypeHolderTrait<TH>> WeakReferenceable<TH> for URL<TH> {}
...
&[
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &searchParams_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
