...
pub struct DOMQuadInit {
    pub p1: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit,
    pub p2: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit,
    pub p3: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit,
    pub p4: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit,
}
impl DOMQuadInit {
    pub unsafe fn empty(cx: *mut JSContext) -> DOMQuadInit {
        match DOMQuadInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<DOMQuadInit>, ()> {
...
impl ToJSValConvertible for DOMQuadInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        let p1 = &self.p1;
        rooted!(in(cx) let mut p1_js = UndefinedValue());
        p1.to_jsval(cx, p1_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "p1", p1_js.handle()).unwrap();
        let p2 = &self.p2;
        rooted!(in(cx) let mut p2_js = UndefinedValue());
        p2.to_jsval(cx, p2_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "p2", p2_js.handle()).unwrap();
        let p3 = &self.p3;
        rooted!(in(cx) let mut p3_js = UndefinedValue());
        p3.to_jsval(cx, p3_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "p3", p3_js.handle()).unwrap();
        let p4 = &self.p4;
        rooted!(in(cx) let mut p4_js = UndefinedValue());
        p4.to_jsval(cx, p4_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "p4", p4_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::DOMQuadBinding::{Wrap, DOMQuadMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn fromRect<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: DomRoot<DOMQuad<TH>> = DOMQuad::FromRect(&global, &arg0);
...
unsafe extern fn fromQuad<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        let args = CallArgs::from_vp(vp, argc);
        ...
        let result: DomRoot<DOMQuad<TH>> = DOMQuad::FromQuad(&global, &arg0);
...
unsafe extern fn get_p1<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMQuad<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<DOMPoint<TH>> = this.P1();
...
fn p1_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_p1::<TH> as *const os::raw::c_void,
...
unsafe extern fn get_p2<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMQuad<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<DOMPoint<TH>> = this.P2();
...
fn p2_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_p2::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMQuad as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_p3<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMQuad<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<DOMPoint<TH>> = this.P3();
...
fn p3_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_p3::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMQuad as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_p4<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMQuad<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<DOMPoint<TH>> = this.P4();
...
fn p4_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_p4::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMQuad as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn getBounds<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const DOMQuad<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: DomRoot<DOMRect<TH>> = this.GetBounds();
...
fn getBounds_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getBounds::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::DOMQuad as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMQuad<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DOMQuad<TH>);
            }
            debug!("DOMQuad<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::DOMQuad, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<DOMQuad<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<DOMQuad<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<DOMQuad<TH>>) -> DomRoot<DOMQuad<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMQuad<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMQuad<TH> {
    fn eq(&self, other: &DOMQuad<TH>) -> bool {
        self as *const DOMQuad<TH> == &*other
    }
}

pub trait DOMQuadMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        name: b"getBounds\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getBounds_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &p1_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"p2\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &p2_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"p3\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &p3_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"p4\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &p4_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg1: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit::empty(cx)
        } else {
        ...
        let arg2: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit = if args.get(2).is_undefined() {
            dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit::empty(cx)
        } else {
        ...
        let arg3: dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit = if args.get(3).is_undefined() {
            dom::bindings::codegen::Bindings::DOMPointBinding::DOMPointInit::empty(cx)
        } else {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DOMQuad as usize].is_null());
    (*cache)[PrototypeList::ID::DOMQuad as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMQuad as isize),
                                  ptr::null_mut(),
                                  prototype.get());
