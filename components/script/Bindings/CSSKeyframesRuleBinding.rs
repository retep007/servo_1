...
pub use self::CSSKeyframesRuleBinding::{Wrap, CSSKeyframesRuleMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::CSSKeyframeRule;
use dom::types::CSSKeyframesRule;
use dom::types::CSSRule;
use dom::types::CSSRuleList;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSKeyframesRule<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<CSSRuleList<TH>> = this.CssRules();
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSKeyframesRule<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CSSKeyframesRule.appendRule\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let result: () = this.AppendRule(arg0);
...
const appendRule_methodinfo: JSJitInfo = JSJitInfo {
    call: appendRule as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSKeyframesRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSKeyframesRule<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CSSKeyframesRule.deleteRule\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let result: () = this.DeleteRule(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSKeyframesRule<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CSSKeyframesRule.findRule\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let result: Option<DomRoot<CSSKeyframeRule<TH>>> = this.FindRule(arg0);
...
const findRule_methodinfo: JSJitInfo = JSJitInfo {
    call: findRule as *const os::raw::c_void,
    protoID: PrototypeList::ID::CSSKeyframesRule as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSKeyframesRule<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CSSKeyframesRule<TH>);
            }
            debug!("CSSKeyframesRule<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::CSSRule, PrototypeList::ID::CSSKeyframesRule, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { cssrule: (::dom::bindings::codegen::InheritTypes::CSSRuleTypeId::CSSKeyframesRule) },
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &appendRule_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
    ...
    JSFunctionSpec {
        name: b"findRule\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &findRule_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSSKeyframesRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSKeyframesRulePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CSSKeyframesRule as usize].is_null());
    (*cache)[PrototypeList::ID::CSSKeyframesRule as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSSKeyframesRule as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"CSSKeyframesRule\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod CSSKeyframesRuleBinding
