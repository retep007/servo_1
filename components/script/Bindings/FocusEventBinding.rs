...
impl<TH: TypeHolderTrait> IDLInterface for FocusEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for FocusEvent<TH> {
    fn eq(&self, other: &FocusEvent<TH>) -> bool {
        self as *const FocusEvent<TH> == &*other
    }
}

pub trait FocusEventMethods<TH: TypeHolderTrait> {
