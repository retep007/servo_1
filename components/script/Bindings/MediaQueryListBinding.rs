...
pub use self::MediaQueryListBinding::{Wrap, MediaQueryListMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MediaQueryList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MediaQueryList.addListener\".");
            return false;
        }
        ...
        let result: () = this.AddListener(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MediaQueryList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MediaQueryList.removeListener\".");
            return false;
        }
        let arg0: Option<Rc<dom::bindings::codegen::Bindings::EventListenerBinding::EventListener<TH>>> = if args.get(0).get().is_object() {
            Some(dom::bindings::codegen::Bindings::EventListenerBinding::EventListener::new(cx, args.get(0).get().to_object()))
        ...
        let result: () = this.RemoveListener(arg0);
    ...
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if !weak_box_ptr.is_null() {
            ...
            if !this.is_null() {
                ...
                let _ = Box::from_raw(this as *mut MediaQueryList<TH>);
            }
            debug!("MediaQueryList<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::MediaQueryList, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::MediaQueryList) },
...
pub trait MediaQueryListMethods<TH: TypeHolderTrait> {
    ...
    fn RemoveListener(&self, listener: Option<Rc<dom::bindings::codegen::Bindings::EventListenerBinding::EventListener<TH>>>) -> ();
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::MediaQueryList as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"MediaQueryListPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::MediaQueryList as usize].is_null());
    (*cache)[PrototypeList::ID::MediaQueryList as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::MediaQueryList as isize),
                                  ptr::null_mut(),
                                  prototype.get());
