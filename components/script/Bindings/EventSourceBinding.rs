...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<EventSource<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for EventSource<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for EventSource<TH> {
    fn eq(&self, other: &EventSource<TH>) -> bool {
        self as *const EventSource<TH> == &*other
    }
}

pub trait EventSourceMethods<TH: TypeHolderTrait> {
