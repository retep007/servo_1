...
pub use self::DOMStringMapBinding::{Wrap, DOMStringMapMethods, GetProtoObject, DefineDOMInterface};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMStringMap<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DOMStringMap<TH>);
            }
            debug!("DOMStringMap<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const DOMStringMap<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const DOMStringMap<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::DOMStringMap, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<DOMStringMap<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"DOMStringMap\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<DOMStringMap<TH>>) -> DomRoot<DOMStringMap<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::DOMStringMap as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMStringMap<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMStringMap<TH> {
    fn eq(&self, other: &DOMStringMap<TH>) -> bool {
        self as *const DOMStringMap<TH> == &*other
    }
}

pub trait DOMStringMapMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DOMStringMap as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DOMStringMapPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function DOMStringMap() {\n    [native code]\n}",
        PrototypeList::ID::DOMStringMap,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DOMStringMap as usize].is_null());
    (*cache)[PrototypeList::ID::DOMStringMap as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DOMStringMap as isize),
                                  ptr::null_mut(),
                                  prototype.get());
