...
pub use self::UnionTypes::StringOrObject as FileReaderResult;

pub use self::FileReaderBinding::{FileReaderConstants, Wrap, FileReaderMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"FileReader.readAsArrayBuffer\".");
            return false;
        }
...
const readAsArrayBuffer_methodinfo: JSJitInfo = JSJitInfo {
    call: readAsArrayBuffer as *const os::raw::c_void,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"FileReader.readAsText\".");
            return false;
        }
        let arg0: DomRoot<Blob<TH>> = if args.get(0).get().is_object() {
            match root_from_handlevalue(args.get(0)) {
...
const readAsText_methodinfo: JSJitInfo = JSJitInfo {
    call: readAsText as *const os::raw::c_void,
    protoID: PrototypeList::ID::FileReader as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"FileReader.readAsDataURL\".");
            return false;
        }
        let arg0: DomRoot<Blob<TH>> = if args.get(0).get().is_object() {
            match root_from_handlevalue(args.get(0)) {
...
const readAsDataURL_methodinfo: JSJitInfo = JSJitInfo {
    call: readAsDataURL as *const os::raw::c_void,
    protoID: PrototypeList::ID::FileReader as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<UnionTypes::StringOrObject> = this.GetResult(cx);
...
const result_getterinfo: JSJitInfo = JSJitInfo {
    call: get_result as *const os::raw::c_void,
    protoID: PrototypeList::ID::FileReader as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<DOMException<TH>>> = this.GetError();
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileReader<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>> = this.GetOnloadend();
...
(cx: *mut JSContext, obj: HandleObject, this: *const FileReader<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.SetOnloadend(arg0);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<FileReader<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut FileReader<TH>);
            }
            debug!("FileReader<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::FileReader, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::FileReader) },
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &readAsArrayBuffer_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"readAsText\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &readAsText_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"readAsDataURL\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &readAsDataURL_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &result_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
...
&[
    ConstantSpec { name: b"EMPTY\0", value: ConstantVal::IntVal(0) },
    ConstantSpec { name: b"LOADING\0", value: ConstantVal::IntVal(1) },
    ConstantSpec { name: b"DONE\0", value: ConstantVal::IntVal(2) }]
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::FileReader as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"FileReaderPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function FileReader() {\n    [native code]\n}",
        PrototypeList::ID::FileReader,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::FileReader as usize].is_null());
    (*cache)[PrototypeList::ID::FileReader as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::FileReader as isize),
                                  ptr::null_mut(),
                                  prototype.get());
