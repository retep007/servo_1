...
impl TextDecoderOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> TextDecoderOptions {
        match TextDecoderOptions::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = TextDecoderOptions {
            fatal: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "fatal", rval.handle_mut())) {
                    true => {
            ...
            ignoreBOM: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "ignoreBOM", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for TextDecoderOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<TextDecoderOptions>, ()> {
        TextDecoderOptions::new(cx, value)
    }
}
...
impl ToJSValConvertible for TextDecoderOptions {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut fatal_js = UndefinedValue());
        fatal.to_jsval(cx, fatal_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "fatal", fatal_js.handle()).unwrap();
        let ignoreBOM = &self.ignoreBOM;
        rooted!(in(cx) let mut ignoreBOM_js = UndefinedValue());
        ignoreBOM.to_jsval(cx, ignoreBOM_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "ignoreBOM", ignoreBOM_js.handle()).unwrap();
...
impl TextDecodeOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> TextDecodeOptions {
        match TextDecodeOptions::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<TextDecodeOptions>, ()> {
        let object = if val.get().is_null_or_undefined() {
            ptr::null_mut()
        } else if val.get().is_object() {
            val.get().to_object()
        ...
        rooted!(in(cx) let object = object);
            let dictionary = TextDecodeOptions {
            stream: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "stream", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for TextDecodeOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<TextDecodeOptions>, ()> {
        TextDecodeOptions::new(cx, value)
    }
}
...
impl ToJSValConvertible for TextDecodeOptions {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut stream_js = UndefinedValue());
        stream.to_jsval(cx, stream_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "stream", stream_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::TextDecoderBinding::{Wrap, TextDecoderMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_fatal<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TextDecoder<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.Fatal();
...
fn fatal_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_ignoreBOM<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TextDecoder<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.IgnoreBOM();
...
fn ignoreBOM_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn decode<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TextDecoder<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let arg0: Option<UnionTypes::ArrayBufferViewOrArrayBuffer> = if args.get(0).is_undefined() {
            None
        } else {
        ...
        let arg1: dom::bindings::codegen::Bindings::TextDecoderBinding::TextDecodeOptions = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::TextDecoderBinding::TextDecodeOptions::empty(cx)
        } else {
...
fn decode_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TextDecoder<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut TextDecoder<TH>);
            }
            debug!("TextDecoder<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"TextDecoder\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::TextDecoder, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<TextDecoder<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<TextDecoder<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<TextDecoder<TH>>) -> DomRoot<TextDecoder<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for TextDecoder<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for TextDecoder<TH> {
    fn eq(&self, other: &TextDecoder<TH>) -> bool {
        self as *const TextDecoder<TH> == &*other
    }
}

pub trait TextDecoderMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::TextDecoder as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"TextDecoderPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg1: dom::bindings::codegen::Bindings::TextDecoderBinding::TextDecoderOptions = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::TextDecoderBinding::TextDecoderOptions::empty(cx)
        } else {
            match FromJSValConvertible::from_jsval(cx, args.get(1), ()) {
                Ok(ConversionResult::Success(dictionary)) => dictionary,
                Ok(ConversionResult::Failure(error)) => {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function TextDecoder() {\n    [native code]\n}",
        PrototypeList::ID::TextDecoder,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::TextDecoder as usize].is_null());
    (*cache)[PrototypeList::ID::TextDecoder as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::TextDecoder as isize),
                                  ptr::null_mut(),
                                  prototype.get());
