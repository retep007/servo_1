...
unsafe extern fn addModule<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Worklet<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for Worklet<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for Worklet<TH> {
    fn eq(&self, other: &Worklet<TH>) -> bool {
        self as *const Worklet<TH> == &*other
    }
}

pub trait WorkletMethods<TH: TypeHolderTrait> {
