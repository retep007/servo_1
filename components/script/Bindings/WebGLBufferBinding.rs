...
pub use self::WebGLBufferBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLBuffer<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WebGLBuffer<TH>);
            }
            debug!("WebGLBuffer<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"WebGLBuffer\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::WebGLObject, PrototypeList::ID::WebGLBuffer, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { webglobject: (::dom::bindings::codegen::InheritTypes::WebGLObjectTypeId::WebGLBuffer) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<WebGLBuffer<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WebGLBuffer<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WebGLBuffer<TH>>) -> DomRoot<WebGLBuffer<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLBuffer<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLBuffer<TH> {
    fn eq(&self, other: &WebGLBuffer<TH>) -> bool {
        self as *const WebGLBuffer<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLBuffer as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WebGLBufferPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function WebGLBuffer() {\n    [native code]\n}",
        PrototypeList::ID::WebGLBuffer,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WebGLBuffer as usize].is_null());
    (*cache)[PrototypeList::ID::WebGLBuffer as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WebGLBuffer as isize),
                                  ptr::null_mut(),
                                  prototype.get());
