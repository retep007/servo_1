...
pub use self::WorkerLocationBinding::{Wrap, WorkerLocationMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WorkerLocation<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn href_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::WorkerLocation as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WorkerLocation<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WorkerLocation<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WorkerLocation<TH>);
            }
            debug!("WorkerLocation<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"WorkerLocation\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::WorkerLocation, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
	malloc_size_of: malloc_size_of_including_raw_self::<WorkerLocation<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WorkerLocation<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WorkerLocation<TH>>) -> DomRoot<WorkerLocation<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WorkerLocation<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WorkerLocation<TH> {
    fn eq(&self, other: &WorkerLocation<TH>) -> bool {
        self as *const WorkerLocation<TH> == &*other
    }
}

pub trait WorkerLocationMethods {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WorkerLocation as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WorkerLocationPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function WorkerLocation() {\n    [native code]\n}",
        PrototypeList::ID::WorkerLocation,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WorkerLocation as usize].is_null());
    (*cache)[PrototypeList::ID::WorkerLocation as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WorkerLocation as isize),
                                  ptr::null_mut(),
                                  prototype.get());
