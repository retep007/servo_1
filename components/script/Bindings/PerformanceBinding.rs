...
use dom::types::PerformanceEntry;
...
pub type PerformanceEntryList<TH> = Vec<DomRoot<PerformanceEntry<TH>>>;

pub use self::PerformanceBinding::{Wrap, PerformanceMethods, GetProtoObject, DefineDOMInterface};
...
use dom::types::PerformanceEntry;
use dom::types::PerformanceTiming;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: Finite<f64> = this.Now();
...
const now_methodinfo: JSJitInfo = JSJitInfo {
    call: now as *const os::raw::c_void,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<PerformanceTiming<TH>> = this.Timing();
...
const timing_getterinfo: JSJitInfo = JSJitInfo {
    call: get_timing as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let args = &*args;
        let argc = args._base.argc_;
        let result: Vec<DomRoot<PerformanceEntry<TH>>> = this.GetEntries();
...
const getEntries_methodinfo: JSJitInfo = JSJitInfo {
    call: getEntries as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Performance.getEntriesByType\".");
            return false;
        }
        ...
        let result: Vec<DomRoot<PerformanceEntry<TH>>> = this.GetEntriesByType(arg0);
...
const getEntriesByType_methodinfo: JSJitInfo = JSJitInfo {
    call: getEntriesByType as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Performance.getEntriesByName\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
        ...
        let result: Vec<DomRoot<PerformanceEntry<TH>>> = this.GetEntriesByName(arg0, arg1);
...
const getEntriesByName_methodinfo: JSJitInfo = JSJitInfo {
    call: getEntriesByName as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Performance.mark\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
const mark_methodinfo: JSJitInfo = JSJitInfo {
    call: mark as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.ClearMarks(arg0);
...
const clearMarks_methodinfo: JSJitInfo = JSJitInfo {
    call: clearMarks as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Performance.measure\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
const measure_methodinfo: JSJitInfo = JSJitInfo {
    call: measure as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Performance<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.ClearMeasures(arg0);
...
const clearMeasures_methodinfo: JSJitInfo = JSJitInfo {
    call: clearMeasures as *const os::raw::c_void,
    protoID: PrototypeList::ID::Performance as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Performance<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut Performance<TH>);
            }
            debug!("Performance<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Performance, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<Performance<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &now_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getEntries\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntries_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getEntriesByType\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntriesByType_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getEntriesByName\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntriesByName_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &mark_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"clearMarks\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &clearMarks_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"measure\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &measure_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"clearMeasures\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &clearMeasures_methodinfo as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &timing_getterinfo },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::Performance as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PerformancePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::Performance as usize].is_null());
    (*cache)[PrototypeList::ID::Performance as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::Performance as isize),
                                  ptr::null_mut(),
                                  prototype.get());
