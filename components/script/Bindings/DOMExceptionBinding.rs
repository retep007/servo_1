...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DOMException<TH>>(obj).unwrap();
            if !this.is_null() {
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<DOMException<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for DOMException<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for DOMException<TH> {
