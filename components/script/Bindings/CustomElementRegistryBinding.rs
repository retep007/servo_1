...
impl ElementDefinitionOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> ElementDefinitionOptions {
        match ElementDefinitionOptions::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            ...
            extends: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "extends", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for ElementDefinitionOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<ElementDefinitionOptions>, ()> {
        ElementDefinitionOptions::new(cx, value)
    }
}
...
pub use self::CustomElementRegistryBinding::{Wrap, CustomElementRegistryMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn define<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CustomElementRegistry<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg2: dom::bindings::codegen::Bindings::CustomElementRegistryBinding::ElementDefinitionOptions = if args.get(2).is_undefined() {
            dom::bindings::codegen::Bindings::CustomElementRegistryBinding::ElementDefinitionOptions::empty(cx)
        } else {
...
fn define_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: define::<TH> as *const os::raw::c_void,
...
unsafe extern fn whenDefined<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CustomElementRegistry<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let result: Rc<Promise<TH>> = this.WhenDefined(arg0);
...
fn whenDefined_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: whenDefined::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CustomElementRegistry as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CustomElementRegistry<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CustomElementRegistry<TH>);
            }
            debug!("CustomElementRegistry<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<CustomElementRegistry<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CustomElementRegistry<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CustomElementRegistry<TH>>) -> DomRoot<CustomElementRegistry<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CustomElementRegistry<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CustomElementRegistry<TH> {
    fn eq(&self, other: &CustomElementRegistry<TH>) -> bool {
        self as *const CustomElementRegistry<TH> == &*other
    }
}

pub trait CustomElementRegistryMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &define_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 2,
    ...
    JSFunctionSpec {
        name: b"whenDefined\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &whenDefined_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CustomElementRegistry as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    ...
    PREFS.get("dom.customelements.enabled").as_boolean().unwrap_or(false)
}
...
} // mod CustomElementRegistryBinding
