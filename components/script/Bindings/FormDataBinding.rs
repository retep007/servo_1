...
impl<TH: TypeHolderTrait> IDLInterface for FormData<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for FormData<TH> {
    fn eq(&self, other: &FormData<TH>) -> bool {
        self as *const FormData<TH> == &*other
    }
}

pub trait FormDataMethods<TH: TypeHolderTrait> {
...
impl<TH: TypeHolderTrait> IDLInterface for IterableIterator<FormData<TH>, TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class as *const _ == &Class.dom_class as *const _
    }
...
impl<TH: TypeHolderTrait> PartialEq for IterableIterator<FormData<TH>, TH> {
    fn eq(&self, other: &IterableIterator<FormData<TH>, TH>) -> bool {
        self as *const IterableIterator<FormData<TH>, TH> == &*other
    }
}

pub trait FormDataIteratorMethods<TH: TypeHolderTrait> {
