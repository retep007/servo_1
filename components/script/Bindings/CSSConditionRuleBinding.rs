...
pub use self::CSSConditionRuleBinding::{CSSConditionRuleMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::CSSGroupingRuleBinding::CSSGroupingRuleBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSConditionRule<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.ConditionText();
...
(cx: *mut JSContext, obj: HandleObject, this: *const CSSConditionRule<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: () = this.SetConditionText(arg0);
...
pub trait CSSConditionRuleMethods {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSSConditionRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSConditionRulePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::CSSConditionRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    CSSGroupingRuleBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::CSSConditionRule as usize].is_null());
    (*cache)[PrototypeList::ID::CSSConditionRule as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSSConditionRule as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    CSSGroupingRuleBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"CSSConditionRule\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
    assert!((*cache)[PrototypeList::Constructor::CSSConditionRule as usize].is_null());
    (*cache)[PrototypeList::Constructor::CSSConditionRule as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::CSSConditionRule as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod CSSConditionRuleBinding
