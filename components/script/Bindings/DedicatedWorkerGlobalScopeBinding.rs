...
pub use self::DedicatedWorkerGlobalScopeBinding::{Wrap, DedicatedWorkerGlobalScopeMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::DedicatedWorkerGlobalScope;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const DedicatedWorkerGlobalScope<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"DedicatedWorkerGlobalScope.postMessage\".");
            return false;
        }
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<DedicatedWorkerGlobalScope<TH>>(obj).unwrap();
        finalize_global(obj);
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut DedicatedWorkerGlobalScope<TH>);
            }
            debug!("DedicatedWorkerGlobalScope<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::GlobalScope, PrototypeList::ID::WorkerGlobalScope, PrototypeList::ID::DedicatedWorkerGlobalScope, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::GlobalScope(::dom::bindings::codegen::InheritTypes::GlobalScopeTypeId::WorkerGlobalScope(::dom::bindings::codegen::InheritTypes::WorkerGlobalScopeTypeId::DedicatedWorkerGlobalScope))) },
    global: InterfaceObjectMap::Globals::DEDICATED_WORKER_GLOBAL_SCOPE,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::DedicatedWorkerGlobalScope as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"DedicatedWorkerGlobalScopePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function DedicatedWorkerGlobalScope() {\n    [native code]\n}",
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::DedicatedWorkerGlobalScope as usize].is_null());
    (*cache)[PrototypeList::ID::DedicatedWorkerGlobalScope as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::DedicatedWorkerGlobalScope as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"DedicatedWorkerGlobalScope\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod DedicatedWorkerGlobalScopeBinding
