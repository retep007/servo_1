...
pub use self::VRFrameDataBinding::{Wrap, VRFrameDataMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Finite<f64> = this.Timestamp();
...
unsafe extern fn get_leftProjectionMatrix<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: NonNull<JSObject> = this.LeftProjectionMatrix(cx);
...
fn leftProjectionMatrix_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_leftViewMatrix<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: NonNull<JSObject> = this.LeftViewMatrix(cx);
...
fn leftViewMatrix_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_rightProjectionMatrix<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: NonNull<JSObject> = this.RightProjectionMatrix(cx);
...
fn rightProjectionMatrix_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn get_rightViewMatrix<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: NonNull<JSObject> = this.RightViewMatrix(cx);
...
fn rightViewMatrix_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(cx: *mut JSContext, _obj: HandleObject, this: *const VRFrameData<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DomRoot<VRPose<TH>> = this.Pose();
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VRFrameData<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut VRFrameData<TH>);
            }
            debug!("VRFrameData<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"VRFrameData\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::VRFrameData, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
	malloc_size_of: malloc_size_of_including_raw_self::<VRFrameData<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<VRFrameData<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<VRFrameData<TH>>) -> DomRoot<VRFrameData<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for VRFrameData<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for VRFrameData<TH> {
    fn eq(&self, other: &VRFrameData<TH>) -> bool {
        self as *const VRFrameData<TH> == &*other
    }
}

pub trait VRFrameDataMethods<TH: TypeHolderTrait<TH>> {
    fn Timestamp(&self) -> Finite<f64>;
    unsafe fn LeftProjectionMatrix(&self, cx: *mut JSContext) -> NonNull<JSObject>;
    unsafe fn LeftViewMatrix(&self, cx: *mut JSContext) -> NonNull<JSObject>;
    unsafe fn RightProjectionMatrix(&self, cx: *mut JSContext) -> NonNull<JSObject>;
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::VRFrameData as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"VRFrameDataPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function VRFrameData() {\n    [native code]\n}",
        PrototypeList::ID::VRFrameData,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::VRFrameData as usize].is_null());
    (*cache)[PrototypeList::ID::VRFrameData as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::VRFrameData as isize),
                                  ptr::null_mut(),
                                  prototype.get());
