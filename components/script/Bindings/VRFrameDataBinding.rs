...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VRFrameData<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for VRFrameData<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for VRFrameData<TH> {
    fn eq(&self, other: &VRFrameData<TH>) -> bool {
        self as *const VRFrameData<TH> == &*other
    }
}

pub trait VRFrameDataMethods<TH: TypeHolderTrait> {
