...
unsafe extern fn get_characteristic<TH: TypeHolderTrait<TH>>
...
fn characteristic_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_characteristic::<TH> as *const os::raw::c_void,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothRemoteGATTDescriptor<TH>>(obj).unwrap();
            if !this.is_null() {
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<BluetoothRemoteGATTDescriptor<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for BluetoothRemoteGATTDescriptor<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for BluetoothRemoteGATTDescriptor<TH> {
    fn eq(&self, other: &BluetoothRemoteGATTDescriptor<TH>) -> bool {
        self as *const BluetoothRemoteGATTDescriptor<TH> == &*other
    }
}

pub trait BluetoothRemoteGATTDescriptorMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &characteristic_getterinfo::<TH>() },
