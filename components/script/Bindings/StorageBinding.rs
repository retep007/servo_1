...
unsafe extern fn key<TH: TypeHolderTrait<TH>>
...
fn key_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn setItem<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const Storage<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn setItem_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn removeItem<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const Storage<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn removeItem_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for Storage<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for Storage<TH> {
    fn eq(&self, other: &Storage<TH>) -> bool {
        self as *const Storage<TH> == &*other
    }
}

pub trait StorageMethods<TH: TypeHolderTrait<TH>> {
    fn Length(&self) -> u32;
