...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MediaQueryListEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for MediaQueryListEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for MediaQueryListEvent<TH> {
