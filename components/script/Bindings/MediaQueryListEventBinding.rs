...
impl MediaQueryListEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> MediaQueryListEventInit {
        match MediaQueryListEventInit::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = MediaQueryListEventInit {
            parent: {
            ...
            matches: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "matches", rval.handle_mut())) {
                    true => {
            ...
            media: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "media", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for MediaQueryListEventInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<MediaQueryListEventInit>, ()> {
        MediaQueryListEventInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for MediaQueryListEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut matches_js = UndefinedValue());
        matches.to_jsval(cx, matches_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "matches", matches_js.handle()).unwrap();
        let media = &self.media;
        rooted!(in(cx) let mut media_js = UndefinedValue());
        media.to_jsval(cx, media_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "media", media_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::MediaQueryListEventBinding::{Wrap, MediaQueryListEventMethods, GetProtoObject, DefineDOMInterface};
...
use dom::globalscope::GlobalScope;
use dom::types::Event;
use dom::types::MediaQueryListEvent;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const MediaQueryListEvent<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn media_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::MediaQueryListEvent as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MediaQueryListEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut MediaQueryListEvent<TH>);
            }
            debug!("MediaQueryListEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"MediaQueryListEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::MediaQueryListEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::MediaQueryListEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<MediaQueryListEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<MediaQueryListEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<MediaQueryListEvent<TH>>) -> DomRoot<MediaQueryListEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for MediaQueryListEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for MediaQueryListEvent<TH> {
    fn eq(&self, other: &MediaQueryListEvent<TH>) -> bool {
        self as *const MediaQueryListEvent<TH> == &*other
    }
}

pub trait MediaQueryListEventMethods {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::MediaQueryListEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"MediaQueryListEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MediaQueryListEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::MediaQueryListEventBinding::MediaQueryListEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::MediaQueryListEventBinding::MediaQueryListEventInit::empty(cx)
        } else {
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function MediaQueryListEvent() {\n    [native code]\n}",
        PrototypeList::ID::MediaQueryListEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::MediaQueryListEvent as usize].is_null());
    (*cache)[PrototypeList::ID::MediaQueryListEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::MediaQueryListEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
...
} // mod MediaQueryListEventBinding
