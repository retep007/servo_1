...
pub use self::StylePropertyMapReadOnlyBinding::{Wrap, StylePropertyMapReadOnlyMethods, GetProtoObject, DefineDOMInterface};
...
use dom::types::StylePropertyMapReadOnly;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const StylePropertyMapReadOnly<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"StylePropertyMapReadOnly.get\".");
            return false;
        }
        ...
        let result: Option<DomRoot<CSSStyleValue<TH>>> = this.Get(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const StylePropertyMapReadOnly<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"StylePropertyMapReadOnly.has\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
unsafe extern fn getProperties<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const StylePropertyMapReadOnly<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: Vec<DOMString> = this.GetProperties();
...
fn getProperties_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<StylePropertyMapReadOnly<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut StylePropertyMapReadOnly<TH>);
            }
            debug!("StylePropertyMapReadOnly<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"StylePropertyMapReadOnly\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::StylePropertyMapReadOnly, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<StylePropertyMapReadOnly<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<StylePropertyMapReadOnly<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<StylePropertyMapReadOnly<TH>>) -> DomRoot<StylePropertyMapReadOnly<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for StylePropertyMapReadOnly<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for StylePropertyMapReadOnly<TH> {
    fn eq(&self, other: &StylePropertyMapReadOnly<TH>) -> bool {
        self as *const StylePropertyMapReadOnly<TH> == &*other
    }
}

pub trait StylePropertyMapReadOnlyMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::StylePropertyMapReadOnly as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"StylePropertyMapReadOnlyPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function StylePropertyMapReadOnly() {\n    [native code]\n}",
        PrototypeList::ID::StylePropertyMapReadOnly,
        0);
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    is_exposed_in(aObj, InterfaceObjectMap::Globals::PAINT_WORKLET_GLOBAL_SCOPE | InterfaceObjectMap::Globals::TEST_WORKLET_GLOBAL_SCOPE) &&
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::StylePropertyMapReadOnly as usize].is_null());
    (*cache)[PrototypeList::ID::StylePropertyMapReadOnly as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::StylePropertyMapReadOnly as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"StylePropertyMapReadOnly\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod StylePropertyMapReadOnlyBinding
