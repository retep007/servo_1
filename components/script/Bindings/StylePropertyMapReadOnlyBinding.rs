...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<StylePropertyMapReadOnly<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for StylePropertyMapReadOnly<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for StylePropertyMapReadOnly<TH> {
    fn eq(&self, other: &StylePropertyMapReadOnly<TH>) -> bool {
        self as *const StylePropertyMapReadOnly<TH> == &*other
    }
}

pub trait StylePropertyMapReadOnlyMethods<TH: TypeHolderTrait> {
