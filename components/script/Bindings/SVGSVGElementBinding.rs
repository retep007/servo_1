...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    SVGGraphicsElementBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    SVGGraphicsElementBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
