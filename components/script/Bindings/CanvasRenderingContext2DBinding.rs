...
pub mod CanvasFillRuleValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasFillRule)] = &[
...
pub mod CanvasLineCapValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasLineCap)] = &[
...
pub mod CanvasLineJoinValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasLineJoin)] = &[
...
pub mod CanvasTextAlignValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasTextAlign)] = &[
...
pub mod CanvasTextBaselineValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasTextBaseline)] = &[
...
pub mod CanvasDirectionValues {
    ...
    pub const pairs: &'static [(&'static str, super::CanvasDirection)] = &[
    ...
    impl ToJSValConvertible for super::CanvasDirection {
        ...
        } // mod CanvasDirectionValues

pub use self::UnionTypes::HTMLImageElementOrHTMLCanvasElementOrCanvasRenderingContext2DOrCSSStyleValue as CanvasImageSource;

pub use self::CanvasRenderingContext2DBinding::{Wrap, CanvasRenderingContext2DMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: JSJitGetterCallArgs) -> bool {
...
(cx: *mut JSContext, obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
unsafe extern fn createImageData<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        match argcount {
            1 => {
                let arg0: DomRoot<ImageData<TH>> = if args.get(0).get().is_object() {
...
fn createImageData_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: createImageData::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CanvasRenderingContext2D as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn getImageData<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn getImageData_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getImageData::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CanvasRenderingContext2D as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn putImageData<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn putImageData_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: putImageData::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CanvasRenderingContext2D as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn fillText<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasRenderingContext2D<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let arg3: Option<f64> = if args.get(3).is_undefined() {
            ...
            Some(match FromJSValConvertible::from_jsval(cx, args.get(3), ()) {
                Ok(ConversionResult::Success(v)) => v,
                Ok(ConversionResult::Failure(error)) => {
                    throw_type_error(cx, &error);
                    return false;
...
fn fillText_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: fillText::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CanvasRenderingContext2D as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CanvasRenderingContext2D<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CanvasRenderingContext2D<TH>);
            }
            debug!("CanvasRenderingContext2D<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<CanvasRenderingContext2D<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CanvasRenderingContext2D<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CanvasRenderingContext2D<TH>>) -> DomRoot<CanvasRenderingContext2D<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CanvasRenderingContext2D<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CanvasRenderingContext2D<TH> {
    fn eq(&self, other: &CanvasRenderingContext2D<TH>) -> bool {
        self as *const CanvasRenderingContext2D<TH> == &*other
    }
}

pub trait CanvasRenderingContext2DMethods<TH: TypeHolderTrait<TH>> {
...
&[
    ...
    JSFunctionSpec {
        name: b"createImageData\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &createImageData_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"getImageData\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &getImageData_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 4,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"putImageData\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &putImageData_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 3,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    JSFunctionSpec {
        name: b"fillText\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &fillText_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 3,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
fn sMethods<TH: TypeHolderTrait<TH>>() -> &'static [Guard<&'static [JSFunctionSpec]>] { &[
    ...
    Guard::new(Condition::Pref("dom.canvas-text.enabled"), sMethods_specs::<TH>()[1]),
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CanvasRenderingContext2D as usize]);
    if !rval.get().is_null() {
        return;
    }
...
} // mod CanvasRenderingContext2DBinding
