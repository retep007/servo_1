...
pub use self::BluetoothDeviceBinding::{Wrap, BluetoothDeviceMethods, GetProtoObject, DefineDOMInterface};
...
use dom::types::BluetoothRemoteGATTServer;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn id_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DOMString> = this.GetName();
...
unsafe extern fn get_gatt<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DomRoot<BluetoothRemoteGATTServer<TH>>> = this.GetGatt();
...
fn gatt_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_gatt::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn watchAdvertisements<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: Rc<Promise<TH>> = this.WatchAdvertisements();
...
fn watchAdvertisements_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: watchAdvertisements::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn unwatchAdvertisements<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        let argc = args._base.argc_;
        let result: () = this.UnwatchAdvertisements();
...
fn unwatchAdvertisements_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: unwatchAdvertisements::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn get_watchingAdvertisements<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.WatchingAdvertisements();
...
fn watchingAdvertisements_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_watchingAdvertisements::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
unsafe extern fn get_ongattserverdisconnected<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>> = this.GetOngattserverdisconnected();
...
unsafe extern fn set_ongattserverdisconnected<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, obj: HandleObject, this: *const BluetoothDevice<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        ...
        let result: () = this.SetOngattserverdisconnected(arg0);
...
fn ongattserverdisconnected_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_ongattserverdisconnected::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
fn ongattserverdisconnected_setterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: set_ongattserverdisconnected::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::BluetoothDevice as u16,
    depth: 1,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothDevice<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut BluetoothDevice<TH>);
            }
            debug!("BluetoothDevice<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"BluetoothDevice\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::BluetoothDevice, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::BluetoothDevice) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<BluetoothDevice<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<BluetoothDevice<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<BluetoothDevice<TH>>) -> DomRoot<BluetoothDevice<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for BluetoothDevice<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for BluetoothDevice<TH> {
    fn eq(&self, other: &BluetoothDevice<TH>) -> bool {
        self as *const BluetoothDevice<TH> == &*other
    }
}

pub trait BluetoothDeviceMethods<TH: TypeHolderTrait<TH>> {
    ...
    fn GetOngattserverdisconnected(&self) -> Option<Rc<dom::bindings::codegen::Bindings::EventHandlerBinding::EventHandlerNonNull<TH>>>;
    fn SetOngattserverdisconnected(&self, value: Option<Rc<EventHandlerNonNull<TH>>>) -> ();
}
fn sMethods_specs<TH: TypeHolderTrait<TH>>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"watchAdvertisements\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &watchAdvertisements_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"unwatchAdvertisements\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &unwatchAdvertisements_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
&[
    ...
    JSPropertySpec {
        name: b"gatt\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &gatt_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"watchingAdvertisements\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &watchingAdvertisements_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"ongattserverdisconnected\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &ongattserverdisconnected_getterinfo::<TH>() },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &ongattserverdisconnected_setterinfo::<TH>() }
    },
    JSPropertySpec {
        name: 0 as *const libc::c_char,
        flags: 0,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BluetoothDevice as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BluetoothDevicePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function BluetoothDevice() {\n    [native code]\n}",
        PrototypeList::ID::BluetoothDevice,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BluetoothDevice as usize].is_null());
    (*cache)[PrototypeList::ID::BluetoothDevice as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BluetoothDevice as isize),
                                  ptr::null_mut(),
                                  prototype.get());
