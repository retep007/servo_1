...
unsafe extern fn addColorStop<TH: TypeHolderTrait>
...
fn addColorStop_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CanvasGradient<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for CanvasGradient<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CanvasGradient<TH> {
