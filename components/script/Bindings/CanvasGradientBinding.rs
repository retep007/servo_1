...
pub use self::CanvasGradientBinding::{Wrap, CanvasGradientMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn addColorStop<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CanvasGradient<TH>, args: *const JSJitMethodCallArgs) -> bool {
...
fn addColorStop_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: addColorStop::<TH> as *const os::raw::c_void,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CanvasGradient<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CanvasGradient<TH>);
            }
            debug!("CanvasGradient<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<CanvasGradient<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CanvasGradient<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CanvasGradient<TH>>) -> DomRoot<CanvasGradient<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CanvasGradient<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CanvasGradient<TH> {
    fn eq(&self, other: &CanvasGradient<TH>) -> bool {
        self as *const CanvasGradient<TH> == &*other
    }
}

pub trait CanvasGradientMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &addColorStop_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 2,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CanvasGradient as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    is_exposed_in(aObj, InterfaceObjectMap::Globals::PAINT_WORKLET_GLOBAL_SCOPE | InterfaceObjectMap::Globals::WINDOW)
}
