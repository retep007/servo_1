...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLAreaElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLAreaElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLAreaElement<TH> {
    fn eq(&self, other: &HTMLAreaElement<TH>) -> bool {
        self as *const HTMLAreaElement<TH> == &*other
    }
}

pub trait HTMLAreaElementMethods<TH: TypeHolderTrait> {
