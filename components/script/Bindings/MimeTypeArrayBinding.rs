...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MimeTypeArray<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for MimeTypeArray<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for MimeTypeArray<TH> {
    fn eq(&self, other: &MimeTypeArray<TH>) -> bool {
        self as *const MimeTypeArray<TH> == &*other
    }
}

pub trait MimeTypeArrayMethods<TH: TypeHolderTrait> {
    fn Length(&self) -> u32;
