...
pub use self::PerformanceObserverEntryListBinding::{Wrap, PerformanceObserverEntryListMethods, GetProtoObject, DefineDOMInterface};
...
use dom::types::PerformanceObserverEntryList;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PerformanceObserverEntryList<TH>, args: *const JSJitMethodCallArgs) -> bool {
...
const getEntries_methodinfo: JSJitInfo = JSJitInfo {
    ...
    protoID: PrototypeList::ID::PerformanceObserverEntryList as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PerformanceObserverEntryList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PerformanceObserverEntryList.getEntriesByType\".");
            return false;
        }
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PerformanceObserverEntryList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PerformanceObserverEntryList.getEntriesByName\".");
            return false;
        }
        let arg0: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(0), StringificationBehavior::Default) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PerformanceObserverEntryList<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PerformanceObserverEntryList<TH>);
            }
            debug!("PerformanceObserverEntryList<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"PerformanceObserverEntryList\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::PerformanceObserverEntryList, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PerformanceObserverEntryList<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<PerformanceObserverEntryList<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PerformanceObserverEntryList<TH>>) -> DomRoot<PerformanceObserverEntryList<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for PerformanceObserverEntryList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PerformanceObserverEntryList<TH> {
    fn eq(&self, other: &PerformanceObserverEntryList<TH>) -> bool {
        self as *const PerformanceObserverEntryList<TH> == &*other
    }
}

pub trait PerformanceObserverEntryListMethods<TH: TypeHolderTrait> {
    fn GetEntries(&self) -> Vec<DomRoot<PerformanceEntry<TH>>>;
    fn GetEntriesByType(&self, entryType: DOMString) -> Vec<DomRoot<PerformanceEntry<TH>>>;
    fn GetEntriesByName(&self, name: DOMString, entryType: Option<DOMString>) -> Vec<DomRoot<PerformanceEntry<TH>>>;
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PerformanceObserverEntryList as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PerformanceObserverEntryListPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PerformanceObserverEntryList() {\n    [native code]\n}",
        PrototypeList::ID::PerformanceObserverEntryList,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::PerformanceObserverEntryList as usize].is_null());
    (*cache)[PrototypeList::ID::PerformanceObserverEntryList as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PerformanceObserverEntryList as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"PerformanceObserverEntryList\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod PerformanceObserverEntryListBinding
