...
impl<TH: TypeHolderTrait<TH>> IDLInterface for PerformanceObserverEntryList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for PerformanceObserverEntryList<TH> {
    fn eq(&self, other: &PerformanceObserverEntryList<TH>) -> bool {
        self as *const PerformanceObserverEntryList<TH> == &*other
    }
}

pub trait PerformanceObserverEntryListMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntries_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntriesByType_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getEntriesByName_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
