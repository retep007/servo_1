...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<RadioNodeList<TH>>(obj).unwrap();
            if !this.is_null() {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    NodeListBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    NodeListBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
