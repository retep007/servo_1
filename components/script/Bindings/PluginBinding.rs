...
pub use self::PluginBinding::{Wrap, PluginMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Plugin<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn name_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::Plugin as u16,
    depth: 0,
...
unsafe extern fn get_description<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const Plugin<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn description_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Plugin<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Plugin.item\".");
            return false;
        }
        ...
        let result: Option<DomRoot<MimeType<TH>>> = this.Item(arg0);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Plugin<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Plugin.namedItem\".");
            return false;
        }
        ...
        let result: Option<DomRoot<MimeType<TH>>> = this.NamedItem(arg0);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Plugin<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut Plugin<TH>);
            }
            debug!("Plugin<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const Plugin<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const Plugin<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::Plugin, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<Plugin<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let this = &*this;
            let result: Option<DomRoot<MimeType<TH>>> = this.IndexedGetter(index);
        ...
        if index.is_none() && (RUST_JSID_IS_STRING(id) || RUST_JSID_IS_INT(id)) {
            ...
            if !has_on_proto {
                ...
                let this = UnwrapProxy(proxy);
                let this = &*this;
                let result: Option<DomRoot<MimeType<TH>>> = this.NamedGetter(name);
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"Plugin\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<Plugin<TH>>) -> DomRoot<Plugin<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::Plugin as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for Plugin<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for Plugin<TH> {
    fn eq(&self, other: &Plugin<TH>) -> bool {
        self as *const Plugin<TH> == &*other
    }
}

pub trait PluginMethods<TH: TypeHolderTrait<TH>> {
    fn Name(&self) -> DOMString;
    fn Description(&self) -> DOMString;
    fn Filename(&self) -> DOMString;
    fn Length(&self) -> u32;
    fn Item(&self, index: u32) -> Option<DomRoot<MimeType<TH>>>;
    fn NamedItem(&self, name: DOMString) -> Option<DomRoot<MimeType<TH>>>;
    fn SupportedPropertyNames(&self) -> Vec<DOMString>;
    fn NamedGetter(&self, name: DOMString) -> Option<DomRoot<MimeType<TH>>>;
    fn IndexedGetter(&self, index: u32) -> Option<DomRoot<MimeType<TH>>>;
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::Plugin as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PluginPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::Plugin as usize].is_null());
    (*cache)[PrototypeList::ID::Plugin as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::Plugin as isize),
                                  ptr::null_mut(),
                                  prototype.get());
