...
pub use self::CSSFontFaceRuleBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSFontFaceRule<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CSSFontFaceRule<TH>);
            }
            debug!("CSSFontFaceRule<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"CSSFontFaceRule\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::CSSRule, PrototypeList::ID::CSSFontFaceRule, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { cssrule: (::dom::bindings::codegen::InheritTypes::CSSRuleTypeId::CSSFontFaceRule) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<CSSFontFaceRule<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CSSFontFaceRule<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CSSFontFaceRule<TH>>) -> DomRoot<CSSFontFaceRule<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CSSFontFaceRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CSSFontFaceRule<TH> {
    fn eq(&self, other: &CSSFontFaceRule<TH>) -> bool {
        self as *const CSSFontFaceRule<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSSFontFaceRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSFontFaceRulePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function CSSFontFaceRule() {\n    [native code]\n}",
        PrototypeList::ID::CSSFontFaceRule,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CSSFontFaceRule as usize].is_null());
    (*cache)[PrototypeList::ID::CSSFontFaceRule as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSSFontFaceRule as isize),
                                  ptr::null_mut(),
                                  prototype.get());
