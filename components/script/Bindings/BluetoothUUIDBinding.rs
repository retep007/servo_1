...
impl<TH: TypeHolderTrait> PartialEq for BluetoothUUID<TH> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(getService)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
    ...
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(getCharacteristic)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(getDescriptor)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: /*Some(canonicalUUID)*/None, info: 0 as *const JSJitInfo },
        nargs: 1,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
