...
pub use self::UnionTypes::StringOrUnsignedLong as BluetoothServiceUUID;

pub use self::UnionTypes::StringOrUnsignedLong as BluetoothCharacteristicUUID;

pub use self::UnionTypes::StringOrUnsignedLong as BluetoothDescriptorUUID;

pub use self::BluetoothUUIDBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn getService<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothUUID.getService\".");
            return false;
        }
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothUUID.getCharacteristic\".");
            return false;
        }
        let arg0: UnionTypes::StringOrUnsignedLong = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(value)) => value,
...
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothUUID.getDescriptor\".");
            return false;
        }
        let arg0: UnionTypes::StringOrUnsignedLong = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(value)) => value,
...
unsafe extern fn canonicalUUID<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let global = GlobalScope::<TH>::from_object(JS_CALLEE(cx, vp).to_object());
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"BluetoothUUID.canonicalUUID\".");
            return false;
        }
        let arg0: u32 = match FromJSValConvertible::from_jsval(cx, args.get(0), ConversionBehavior::EnforceRange) {
        ...
        let result: DOMString = BluetoothUUID::CanonicalUUID(&global, arg0);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<BluetoothUUID<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut BluetoothUUID<TH>);
            }
            debug!("BluetoothUUID<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::BluetoothUUID, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
	malloc_size_of: malloc_size_of_including_raw_self::<BluetoothUUID<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<BluetoothUUID<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<BluetoothUUID<TH>>) -> DomRoot<BluetoothUUID<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for BluetoothUUID<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for BluetoothUUID<TH> {
    fn eq(&self, other: &BluetoothUUID<TH>) -> bool {
        self as *const BluetoothUUID<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::BluetoothUUID as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"BluetoothUUIDPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function BluetoothUUID() {\n    [native code]\n}",
        PrototypeList::ID::BluetoothUUID,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::BluetoothUUID as usize].is_null());
    (*cache)[PrototypeList::ID::BluetoothUUID as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::BluetoothUUID as isize),
                                  ptr::null_mut(),
                                  prototype.get());
