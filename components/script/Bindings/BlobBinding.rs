...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Blob<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for Blob<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for Blob<TH> {
    fn eq(&self, other: &Blob<TH>) -> bool {
        self as *const Blob<TH> == &*other
    }
}

pub trait BlobMethods<TH: TypeHolderTrait> {
    fn Size(&self) -> u64;
