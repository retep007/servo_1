...
pub use self::UnionTypes::ArrayBufferOrArrayBufferViewOrBlobOrString as BlobPart;
...
impl BlobPropertyBag {
    pub unsafe fn empty(cx: *mut JSContext) -> BlobPropertyBag {
        match BlobPropertyBag::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<BlobPropertyBag>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = BlobPropertyBag {
            type_: {
...
pub use self::BlobBinding::{Wrap, BlobMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
pub mod BlobBinding {
#![allow(non_camel_case_types,non_upper_case_globals,unused_imports,unused_variables,unused_assignments,unused_mut)]
use dom;
use dom::bindings;
...
fn type_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo {
 JSJitInfo {
...
unsafe extern fn slice<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const Blob<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result: DomRoot<Blob<TH>> = this.Slice(arg0, arg1, arg2);
...
fn slice_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Blob<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut Blob<TH>);
            }
            debug!("Blob<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Blob, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { blob: (::dom::bindings::codegen::InheritTypes::BlobTypeId::Blob) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<Blob<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<Blob<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<Blob<TH>>) -> DomRoot<Blob<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for Blob<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for Blob<TH> {
    fn eq(&self, other: &Blob<TH>) -> bool {
        self as *const Blob<TH> == &*other
    }
}

pub trait BlobMethods<TH: TypeHolderTrait<TH>> {
    fn Size(&self) -> u64;
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg0: Option<Vec<UnionTypes::ArrayBufferOrArrayBufferViewOrBlobOrString<TH>>> = if args.get(0).is_undefined() {
            None
        } else {
        ...
        let arg1: dom::bindings::codegen::Bindings::BlobBinding::BlobPropertyBag = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::BlobBinding::BlobPropertyBag::empty(cx)
        } else {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::Blob as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::Blob as usize].is_null());
    (*cache)[PrototypeList::ID::Blob as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::Blob as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    assert!((*cache)[PrototypeList::Constructor::Blob as usize].is_null());
    (*cache)[PrototypeList::Constructor::Blob as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::Blob as isize),
                                  ptr::null_mut(),
                                  interface.get());
