...
pub use self::TestWorkletGlobalScopeBinding::{Wrap, TestWorkletGlobalScopeMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::TestWorkletGlobalScope;
...
unsafe extern fn registerKeyValue<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const TestWorkletGlobalScope<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"TestWorkletGlobalScope.registerKeyValue\".");
            return false;
        }
        ...
        let result: () = this.RegisterKeyValue(arg0, arg1);
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TestWorkletGlobalScope<TH>>(obj).unwrap();
        finalize_global(obj);
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut TestWorkletGlobalScope<TH>);
            }
            debug!("TestWorkletGlobalScope<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"TestWorkletGlobalScope\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::GlobalScope, PrototypeList::ID::WorkletGlobalScope, PrototypeList::ID::TestWorkletGlobalScope, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::GlobalScope(::dom::bindings::codegen::InheritTypes::GlobalScopeTypeId::WorkletGlobalScope(::dom::bindings::codegen::InheritTypes::WorkletGlobalScopeTypeId::TestWorkletGlobalScope))) },
    global: InterfaceObjectMap::Globals::TEST_WORKLET_GLOBAL_SCOPE,
...
(cx: *mut JSContext, object: Box<TestWorkletGlobalScope<TH>>) -> DomRoot<TestWorkletGlobalScope<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for TestWorkletGlobalScope<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TestWorkletGlobalScope<TH> {
    fn eq(&self, other: &TestWorkletGlobalScope<TH>) -> bool {
        self as *const TestWorkletGlobalScope<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::TestWorkletGlobalScope as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"TestWorkletGlobalScopePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function TestWorkletGlobalScope() {\n    [native code]\n}",
        PrototypeList::ID::TestWorkletGlobalScope,
        3);
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    is_exposed_in(aObj, InterfaceObjectMap::Globals::TEST_WORKLET_GLOBAL_SCOPE) &&
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    WorkletGlobalScopeBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::TestWorkletGlobalScope as usize].is_null());
    (*cache)[PrototypeList::ID::TestWorkletGlobalScope as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::TestWorkletGlobalScope as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    WorkletGlobalScopeBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"TestWorkletGlobalScope\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod TestWorkletGlobalScopeBinding
