...
impl WebGLContextAttributes {
    pub unsafe fn empty(cx: *mut JSContext) -> WebGLContextAttributes {
        match WebGLContextAttributes::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            ...
            alpha: {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "alpha", rval.handle_mut())) {
                    true => {
            ...
            antialias: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "antialias", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            depth: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "depth", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            failIfMajorPerformanceCaveat: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "failIfMajorPerformanceCaveat", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            preferLowPowerToHighPerformance: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "preferLowPowerToHighPerformance", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            premultipliedAlpha: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "premultipliedAlpha", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            preserveDrawingBuffer: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "preserveDrawingBuffer", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            stencil: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "stencil", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for WebGLContextAttributes {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<WebGLContextAttributes>, ()> {
        WebGLContextAttributes::new(cx, value)
    }
}
...
pub use self::WebGLRenderingContextBinding::{WebGLRenderingContextConstants, Wrap, WebGLRenderingContextMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WebGLRenderingContext<TH>, args: *const JSJitMethodCallArgs) -> bool {
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WebGLRenderingContext<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const WebGLRenderingContext<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 8 {
            throw_type_error(cx, "Not enough arguments to \"WebGLRenderingContext.texImageDOM\".");
            return false;
        }
        let arg0: u32 = match FromJSValConvertible::from_jsval(cx, args.get(0), ConversionBehavior::Default) {
            Ok(ConversionResult::Success(v)) => v,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<WebGLRenderingContext<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut WebGLRenderingContext<TH>);
            }
            debug!("WebGLRenderingContext<TH> finalize: {:p}", this);
    }), ());
}
...
} // mod WebGLRenderingContextConstants
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<WebGLRenderingContext<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<WebGLRenderingContext<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<WebGLRenderingContext<TH>>) -> DomRoot<WebGLRenderingContext<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLRenderingContext<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLRenderingContext<TH> {
    fn eq(&self, other: &WebGLRenderingContext<TH>) -> bool {
        self as *const WebGLRenderingContext<TH> == &*other
    }
}

pub trait WebGLRenderingContextMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLRenderingContext as usize]);
    if !rval.get().is_null() {
        return;
    }
...
} // mod WebGLRenderingContextBinding
