...
unsafe extern fn getDisplays<TH: TypeHolderTrait<TH>>
...
fn getDisplays_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: getDisplays::<TH> as *const os::raw::c_void,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VR<TH>>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for VR<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for VR<TH> {
    fn eq(&self, other: &VR<TH>) -> bool {
        self as *const VR<TH> == &*other
    }
}

pub trait VRMethods<TH: TypeHolderTrait<TH>> {
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getDisplays_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
