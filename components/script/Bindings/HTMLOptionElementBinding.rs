...
const label_getterinfo: JSJitInfo = JSJitInfo {
    call: get_label as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const label_setterinfo: JSJitInfo = JSJitInfo {
    call: set_label as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const defaultSelected_getterinfo: JSJitInfo = JSJitInfo {
    call: get_defaultSelected as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const defaultSelected_setterinfo: JSJitInfo = JSJitInfo {
    call: set_defaultSelected as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
const selected_getterinfo: JSJitInfo = JSJitInfo {
    call: get_selected as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const selected_setterinfo: JSJitInfo = JSJitInfo {
    call: set_selected as *const os::raw::c_void,
    protoID: PrototypeList::ID::HTMLOptionElement as u16,
    depth: 4,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Setter as u8,
...
&[
    ...
    JSPropertySpec {
        ...
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &label_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &label_setterinfo }
    },
    JSPropertySpec {
        name: b"defaultSelected\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &defaultSelected_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &defaultSelected_setterinfo }
    },
    JSPropertySpec {
        name: b"selected\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &selected_getterinfo },
        setter: JSNativeWrapper { op: Some(generic_setter), info: &selected_setterinfo }
    },
    JSPropertySpec {
