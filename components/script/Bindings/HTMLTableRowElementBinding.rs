...
unsafe extern fn get_rowIndex<TH: TypeHolderTrait>
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLTableRowElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLTableRowElement<TH> {
    fn eq(&self, other: &HTMLTableRowElement<TH>) -> bool {
        self as *const HTMLTableRowElement<TH> == &*other
    }
}

pub trait HTMLTableRowElementMethods<TH: TypeHolderTrait> {
