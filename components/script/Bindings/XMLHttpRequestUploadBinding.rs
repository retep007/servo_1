...
pub use self::XMLHttpRequestUploadBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<XMLHttpRequestUpload<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut XMLHttpRequestUpload<TH>);
            }
            debug!("XMLHttpRequestUpload<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"XMLHttpRequestUpload\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::XMLHttpRequestEventTarget, PrototypeList::ID::XMLHttpRequestUpload, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::XMLHttpRequestEventTarget(::dom::bindings::codegen::InheritTypes::XMLHttpRequestEventTargetTypeId::XMLHttpRequestUpload)) },
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<XMLHttpRequestUpload<TH>>) -> DomRoot<XMLHttpRequestUpload<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for XMLHttpRequestUpload<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for XMLHttpRequestUpload<TH> {
    fn eq(&self, other: &XMLHttpRequestUpload<TH>) -> bool {
        self as *const XMLHttpRequestUpload<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::XMLHttpRequestUpload as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"XMLHttpRequestUploadPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function XMLHttpRequestUpload() {\n    [native code]\n}",
        PrototypeList::ID::XMLHttpRequestUpload,
        2);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    XMLHttpRequestEventTargetBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::XMLHttpRequestUpload as usize].is_null());
    (*cache)[PrototypeList::ID::XMLHttpRequestUpload as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::XMLHttpRequestUpload as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    XMLHttpRequestEventTargetBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"XMLHttpRequestUpload\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod XMLHttpRequestUploadBinding
