...
unsafe extern fn get_availWidth<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Screen<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for Screen<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for Screen<TH> {
