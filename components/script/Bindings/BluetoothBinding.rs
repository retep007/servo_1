...
unsafe extern fn getAvailability<TH: TypeHolderTrait>
...
const getAvailability_methodinfo: JSJitInfo = 
    JSJitInfo {
...
unsafe extern fn set_onavailabilitychanged<TH: TypeHolderTrait>
...
const onavailabilitychanged_getterinfo: JSJitInfo = 
    JSJitInfo {
        call: 0 as *const os::raw::c_void,
    protoID: PrototypeList::ID::Bluetooth as u16,
    depth: 1,
...
impl<TH: TypeHolderTrait> PartialEq for Bluetooth<TH> {
    fn eq(&self, other: &Bluetooth<TH>) -> bool {
        self as *const Bluetooth<TH> == &*other
    }
}

pub trait BluetoothMethods<TH: TypeHolderTrait> {
