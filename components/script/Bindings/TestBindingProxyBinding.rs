...
pub use self::TestBindingProxyBinding::{Wrap, TestBindingProxyMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::callback::ExceptionHandling;
use dom::bindings::callback::wrap_call_this_object;
use dom::bindings::codegen::Bindings::TestBindingBinding::TestBindingBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
use dom::types::TestBindingProxy;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const TestBindingProxy<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn getNamedItem_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TestBindingProxy<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut TestBindingProxy<TH>);
            }
            debug!("TestBindingProxy<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const TestBindingProxy<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const TestBindingProxy<TH>;
    return box_;
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    ...
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { testbinding: (::dom::bindings::codegen::InheritTypes::TestBindingTypeId::TestBindingProxy) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<TestBindingProxy<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"TestBindingProxy\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<TestBindingProxy<TH>>) -> DomRoot<TestBindingProxy<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::TestBindingProxy as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for TestBindingProxy<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for TestBindingProxy<TH> {
    fn eq(&self, other: &TestBindingProxy<TH>) -> bool {
        self as *const TestBindingProxy<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::TestBindingProxy as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    TestBindingBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    TestBindingBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
