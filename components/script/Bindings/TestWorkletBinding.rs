...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TestWorklet<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for TestWorklet<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TestWorklet<TH> {
    fn eq(&self, other: &TestWorklet<TH>) -> bool {
        self as *const TestWorklet<TH> == &*other
    }
}

pub trait TestWorkletMethods<TH: TypeHolderTrait> {
