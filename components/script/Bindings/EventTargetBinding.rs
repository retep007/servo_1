...
unsafe extern fn addEventListener<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<EventTarget<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for EventTarget<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for EventTarget<TH> {
    fn eq(&self, other: &EventTarget<TH>) -> bool {
        self as *const EventTarget<TH> == &*other
    }
}

pub trait EventTargetMethods<TH: TypeHolderTrait> {
