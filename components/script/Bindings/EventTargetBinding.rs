...
impl EventListenerOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> EventListenerOptions {
        match EventListenerOptions::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<EventListenerOptions>, ()> {
        ...
        rooted!(in(cx) let object = object);
            let dictionary = EventListenerOptions {
            capture: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "capture", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for EventListenerOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<EventListenerOptions>, ()> {
        EventListenerOptions::new(cx, value)
    }
}
...
impl ToJSValConvertible for EventListenerOptions {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        rooted!(in(cx) let mut capture_js = UndefinedValue());
        capture.to_jsval(cx, capture_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "capture", capture_js.handle()).unwrap();
...
pub struct AddEventListenerOptions {
    pub parent: dom::bindings::codegen::Bindings::EventTargetBinding::EventListenerOptions,

}
impl AddEventListenerOptions {
    pub unsafe fn empty(cx: *mut JSContext) -> AddEventListenerOptions {
        match AddEventListenerOptions::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<AddEventListenerOptions>, ()> {
        let object = if val.get().is_null_or_undefined() {
            ptr::null_mut()
        } else if val.get().is_object() {
            val.get().to_object()
        ...
        rooted!(in(cx) let object = object);
            let dictionary = AddEventListenerOptions {
            parent: {
                match try!(dom::bindings::codegen::Bindings::EventTargetBinding::EventListenerOptions::new(cx, val)) {
...
impl FromJSValConvertible for AddEventListenerOptions {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<AddEventListenerOptions>, ()> {
        AddEventListenerOptions::new(cx, value)
    }
}
...
pub use self::EventTargetBinding::{Wrap, EventTargetMethods, GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
unsafe extern fn addEventListener<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const EventTarget<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let arg1: Option<Rc<dom::bindings::codegen::Bindings::EventListenerBinding::EventListener<TH>>> = if args.get(1).get().is_object() {
            Some(dom::bindings::codegen::Bindings::EventListenerBinding::EventListener::new(cx, args.get(1).get().to_object()))
        ...
        let arg2: UnionTypes::AddEventListenerOptionsOrBoolean = if args.get(2).is_undefined() {
            UnionTypes::AddEventListenerOptionsOrBoolean::AddEventListenerOptions(dom::bindings::codegen::Bindings::EventTargetBinding::AddEventListenerOptions::empty(cx))
        } else {
...
fn addEventListener_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn removeEventListener<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const EventTarget<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let arg2: UnionTypes::EventListenerOptionsOrBoolean = if args.get(2).is_undefined() {
            UnionTypes::EventListenerOptionsOrBoolean::EventListenerOptions(dom::bindings::codegen::Bindings::EventTargetBinding::EventListenerOptions::empty(cx))
        } else {
            match FromJSValConvertible::from_jsval(cx, args.get(2), ()) {
                Ok(ConversionResult::Success(value)) => value,
                Ok(ConversionResult::Failure(error)) => {
...
fn removeEventListener_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn dispatchEvent<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const EventTarget<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let arg0: DomRoot<Event<TH>> = if args.get(0).get().is_object() {
...
fn dispatchEvent_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<EventTarget<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut EventTarget<TH>);
            }
            debug!("EventTarget<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"EventTarget\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::EventTarget) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<EventTarget<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<EventTarget<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<EventTarget<TH>>) -> DomRoot<EventTarget<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for EventTarget<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for EventTarget<TH> {
    fn eq(&self, other: &EventTarget<TH>) -> bool {
        self as *const EventTarget<TH> == &*other
    }
}

pub trait EventTargetMethods<TH: TypeHolderTrait<TH>> {
    fn AddEventListener(&self, type_: DOMString, callback: Option<Rc<dom::bindings::codegen::Bindings::EventListenerBinding::EventListener<TH>>>, options: UnionTypes::AddEventListenerOptionsOrBoolean) -> ();
