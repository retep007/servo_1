...
const upDegrees_getterinfo: JSJitInfo = JSJitInfo {
    call: get_upDegrees as *const os::raw::c_void,
...
const rightDegrees_getterinfo: JSJitInfo = JSJitInfo {
    call: get_rightDegrees as *const os::raw::c_void,
    protoID: PrototypeList::ID::VRFieldOfView as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const downDegrees_getterinfo: JSJitInfo = JSJitInfo {
    call: get_downDegrees as *const os::raw::c_void,
    protoID: PrototypeList::ID::VRFieldOfView as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
const leftDegrees_getterinfo: JSJitInfo = JSJitInfo {
    call: get_leftDegrees as *const os::raw::c_void,
    protoID: PrototypeList::ID::VRFieldOfView as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Getter as u8,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &upDegrees_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"rightDegrees\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &rightDegrees_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"downDegrees\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &downDegrees_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
        name: b"leftDegrees\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &leftDegrees_getterinfo },
        setter: JSNativeWrapper { op: None, info: 0 as *const JSJitInfo }
    },
    JSPropertySpec {
