...
use dom::types::MutationObserver;
use dom::types::MutationRecord;
...
impl MutationObserverInit {
    pub unsafe fn empty(cx: *mut JSContext) -> MutationObserverInit {
        match MutationObserverInit::new(cx, HandleValue::null()) {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let dictionary = MutationObserverInit {
            attributeFilter: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "attributeFilter", rval.handle_mut())) {
                    true => {
            ...
            attributeOldValue: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "attributeOldValue", rval.handle_mut())) {
                    true => {
            ...
            attributes: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "attributes", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            characterData: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "characterData", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            characterDataOldValue: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "characterDataOldValue", rval.handle_mut())) {
                    true => {
                        Some(match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
            ...
            childList: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "childList", rval.handle_mut())) {
                    true => {
            ...
            subtree: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "subtree", rval.handle_mut())) {
                    true => {
                        match FromJSValConvertible::from_jsval(cx, rval.handle(), ()) {
                            Ok(ConversionResult::Success(v)) => v,
                            Ok(ConversionResult::Failure(error)) => {
...
impl FromJSValConvertible for MutationObserverInit {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<MutationObserverInit>, ()> {
        MutationObserverInit::new(cx, value)
    }
}
...
impl ToJSValConvertible for MutationObserverInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        if let Some(ref attributeFilter) = self.attributeFilter {
            rooted!(in(cx) let mut attributeFilter_js = UndefinedValue());
            attributeFilter.to_jsval(cx, attributeFilter_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "attributeFilter", attributeFilter_js.handle()).unwrap();
        }
        if let Some(ref attributeOldValue) = self.attributeOldValue {
            rooted!(in(cx) let mut attributeOldValue_js = UndefinedValue());
            attributeOldValue.to_jsval(cx, attributeOldValue_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "attributeOldValue", attributeOldValue_js.handle()).unwrap();
        }
        ...
        if let Some(ref characterData) = self.characterData {
            rooted!(in(cx) let mut characterData_js = UndefinedValue());
            characterData.to_jsval(cx, characterData_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "characterData", characterData_js.handle()).unwrap();
        }
        if let Some(ref characterDataOldValue) = self.characterDataOldValue {
            rooted!(in(cx) let mut characterDataOldValue_js = UndefinedValue());
            characterDataOldValue.to_jsval(cx, characterDataOldValue_js.handle_mut());
            set_dictionary_property(cx, obj.handle(), "characterDataOldValue", characterDataOldValue_js.handle()).unwrap();
        }
        let childList = &self.childList;
        rooted!(in(cx) let mut childList_js = UndefinedValue());
        childList.to_jsval(cx, childList_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "childList", childList_js.handle()).unwrap();
        let subtree = &self.subtree;
        rooted!(in(cx) let mut subtree_js = UndefinedValue());
        subtree.to_jsval(cx, subtree_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "subtree", subtree_js.handle()).unwrap();
...
pub struct MutationCallback<TH: TypeHolderTrait<TH> + 'static> {
    pub parent: CallbackFunction<TH>,
}

impl<TH: TypeHolderTrait<TH>> MutationCallback<TH> {
    ...
    unsafe fn Call(&self, cx: *mut JSContext, aThisObj: HandleObject, mutations: Vec<DomRoot<MutationRecord<TH>>>, observer: &MutationObserver<TH>) -> Fallible<(), TH> {
        ...
        (observer).to_jsval(cx, argv_root.handle_mut());
        {
        let arg = &mut argv[1];
        *arg = Heap::default();
        ...
        rooted!(in(cx) let mut argv_root = UndefinedValue());
        (mutations).to_jsval(cx, argv_root.handle_mut());
        {
        let arg = &mut argv[0];
        *arg = Heap::default();
        arg.set(argv_root.get());
...
impl<TH: TypeHolderTrait<TH>> CallbackContainer<TH> for MutationCallback<TH> {
...
impl<TH: TypeHolderTrait<TH>> ToJSValConvertible for MutationCallback<TH> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, rval: MutableHandleValue) {
        self.callback().to_jsval(cx, rval);
    }
}

pub use self::MutationObserverBinding::{Wrap, MutationObserverMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn observe<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const MutationObserver<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"MutationObserver.observe\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::MutationObserverBinding::MutationObserverInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::MutationObserverBinding::MutationObserverInit::empty(cx)
        } else {
...
fn observe_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: observe::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::MutationObserver as u16,
    depth: 0,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MutationObserver<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut MutationObserver<TH>);
            }
            debug!("MutationObserver<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"MutationObserver\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::MutationObserver, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<MutationObserver<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<MutationObserver<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<MutationObserver<TH>>) -> DomRoot<MutationObserver<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for MutationObserver<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for MutationObserver<TH> {
    fn eq(&self, other: &MutationObserver<TH>) -> bool {
        self as *const MutationObserver<TH> == &*other
    }
}

pub trait MutationObserverMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::MutationObserver as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"MutationObserverPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function MutationObserver() {\n    [native code]\n}",
        PrototypeList::ID::MutationObserver,
        0) 
}
...
(aCx: *mut JSContext, aObj: HandleObject) -> bool {
    ...
    PREFS.get("dom.mutation_observer.enabled").as_boolean().unwrap_or(false)
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::MutationObserver as usize].is_null());
    (*cache)[PrototypeList::ID::MutationObserver as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::MutationObserver as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"MutationObserver\0",
                                        1,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod MutationObserverBinding
