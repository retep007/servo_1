...
unsafe extern fn observe<TH: TypeHolderTrait>
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<MutationObserver<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for MutationObserver<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for MutationObserver<TH> {
