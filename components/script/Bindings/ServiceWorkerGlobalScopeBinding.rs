...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<ServiceWorkerGlobalScope<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ServiceWorkerGlobalScope<TH>>(ops, obj)
}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ServiceWorkerGlobalScope<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ServiceWorkerGlobalScope<TH> {
    fn eq(&self, other: &ServiceWorkerGlobalScope<TH>) -> bool {
        self as *const ServiceWorkerGlobalScope<TH> == &*other
    }
}

pub trait ServiceWorkerGlobalScopeMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    WorkerGlobalScopeBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
