...
pub use self::ServiceWorkerGlobalScopeBinding::{Wrap, ServiceWorkerGlobalScopeMethods, GetProtoObject, DefineDOMInterface};
...
use dom::bindings::codegen::Bindings::WorkerGlobalScopeBinding::WorkerGlobalScopeBinding;
use dom::bindings::codegen::InterfaceObjectMap;
use dom::bindings::codegen::PrototypeList;
use dom::bindings::codegen::RegisterBindings;
use dom::bindings::codegen::UnionTypes;
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::ServiceWorkerGlobalScope;
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ServiceWorkerGlobalScope<TH>, args: JSJitGetterCallArgs) -> bool {
...
(cx: *mut JSContext, obj: HandleObject, this: *const ServiceWorkerGlobalScope<TH>, args: JSJitSetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ServiceWorkerGlobalScope<TH>>(obj).unwrap();
        finalize_global(obj);
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ServiceWorkerGlobalScope<TH>);
            }
            debug!("ServiceWorkerGlobalScope<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ServiceWorkerGlobalScope\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::GlobalScope, PrototypeList::ID::WorkerGlobalScope, PrototypeList::ID::ServiceWorkerGlobalScope, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::GlobalScope(::dom::bindings::codegen::InheritTypes::GlobalScopeTypeId::WorkerGlobalScope(::dom::bindings::codegen::InheritTypes::WorkerGlobalScopeTypeId::ServiceWorkerGlobalScope))) },
    global: InterfaceObjectMap::Globals::SERVICE_WORKER_GLOBAL_SCOPE,
...
(cx: *mut JSContext, object: Box<ServiceWorkerGlobalScope<TH>>) -> DomRoot<ServiceWorkerGlobalScope<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for ServiceWorkerGlobalScope<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for ServiceWorkerGlobalScope<TH> {
    fn eq(&self, other: &ServiceWorkerGlobalScope<TH>) -> bool {
        self as *const ServiceWorkerGlobalScope<TH> == &*other
    }
}

pub trait ServiceWorkerGlobalScopeMethods<TH: TypeHolderTrait> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ServiceWorkerGlobalScope as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ServiceWorkerGlobalScopePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ServiceWorkerGlobalScope() {\n    [native code]\n}",
        PrototypeList::ID::ServiceWorkerGlobalScope,
        3);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    WorkerGlobalScopeBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::ServiceWorkerGlobalScope as usize].is_null());
    (*cache)[PrototypeList::ID::ServiceWorkerGlobalScope as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ServiceWorkerGlobalScope as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    WorkerGlobalScopeBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"ServiceWorkerGlobalScope\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod ServiceWorkerGlobalScopeBinding
