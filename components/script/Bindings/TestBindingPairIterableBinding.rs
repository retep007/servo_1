...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<TestBindingPairIterable<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<TestBindingPairIterable<TH>>(ops, obj)
}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for TestBindingPairIterable<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for TestBindingPairIterable<TH> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for IterableIterator<TestBindingPairIterable<TH>> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class as *const _ == &Class::<TH>().dom_class as *const _
    }
...
impl<TH: TypeHolderTrait<TH>> PartialEq for IterableIterator<TestBindingPairIterable<TH>> {
...
pub trait TestBindingPairIterableIteratorMethods<TH: TypeHolderTrait<TH>> {
