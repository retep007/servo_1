...
impl<TH: TypeHolderTrait> IDLInterface for HTMLStyleElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLStyleElement<TH> {
    fn eq(&self, other: &HTMLStyleElement<TH>) -> bool {
        self as *const HTMLStyleElement<TH> == &*other
    }
}

pub trait HTMLStyleElementMethods<TH: TypeHolderTrait> {
