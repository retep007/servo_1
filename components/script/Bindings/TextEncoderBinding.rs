...
pub use self::TextEncoderBinding::{Wrap, TextEncoderMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const TextEncoder<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn encoding_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::TextEncoder as u16,
    depth: 0,
...
unsafe extern fn encode<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const TextEncoder<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        let result: NonNull<JSObject> = this.Encode(cx, arg0);
...
fn encode_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: encode::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::TextEncoder as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TextEncoder<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut TextEncoder<TH>);
            }
            debug!("TextEncoder<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"TextEncoder\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::TextEncoder, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<TextEncoder<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<TextEncoder<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<TextEncoder<TH>>) -> DomRoot<TextEncoder<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for TextEncoder<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for TextEncoder<TH> {
    fn eq(&self, other: &TextEncoder<TH>) -> bool {
        self as *const TextEncoder<TH> == &*other
    }
}

pub trait TextEncoderMethods {
...
&[
    JSFunctionSpec {
        name: b"encode\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &encode_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::TextEncoder as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"TextEncoderPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function TextEncoder() {\n    [native code]\n}",
        PrototypeList::ID::TextEncoder,
        0) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::TextEncoder as usize].is_null());
    (*cache)[PrototypeList::ID::TextEncoder as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::TextEncoder as isize),
                                  ptr::null_mut(),
                                  prototype.get());
