...
unsafe extern fn encode<TH: TypeHolderTrait>
...
fn encode_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<TextEncoder<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for TextEncoder<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for TextEncoder<TH> {
