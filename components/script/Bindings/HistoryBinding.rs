...
pub use self::HistoryBinding::{Wrap, HistoryMethods, GetProtoObject, DefineDOMInterface};
...
fn length_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
...
unsafe extern fn go<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn go_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    call: go::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
...
unsafe extern fn back<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn back_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    call: back::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn forward<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn forward_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    call: forward::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn pushState<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"History.pushState\".");
            return false;
        }
...
fn pushState_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    call: pushState::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
unsafe extern fn replaceState<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"History.replaceState\".");
            return false;
        }
        let arg0: HandleValue = args.get(0);
        let arg1: DOMString = match FromJSValConvertible::from_jsval(cx, args.get(1), StringificationBehavior::Default) {
...
fn replaceState_methodinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    call: replaceState::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::History as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<History<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut History<TH>);
            }
            debug!("History<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::History, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<History<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<History<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<History<TH>>) -> DomRoot<History<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for History<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for History<TH> {
    fn eq(&self, other: &History<TH>) -> bool {
        self as *const History<TH> == &*other
    }
}

pub trait HistoryMethods<TH: TypeHolderTrait> {
    fn GetLength(&self) -> Fallible<u32, TH>;
    unsafe fn GetState(&self, cx: *mut JSContext) -> Fallible<JSVal, TH>;
    fn Go(&self, delta: i32) -> Fallible<(), TH>;
    fn Back(&self) -> Fallible<(), TH>;
    fn Forward(&self) -> Fallible<(), TH>;
    unsafe fn PushState(&self, cx: *mut JSContext, data: HandleValue, title: DOMString, url: Option<USVString>) -> Fallible<(), TH>;
    unsafe fn ReplaceState(&self, cx: *mut JSContext, data: HandleValue, title: DOMString, url: Option<USVString>) -> Fallible<(), TH>;
}
fn sMethods_specs<TH: TypeHolderTrait>() -> &'static [&'static[JSFunctionSpec]] { &[
&[
    JSFunctionSpec {
        name: b"go\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &go_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"back\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &back_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &forward_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 0,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"pushState\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &pushState_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 2,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
    JSFunctionSpec {
        name: b"replaceState\0" as *const u8 as *const libc::c_char,
        call: JSNativeWrapper { op: Some(generic_method), info: &replaceState_methodinfo::<TH>() as *const _ as *const JSJitInfo },
        nargs: 2,
        flags: (JSPROP_ENUMERATE) as u16,
        selfHostedName: 0 as *const libc::c_char
    },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::History as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HistoryPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::History as usize].is_null());
    (*cache)[PrototypeList::ID::History as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::History as isize),
                                  ptr::null_mut(),
                                  prototype.get());
