...
unsafe extern fn go<TH: TypeHolderTrait<TH>>
...
fn go_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn back<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn back_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn forward<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn forward_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn pushState<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn pushState_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
unsafe extern fn replaceState<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const History<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let args = &*args;
...
fn replaceState_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for History<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for History<TH> {
    fn eq(&self, other: &History<TH>) -> bool {
        self as *const History<TH> == &*other
    }
}

pub trait HistoryMethods<TH: TypeHolderTrait<TH>> {
