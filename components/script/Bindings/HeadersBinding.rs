...
pub use self::UnionTypes::HeadersOrByteStringSequenceSequenceOrStringByteStringRecord as HeadersInit;

pub use self::HeadersBinding::{Wrap as HeadersWrap, HeadersMethods, GetProtoObject as HeadersGetProtoObject, DefineDOMInterface as HeadersDefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"Headers.append\".");
            return false;
        }
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Headers.delete\".");
            return false;
        }
        let arg0: ByteString = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Headers.get\".");
            return false;
        }
        let arg0: ByteString = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Headers.has\".");
            return false;
        }
        let arg0: ByteString = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 2 {
            throw_type_error(cx, "Not enough arguments to \"Headers.set\".");
            return false;
        }
        let arg0: ByteString = match FromJSValConvertible::from_jsval(cx, args.get(0), ()) {
            Ok(ConversionResult::Success(strval)) => strval,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let result = IterableIterator::new(&*this,
                                       ...
                                       super::HeadersIteratorBinding::Wrap);
...
(cx: *mut JSContext, _obj: HandleObject, this: *const Headers<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"Headers.forEach\".");
            return false;
        }
        ...
        if !IsCallable(arg0) {
          throw_type_error(cx, "Argument 1 of Headers.forEach is not callable.");
          return false;
        }
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<Headers<TH>>(obj).unwrap();
            ...
            debug!("Headers<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Headers, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<Headers<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<Headers<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<Headers<TH>>) -> DomRoot<Headers<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for Headers<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for Headers<TH> {
    fn eq(&self, other: &Headers<TH>) -> bool {
        self as *const Headers<TH> == &*other
    }
}

pub trait HeadersMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::Headers as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HeadersPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::Headers as usize].is_null());
    (*cache)[PrototypeList::ID::Headers as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::Headers as isize),
                                  ptr::null_mut(),
                                  prototype.get());
...
pub use self::HeadersIteratorBinding::{Wrap as HeadersIteratorWrap, HeadersIteratorMethods, GetProtoObject as HeadersIteratorGetProtoObject};
pub mod HeadersIteratorBinding {
#![allow(non_camel_case_types,non_upper_case_globals,unused_imports,unused_variables,unused_assignments,unused_mut)]
use dom;
use dom::bindings;
use dom::bindings::callback::CallSetup;
...
fn next_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::HeadersIterator as u16,
    depth: 0,
    _bitfield_1: new_jsjitinfo_bitfield_1!(
        JSJitInfo_OpType::Method as u8,
        JSJitInfo_AliasSet::AliasEverything as u8,
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"HeadersIterator\0" as *const u8 as *const libc::c_char,
        flags: JSCLASS_IS_DOMJSCLASS | 0 |
               (((1) & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT)
               /* JSCLASS_HAS_RESERVED_SLOTS(1) */,
        cOps: &CLASS_OPS::<TH>(),
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::HeadersIterator, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<Headers<TH>> as unsafe fn(&mut _, _) -> _,
}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for IterableIterator<Headers<TH>> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class as *const _ == &Class::<TH>().dom_class as *const _
    }
...
impl<TH: TypeHolderTrait<TH>> PartialEq for IterableIterator<Headers<TH>> {
    fn eq(&self, other: &IterableIterator<Headers<TH>>) -> bool {
        self as *const IterableIterator<Headers<TH>> == &*other
    }
}

pub trait HeadersIteratorMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::ID::HeadersIterator as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"HeadersIteratorPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(0)
        (0 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    create_interface_prototype_object(cx,
                                      ...
                                      prototype.handle_mut().into());
    assert!(!prototype.is_null());
    assert!((*cache)[PrototypeList::ID::HeadersIterator as usize].is_null());
    (*cache)[PrototypeList::ID::HeadersIterator as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::HeadersIterator as isize),
                                  ptr::null_mut(),
                                  prototype.get());

}
} // mod HeadersIteratorBinding
