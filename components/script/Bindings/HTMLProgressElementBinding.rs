...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLProgressElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLProgressElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLProgressElement<TH> {
    fn eq(&self, other: &HTMLProgressElement<TH>) -> bool {
        self as *const HTMLProgressElement<TH> == &*other
    }
}

pub trait HTMLProgressElementMethods<TH: TypeHolderTrait> {
