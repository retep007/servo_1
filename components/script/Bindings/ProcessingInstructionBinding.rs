...
pub use self::ProcessingInstructionBinding::{Wrap, ProcessingInstructionMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const ProcessingInstruction<TH>, args: JSJitGetterCallArgs) -> bool {
...
fn target_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::ProcessingInstruction as u16,
    depth: 3,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<ProcessingInstruction<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut ProcessingInstruction<TH>);
            }
            debug!("ProcessingInstruction<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"ProcessingInstruction\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::EventTarget, PrototypeList::ID::Node, PrototypeList::ID::CharacterData, PrototypeList::ID::ProcessingInstruction, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { eventtarget: (::dom::bindings::codegen::InheritTypes::EventTargetTypeId::Node(::dom::bindings::codegen::InheritTypes::NodeTypeId::CharacterData(::dom::bindings::codegen::InheritTypes::CharacterDataTypeId::ProcessingInstruction))) },
    global: InterfaceObjectMap::Globals::EMPTY,
   	malloc_size_of: malloc_size_of_including_raw_self::<ProcessingInstruction<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<ProcessingInstruction<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<ProcessingInstruction<TH>>) -> DomRoot<ProcessingInstruction<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for ProcessingInstruction<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for ProcessingInstruction<TH> {
    fn eq(&self, other: &ProcessingInstruction<TH>) -> bool {
        self as *const ProcessingInstruction<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::ProcessingInstruction as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"ProcessingInstructionPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function ProcessingInstruction() {\n    [native code]\n}",
        PrototypeList::ID::ProcessingInstruction,
        3);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    CharacterDataBinding::GetProtoObject(cx, global, prototype_proto.handle_mut());
    ...
    assert!((*cache)[PrototypeList::ID::ProcessingInstruction as usize].is_null());
    (*cache)[PrototypeList::ID::ProcessingInstruction as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::ProcessingInstruction as isize),
                                  ptr::null_mut(),
                                  prototype.get());


    rooted!(in(cx) let mut interface_proto = ptr::null_mut::<JSObject>());
    CharacterDataBinding::GetConstructorObject(cx, global, interface_proto.handle_mut());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"ProcessingInstruction\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod ProcessingInstructionBinding
