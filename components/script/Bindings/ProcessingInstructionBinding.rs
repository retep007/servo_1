...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    CharacterDataBinding::GetProtoObject::<TH>(cx, global, prototype_proto.handle_mut());
    ...
    CharacterDataBinding::GetConstructorObject::<TH>(cx, global, interface_proto.handle_mut());
