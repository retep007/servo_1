...
unsafe extern fn get_reason<TH: TypeHolderTrait>
(cx: *mut JSContext, _obj: HandleObject, this: *const VRDisplayEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
fn reason_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<VRDisplayEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for VRDisplayEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for VRDisplayEvent<TH> {
    fn eq(&self, other: &VRDisplayEvent<TH>) -> bool {
        self as *const VRDisplayEvent<TH> == &*other
    }
}

pub trait VRDisplayEventMethods<TH: TypeHolderTrait> {
