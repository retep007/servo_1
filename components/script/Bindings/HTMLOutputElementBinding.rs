...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<HTMLOutputElement<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for HTMLOutputElement<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for HTMLOutputElement<TH> {
    fn eq(&self, other: &HTMLOutputElement<TH>) -> bool {
        self as *const HTMLOutputElement<TH> == &*other
    }
}

pub trait HTMLOutputElementMethods<TH: TypeHolderTrait> {
