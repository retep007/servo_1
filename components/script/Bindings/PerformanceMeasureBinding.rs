...
pub use self::PerformanceMeasureBinding::{Wrap, GetProtoObject, DefineDOMInterface};
...
use dom::types::PerformanceMeasure;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PerformanceMeasure<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PerformanceMeasure<TH>);
            }
            debug!("PerformanceMeasure<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"PerformanceMeasure\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::PerformanceEntry, PrototypeList::ID::PerformanceMeasure, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { performanceentry: (::dom::bindings::codegen::InheritTypes::PerformanceEntryTypeId::PerformanceMeasure) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PerformanceMeasure<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<PerformanceMeasure<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PerformanceMeasure<TH>>) -> DomRoot<PerformanceMeasure<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for PerformanceMeasure<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for PerformanceMeasure<TH> {
    fn eq(&self, other: &PerformanceMeasure<TH>) -> bool {
        self as *const PerformanceMeasure<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PerformanceMeasure as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PerformanceMeasurePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PerformanceMeasure() {\n    [native code]\n}",
        PrototypeList::ID::PerformanceMeasure,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::PerformanceMeasure as usize].is_null());
    (*cache)[PrototypeList::ID::PerformanceMeasure as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PerformanceMeasure as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    create_noncallback_interface_object(cx,
                                        ...
                                        &[],
                                        prototype.handle(),
                                        b"PerformanceMeasure\0",
                                        0,
                                        interface.handle_mut());
    assert!(!interface.is_null());
}
} // mod PerformanceMeasureBinding
