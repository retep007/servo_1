...
pub use self::OESTextureHalfFloatLinearBinding::{Wrap, GetProtoObject};
...
use dom::bindings::weakref::WeakReferenceable;
use dom::globalscope::GlobalScope;
use dom::types::OESTextureHalfFloatLinear;
use dom::windowproxy::WindowProxy;
use js;
use js::JSCLASS_GLOBAL_SLOT_COUNT;
use js::JSCLASS_IS_DOMJSCLASS;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<OESTextureHalfFloatLinear<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut OESTextureHalfFloatLinear<TH>);
            }
            debug!("OESTextureHalfFloatLinear<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"OESTextureHalfFloatLinear\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::OESTextureHalfFloatLinear, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
	malloc_size_of: malloc_size_of_including_raw_self::<OESTextureHalfFloatLinear<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<OESTextureHalfFloatLinear<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<OESTextureHalfFloatLinear<TH>>) -> DomRoot<OESTextureHalfFloatLinear<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for OESTextureHalfFloatLinear<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for OESTextureHalfFloatLinear<TH> {
    fn eq(&self, other: &OESTextureHalfFloatLinear<TH>) -> bool {
        self as *const OESTextureHalfFloatLinear<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::OESTextureHalfFloatLinear as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"OESTextureHalfFloatLinearPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::OESTextureHalfFloatLinear as usize].is_null());
    (*cache)[PrototypeList::ID::OESTextureHalfFloatLinear as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::OESTextureHalfFloatLinear as isize),
                                  ptr::null_mut(),
                                  prototype.get());

}
} // mod OESTextureHalfFloatLinearBinding
