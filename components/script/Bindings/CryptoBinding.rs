...
const getRandomValues_methodinfo: JSJitInfo = JSJitInfo {
    call: getRandomValues as *const os::raw::c_void,
...
&[
    JSFunctionSpec {
        ...
        call: JSNativeWrapper { op: Some(generic_method), info: &getRandomValues_methodinfo as *const _ as *const JSJitInfo },
        nargs: 1,
