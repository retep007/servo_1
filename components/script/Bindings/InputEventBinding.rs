...
impl<TH: TypeHolderTrait<TH>> FromJSValConvertible for InputEventInit<TH> {
    type Config = ();
...
impl<TH: TypeHolderTrait<TH>> ToJSValConvertible for InputEventInit<TH> {
...
pub use self::InputEventBinding::{Wrap, InputEventMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const InputEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: Option<DOMString> = this.GetData();
...
fn data_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::InputEvent as u16,
    depth: 2,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<InputEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut InputEvent<TH>);
            }
            debug!("InputEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"InputEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::UIEvent, PrototypeList::ID::InputEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::UIEvent(::dom::bindings::codegen::InheritTypes::UIEventTypeId::InputEvent)) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<InputEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<InputEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<InputEvent<TH>>) -> DomRoot<InputEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for InputEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for InputEvent<TH> {
    fn eq(&self, other: &InputEvent<TH>) -> bool {
        self as *const InputEvent<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::InputEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"InputEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"InputEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::InputEventBinding::InputEventInit<TH> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::InputEventBinding::InputEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<InputEvent<TH>>, Error<TH>> = InputEvent::Constructor(&global, arg0, &arg1);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait<TH>>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function InputEvent() {\n    [native code]\n}",
        PrototypeList::ID::InputEvent,
        2) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::InputEvent as usize].is_null());
    (*cache)[PrototypeList::ID::InputEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::InputEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
