...
#[derive(JSTraceable)]
pub struct InputEventInit<TH: TypeHolderTrait + 'static> {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<InputEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for InputEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for InputEvent<TH> {
