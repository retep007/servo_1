...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<FileList<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for FileList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for FileList<TH> {
    fn eq(&self, other: &FileList<TH>) -> bool {
        self as *const FileList<TH> == &*other
    }
}

pub trait FileListMethods<TH: TypeHolderTrait> {
