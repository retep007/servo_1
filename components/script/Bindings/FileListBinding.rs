...
pub use self::FileListBinding::{Wrap, FileListMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"FileList.item\".");
            return false;
        }
        ...
        let result: Option<DomRoot<File<TH>>> = this.Item(arg0);
...
fn item_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::FileList as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const FileList<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<FileList<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut FileList<TH>);
            }
            debug!("FileList<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const FileList<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const FileList<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::FileList, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<FileList<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let this = &*this;
            let result: Option<DomRoot<File<TH>>> = this.IndexedGetter(index);
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"FileList\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<FileList<TH>>) -> DomRoot<FileList<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::FileList as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for FileList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for FileList<TH> {
    fn eq(&self, other: &FileList<TH>) -> bool {
        self as *const FileList<TH> == &*other
    }
}

pub trait FileListMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::FileList as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"FileListPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::FileList as usize].is_null());
    (*cache)[PrototypeList::ID::FileList as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::FileList as isize),
                                  ptr::null_mut(),
                                  prototype.get());
