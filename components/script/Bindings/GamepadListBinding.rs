...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<GamepadList<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for GamepadList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for GamepadList<TH> {
    fn eq(&self, other: &GamepadList<TH>) -> bool {
        self as *const GamepadList<TH> == &*other
    }
}

pub trait GamepadListMethods<TH: TypeHolderTrait> {
