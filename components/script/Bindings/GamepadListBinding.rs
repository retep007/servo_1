...
pub use self::GamepadListBinding::{Wrap, GamepadListMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const GamepadList<TH>, args: *const JSJitMethodCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"GamepadList.item\".");
            return false;
        }
        ...
        let result: Option<DomRoot<Gamepad<TH>>> = this.Item(arg0);
...
fn item_methodinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::GamepadList as u16,
    depth: 0,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const GamepadList<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<GamepadList<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut GamepadList<TH>);
            }
            debug!("GamepadList<TH> finalize: {:p}", this);
    }), ());
}
...
(obj: RawHandleObject) -> *const GamepadList<TH> {
    /*if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
        obj = js::UnwrapObject(obj);
    }*/
    //MOZ_ASSERT(IsProxy(obj));
    let box_ = GetProxyPrivate(obj.get()).to_private() as *const GamepadList<TH>;
    return box_;
}

fn Class<TH: TypeHolderTrait<TH>>() -> DOMClass { DOMClass {
    interface_chain: [ PrototypeList::ID::GamepadList, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { alone: () },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<GamepadList<TH>> as unsafe fn(&mut _, _) -> _,
}}
...
(cx: *mut JSContext, proxy: RawHandleObject, id: RawHandleId, desc: RawMutableHandle<PropertyDescriptor>) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if let Some(index) = index {
            ...
            let this = &*this;
            let result: Option<DomRoot<Gamepad<TH>>> = this.IndexedGetter(index);
...
(cx: *mut JSContext, _proxy: RawHandleObject) -> *const i8 {
    b"GamepadList\0" as *const u8 as *const i8
}
...
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<GamepadList<TH>>) -> DomRoot<GamepadList<TH>> {
    ...
    let handler = RegisterBindings::PROXY_HANDLERS[PrototypeList::Proxies::GamepadList as usize];
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for GamepadList<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for GamepadList<TH> {
    fn eq(&self, other: &GamepadList<TH>) -> bool {
        self as *const GamepadList<TH> == &*other
    }
}

pub trait GamepadListMethods<TH: TypeHolderTrait<TH>> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::GamepadList as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"GamepadListPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function GamepadList() {\n    [native code]\n}",
        PrototypeList::ID::GamepadList,
        0);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::GamepadList as usize].is_null());
    (*cache)[PrototypeList::ID::GamepadList as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::GamepadList as isize),
                                  ptr::null_mut(),
                                  prototype.get());
