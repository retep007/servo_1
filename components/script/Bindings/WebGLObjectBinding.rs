...
pub use self::WebGLObjectBinding::{GetProtoObject, GetConstructorObject, DefineDOMInterface};
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for WebGLObject<TH> {
    #[inline]
    fn derives(class: &'static DOMClass) -> bool {
        class.interface_chain[0] == PrototypeList::ID::WebGLObject
    }
}

impl<TH: TypeHolderTrait<TH>> PartialEq for WebGLObject<TH> {
    fn eq(&self, other: &WebGLObject<TH>) -> bool {
        self as *const WebGLObject<TH> == &*other
    }
}
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::WebGLObject as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"WebGLObjectPrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function WebGLObject() {\n    [native code]\n}",
        PrototypeList::ID::WebGLObject,
        0);
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    /* Check to see whether the interface objects are already installed */
    let proto_or_iface_array = get_proto_or_iface_array(global.get());
    rval.set((*proto_or_iface_array)[PrototypeList::Constructor::WebGLObject as usize]);
    if !rval.get().is_null() {
        return;
    }
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::WebGLObject as usize].is_null());
    (*cache)[PrototypeList::ID::WebGLObject as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::WebGLObject as isize),
                                  ptr::null_mut(),
                                  prototype.get());
    ...
    assert!((*cache)[PrototypeList::Constructor::WebGLObject as usize].is_null());
    (*cache)[PrototypeList::Constructor::WebGLObject as usize] = interface.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::Constructor::WebGLObject as isize),
                                  ptr::null_mut(),
                                  interface.get());

}
} // mod WebGLObjectBinding
