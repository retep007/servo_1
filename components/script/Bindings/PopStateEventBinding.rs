...
impl PopStateEventInit {
    ...
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
        ...
        rooted!(in(cx) let object = object);
            let mut dictionary = RootedTraceableBox::new(PopStateEventInit::default());
            dictionary.parent = {
            ...
            dictionary.state = {
                ...
                match try!(get_dictionary_property(cx, object.handle(), "state", rval.handle_mut())) {
                    true => {
...
impl FromJSValConvertible for RootedTraceableBox<PopStateEventInit> {
    ...
    unsafe fn from_jsval(cx: *mut JSContext, value: HandleValue, _option: ())
                         -> Result<ConversionResult<RootedTraceableBox<PopStateEventInit>>, ()> {
        PopStateEventInit::new(cx, value)
    }
}

impl ToJSValConvertible for RootedTraceableBox<PopStateEventInit> {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        rooted!(in(cx) let obj = JS_NewObject(cx, ptr::null()));
        let state = &self.state;
        rooted!(in(cx) let mut state_js = UndefinedValue());
        state.to_jsval(cx, state_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "state", state_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::PopStateEventBinding::{Wrap, PopStateEventMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const PopStateEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: JSVal = this.State(cx);
...
fn state_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
    ...
    protoID: PrototypeList::ID::PopStateEvent as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<PopStateEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut PopStateEvent<TH>);
            }
            debug!("PopStateEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"PopStateEvent\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::Event, PrototypeList::ID::PopStateEvent, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { event: (::dom::bindings::codegen::InheritTypes::EventTypeId::PopStateEvent) },
    global: InterfaceObjectMap::Globals::EMPTY,
    malloc_size_of: malloc_size_of_including_raw_self::<PopStateEvent<TH>> as unsafe fn(&mut _, _) -> _,
}
}}

#[inline]
fn malloc_size<TH: TypeHolderTrait>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<PopStateEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<PopStateEvent<TH>>) -> DomRoot<PopStateEvent<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for PopStateEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for PopStateEvent<TH> {
    fn eq(&self, other: &PopStateEvent<TH>) -> bool {
        self as *const PopStateEvent<TH> == &*other
    }
}

pub trait PopStateEventMethods {
    unsafe fn State(&self, cx: *mut JSContext) -> JSVal;
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::PopStateEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"PopStateEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"PopStateEvent.constructor\".");
            return false;
        }
        ...
        let arg1: RootedTraceableBox<dom::bindings::codegen::Bindings::PopStateEventBinding::PopStateEventInit> = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::PopStateEventBinding::PopStateEventInit::empty(cx)
        } else {
        ...
        let result: Result<DomRoot<PopStateEvent<TH>>, Error<TH>> = PopStateEvent::Constructor(&global, arg0, arg1);
...
fn INTERFACE_OBJECT_CLASS<TH: TypeHolderTrait>() -> NonCallbackInterfaceObjectClass {
    ...
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function PopStateEvent() {\n    [native code]\n}",
        PrototypeList::ID::PopStateEvent,
        1) 
}
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::PopStateEvent as usize].is_null());
    (*cache)[PrototypeList::ID::PopStateEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::PopStateEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
