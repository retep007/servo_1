...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    ...
    malloc_size_of: malloc_size_of_including_raw_self::<CSSKeyframeRule<TH>> as unsafe fn(&mut _, _) -> _,
}
}}
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CSSKeyframeRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CSSKeyframeRule<TH> {
    fn eq(&self, other: &CSSKeyframeRule<TH>) -> bool {
        self as *const CSSKeyframeRule<TH> == &*other
    }
}

pub trait CSSKeyframeRuleMethods<TH: TypeHolderTrait<TH>> {
