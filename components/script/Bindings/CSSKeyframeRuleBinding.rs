...
pub use self::CSSKeyframeRuleBinding::{Wrap, CSSKeyframeRuleMethods, GetProtoObject, DefineDOMInterface};
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CSSKeyframeRule<TH>, args: JSJitGetterCallArgs) -> bool {
...
const style_getterinfo: JSJitInfo = JSJitInfo {
    ...
    protoID: PrototypeList::ID::CSSKeyframeRule as u16,
    depth: 1,
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CSSKeyframeRule<TH>, TH>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CSSKeyframeRule<TH>);
            }
            debug!("CSSKeyframeRule<TH> finalize: {:p}", this);
    }), ());
}
...
static Class: DOMJSClass = DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"CSSKeyframeRule\0" as *const u8 as *const libc::c_char,
    ...
    dom_class: DOMClass {
    interface_chain: [ PrototypeList::ID::CSSRule, PrototypeList::ID::CSSKeyframeRule, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last, PrototypeList::ID::Last ],
    type_id: ::dom::bindings::codegen::InheritTypes::TopTypeId { cssrule: (::dom::bindings::codegen::InheritTypes::CSSRuleTypeId::CSSKeyframeRule) },
...
fn malloc_size<TH: TypeHolderTrait>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CSSKeyframeRule<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CSSKeyframeRule<TH>>) -> DomRoot<CSSKeyframeRule<TH>> {
...
impl<TH: TypeHolderTrait> IDLInterface for CSSKeyframeRule<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CSSKeyframeRule<TH> {
    fn eq(&self, other: &CSSKeyframeRule<TH>) -> bool {
        self as *const CSSKeyframeRule<TH> == &*other
    }
}

pub trait CSSKeyframeRuleMethods<TH: TypeHolderTrait> {
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CSSKeyframeRule as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CSSKeyframeRulePrototype\0" as *const u8 as *const libc::c_char,
    flags:
...
static INTERFACE_OBJECT_CLASS: NonCallbackInterfaceObjectClass =
    NonCallbackInterfaceObjectClass::new(
        ...
        b"function CSSKeyframeRule() {\n    [native code]\n}",
        PrototypeList::ID::CSSKeyframeRule,
        1);
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CSSKeyframeRule as usize].is_null());
    (*cache)[PrototypeList::ID::CSSKeyframeRule as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CSSKeyframeRule as isize),
                                  ptr::null_mut(),
                                  prototype.get());
