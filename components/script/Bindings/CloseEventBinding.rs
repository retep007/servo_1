...
unsafe extern fn get_wasClean<TH: TypeHolderTrait>
...
fn wasClean_getterinfo<TH: TypeHolderTrait>() -> JSJitInfo { JSJitInfo {
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CloseEvent<TH>, TH>(obj).unwrap();
            if !this.is_null() {
...
impl<TH: TypeHolderTrait> IDLInterface for CloseEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait> PartialEq for CloseEvent<TH> {
