...
const wasClean_getterinfo: JSJitInfo = JSJitInfo {
    call: get_wasClean as *const os::raw::c_void,
...
&[
    JSPropertySpec {
        ...
        getter: JSNativeWrapper { op: Some(generic_getter), info: &wasClean_getterinfo },
