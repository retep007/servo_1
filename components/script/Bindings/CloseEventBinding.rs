...
impl CloseEventInit {
    pub unsafe fn empty(cx: *mut JSContext) -> CloseEventInit {
        match CloseEventInit::new(cx, HandleValue::null()) {
            Ok(ConversionResult::Success(v)) => v,
            _ => unreachable!(),
        }
    }
    pub unsafe fn new(cx: *mut JSContext, val: HandleValue)
                      -> Result<ConversionResult<CloseEventInit>, ()> {
        ...
        rooted!(in(cx) let object = object);
            ...
            wasClean: {
                rooted!(in(cx) let mut rval = UndefinedValue());
                match try!(get_dictionary_property(cx, object.handle(), "wasClean", rval.handle_mut())) {
                    true => {
...
impl ToJSValConvertible for CloseEventInit {
    unsafe fn to_jsval(&self, cx: *mut JSContext, mut rval: MutableHandleValue) {
        ...
        let wasClean = &self.wasClean;
        rooted!(in(cx) let mut wasClean_js = UndefinedValue());
        wasClean.to_jsval(cx, wasClean_js.handle_mut());
        set_dictionary_property(cx, obj.handle(), "wasClean", wasClean_js.handle()).unwrap();
        rval.set(ObjectOrNullValue(obj.get()))
    }
}


pub use self::CloseEventBinding::{Wrap, CloseEventMethods, GetProtoObject, DefineDOMInterface};
...
unsafe extern fn get_wasClean<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, _obj: HandleObject, this: *const CloseEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: bool = this.WasClean();
...
fn wasClean_getterinfo<TH: TypeHolderTrait<TH>>() -> JSJitInfo { JSJitInfo {
    call: get_wasClean::<TH> as *const os::raw::c_void,
    protoID: PrototypeList::ID::CloseEvent as u16,
    depth: 1,
...
(cx: *mut JSContext, _obj: HandleObject, this: *const CloseEvent<TH>, args: JSJitGetterCallArgs) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        let this = &*this;
        let result: DOMString = this.Reason();
...
(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        let this = native_from_object::<CloseEvent<TH>>(obj).unwrap();
            if !this.is_null() {
                // The pointer can be null if the object is the unforgeable holder of that interface.
                let _ = Box::from_raw(this as *mut CloseEvent<TH>);
            }
            debug!("CloseEvent<TH> finalize: {:p}", this);
    }), ());
}
...
fn Class<TH: TypeHolderTrait<TH>>() -> DOMJSClass { DOMJSClass {
    base: js::jsapi::JSClass {
        name: b"CloseEvent\0" as *const u8 as *const libc::c_char,
...
fn malloc_size<TH: TypeHolderTrait<TH>>(ops: &mut MallocSizeOfOps, obj: *const c_void) -> usize {
    malloc_size_of_including_raw_self::<CloseEvent<TH>>(ops, obj)
}

pub unsafe fn Wrap<TH: TypeHolderTrait<TH>>
(cx: *mut JSContext, scope: &GlobalScope<TH>, object: Box<CloseEvent<TH>>) -> DomRoot<CloseEvent<TH>> {
...
impl<TH: TypeHolderTrait<TH>> IDLInterface for CloseEvent<TH> {
    #[inline]
...
impl<TH: TypeHolderTrait<TH>> PartialEq for CloseEvent<TH> {
    fn eq(&self, other: &CloseEvent<TH>) -> bool {
        self as *const CloseEvent<TH> == &*other
    }
}
...
&[
    JSPropertySpec {
        name: b"wasClean\0" as *const u8 as *const libc::c_char,
        flags: (JSPROP_ENUMERATE | JSPROP_SHARED) as u8,
        getter: JSNativeWrapper { op: Some(generic_getter), info: &wasClean_getterinfo::<TH>() },
...
(cx: *mut JSContext, global: HandleObject, mut rval: MutableHandleObject) {
    ...
    rval.set((*proto_or_iface_array)[PrototypeList::ID::CloseEvent as usize]);
    if !rval.get().is_null() {
        return;
    }
...
static PrototypeClass: JSClass = JSClass {
    name: b"CloseEventPrototype\0" as *const u8 as *const libc::c_char,
    flags:
        // JSCLASS_HAS_RESERVED_SLOTS(1)
        (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT,
    cOps: 0 as *const _,
...
(cx: *mut JSContext, argc: u32, vp: *mut JSVal) -> bool {
    return wrap_panic(panic::AssertUnwindSafe(|| {
        ...
        if argc < 1 {
            throw_type_error(cx, "Not enough arguments to \"CloseEvent.constructor\".");
            return false;
        }
        ...
        let arg1: dom::bindings::codegen::Bindings::CloseEventBinding::CloseEventInit = if args.get(1).is_undefined() {
            dom::bindings::codegen::Bindings::CloseEventBinding::CloseEventInit::empty(cx)
        } else {
...
(cx: *mut JSContext, global: HandleObject, cache: *mut ProtoOrIfaceArray) {
    ...
    assert!((*cache)[PrototypeList::ID::CloseEvent as usize].is_null());
    (*cache)[PrototypeList::ID::CloseEvent as usize] = prototype.get();
    <*mut JSObject>::post_barrier((*cache).as_mut_ptr().offset(PrototypeList::ID::CloseEvent as isize),
                                  ptr::null_mut(),
                                  prototype.get());
